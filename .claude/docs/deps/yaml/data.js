window.REPORT_DATA = {
  "meta": {
    "title": "yaml dependency footprint",
    "pageTitle": "yaml · Skills Dependency Report",
    "subtitle": "Runtime dependency · ^2.8.3 · 28 hit files across /Users/yi/YrY/.claude/skills",
    "footer": "Generated for .claude/docs/deps/yaml/index.html · package yaml · 28 hit files · 6 skill roots",
  ...
  "executiveSummary": [
    {
      ...
      "content": "YAML parse/serialize · config + index"
    },
    {
      "color": "green",
      "title": "Where It Lands",
      "content": "Top consumer skill: rui-reports/diagram. Consumer count: 6."
    },
    {
      "color": "amber",
      "title": "Why Review It",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        "skills/rui-reports/diagram/pnpm-lock.yaml is the hottest touchpoint with 18 textual matches.",
        "skills/rui-reports/diagram/languages/yaml.md is a secondary touchpoint and should be reviewed when upgrading.",
    ...
    },
    {
      ...
      "items": [
        ...
        "Official reference host is eemeli.org; keep the page link aligned with upstream package naming and release history."
      ]
    }
  ],
  "pipeline": [
    ...
    },
    {
      "badge": "USAGE",
      "badgeClass": "green",
      "info": "7 direct import file(s) and 21 reference-only file(s) were found."
    },
    {
      "badge": "REPORT",
      "badgeClass": "violet",
  ...
  "securityCards": [
    ...
    },
    {
      ...
      "items": [
        "Official reference resolves to eemeli.org.",
  ...
  "scalingTiles": [
    ...
    },
    {
      ...
      "body": "Top spread: <code>rui-reports/diagram</code> with 19 hit(s)."
    },
    {
      "color": "amber",
      "title": "Drift Signal",
  ...
  "ownership": {
    ...
    "rows": [
      [
        ...
        "19",
        "<code>skills/rui-reports/diagram/agents/architecture-analyzer.md</code>",
        "direct import"
      ],
      [
      ...
      [
        "<code>rui-code/vite</code>",
        "2",
        "<code>skills/rui-code/vite/references/index.json</code>",
        "doc / metadata mention"
      ],
      [
        "<code>rui-init</code>",
  ...
  "apiTable": {
    ...
    "rows": [
      ...
      [
        "<code>skills/rui-reports/diagram/languages/yaml.md</code>",
        "code",
        "7",
        "Executable implementation surface"
      ],
      ...
      [
        "<code>skills/rui-reports/diagram/engine/core/src/languages/configs/index.js</code>",
        "code",
        "4",
        "Executable implementation surface"
      ],
      [
        "<code>skills/rui-reports/diagram/engine/core/src/languages/configs/kubernetes.js</code>",
        "code",
        "4",
        "Executable implementation surface"
      ]
  ...
  "schemaTiles": [
    ...
    },
    {
      ...
      "body": "docs/deps/yaml/index.html"
    }
  ],
  "roadmap": [
    {
