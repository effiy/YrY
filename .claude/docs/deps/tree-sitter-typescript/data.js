window.REPORT_DATA = {
  "meta": {
    "pageTitle": "tree-sitter-typescript footprint",
    "subtitle": "Runtime dependency · ^0.23.2 · 3 hit files across .claude/skills",
    "upstream": "https://github.com/tree-sitter/tree-sitter-typescript",
    "footer": "Generated for .claude/docs/deps/tree-sitter-typescript/index.html · package tree-sitter-typescript · 3 hit files · 1 skill roots · rebuilt 2026-07-19"
  },
  "metrics": [
    {
      "label": "Version",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        ".claude/skills/rui-reports/diagram/engine/core/src/plugins/tree-sitter-plugin.js (3 matches, direct)",
        ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/typescript.js (2 matches, direct)",
  ...
  "hitFiles": [
    ...
    {
      "path": ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/typescript.js",
      "occurrences": 2,
      "skillRoot": "rui-reports/diagram",
      "fileKind": "source",
      "usageType": "direct"
