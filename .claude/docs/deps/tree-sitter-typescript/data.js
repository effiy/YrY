window.REPORT_DATA = {
  "meta": {
    "title": "tree-sitter-typescript dependency footprint",
    "pageTitle": "tree-sitter-typescript · Skills Dependency Report",
    "subtitle": "Runtime dependency · ^0.23.2 · 4 hit files across /Users/yi/YrY/.claude/skills",
    "footer": "Generated for .claude/docs/deps/tree-sitter-typescript/index.html · package tree-sitter-typescript · 4 hit files · 1 skill roots",
  ...
  "executiveSummary": [
    {
      ...
      "content": "TypeScript grammar · AST parsing"
    },
    {
      "color": "green",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        "skills/rui-reports/diagram/engine/core/src/plugins/tree-sitter-plugin.js is the hottest touchpoint with 3 textual matches.",
  ...
  "pipeline": [
    ...
    },
    {
      "badge": "USAGE",
      "badgeClass": "green",
      "info": "2 direct import file(s) and 2 reference-only file(s) were found."
    },
    {
      "badge": "REPORT",
      "badgeClass": "violet",
  ...
  "securityCards": [
    ...
    },
    {
      ...
      "items": [
        ...
        "Primary file hotspot: skills/rui-reports/diagram/engine/core/src/plugins/tree-sitter-plugin.js.",
  ...
  "trace": [
    ...
    },
    {
      "name": "Dependency",
      "nameClass": "green",
      "sub": "tree-sitter-typescript",
      "time": "t2"
    },
    {
      "name": "rui-reports/diagram",
      "nameClass": "violet",
      "sub": "tree-sitter-plugin.js",
      "time": "t3"
    },
    {
      "name": "Report",
      "nameClass": "cyan",
      "sub": "deps/tree-sitter-typescript/index.html",
      "time": "t4"
    }
  ],
  "scalingTiles": [
    ...
    },
    {
      ...
      "body": "Top spread: <code>rui-reports/diagram</code> with 4 hit(s)."
    },
    {
      "color": "amber",
      "title": "Drift Signal",
    ...
    },
    {
      "color": "violet",
      "title": "Review Focus",
      "body": "Start review at <code>skills/rui-reports/diagram/engine/core/src/plugins/tree-sitter-plugin.js</code>."
    }
  ],
  "ownership": {
    "headers": [
    ...
    "rows": [
      [
        ...
        "4",
        "<code>skills/rui-reports/diagram/engine/core/src/languages/configs/typescript.js</code>",
        "direct import"
      ]
    ]
  },
  ...
  "schemaTiles": [
    ...
    },
    {
      ...
      "body": "skills/rui-reports/diagram/engine/core/src/plugins/tree-sitter-plugin.js"
    },
    {
    ...
    },
    {
      ...
      "body": "docs/deps/tree-sitter-typescript/index.html"
    }
  ],
  "roadmap": [
    {
