window.REPORT_DATA = {
  "meta": {
    "title": "tree-sitter-go dependency footprint",
    "pageTitle": "tree-sitter-go · Skills Dependency Report",
    "subtitle": "Runtime dependency · ^0.25.0 · 3 hit files across /Users/yi/YrY/.claude/skills",
    "footer": "Generated for .claude/docs/deps/tree-sitter-go/index.html · package tree-sitter-go · 3 hit files · 1 skill roots",
  ...
  "executiveSummary": [
    {
      ...
      "content": "Go grammar · AST parsing"
    },
    {
      "color": "green",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        ...
        "skills/rui-reports/diagram/engine/core/src/languages/configs/go.js is a secondary touchpoint and should be reviewed when upgrading.",
  ...
  "trace": [
    ...
    },
    {
      "name": "Report",
      "nameClass": "cyan",
      "sub": "deps/tree-sitter-go/index.html",
      "time": "t4"
    }
  ],
  "scalingTiles": [
  ...
  "ownership": {
    ...
    "rows": [
      [
        ...
        "3",
        "<code>skills/rui-reports/diagram/engine/core/src/languages/configs/go.js</code>",
        "direct import"
      ]
    ]
  },
  ...
  "schemaTiles": [
    ...
    },
    {
      ...
      "body": "docs/deps/tree-sitter-go/index.html"
    }
  ],
  "roadmap": [
    {
