window.REPORT_DATA = {
  "meta": {
    "title": "ignore dependency footprint",
    "pageTitle": "ignore · Skills Dependency Report",
    "subtitle": "Runtime dependency · ^7.0.5 · 42 hit files across /Users/yi/YrY/.claude/skills",
    "footer": "Generated for .claude/docs/deps/ignore/index.html · package ignore · 42 hit files · 11 skill roots",
  ...
  "executiveSummary": [
    {
      ...
      "content": ".gitignore-compatible file filter · scan skip rules"
    },
    {
      "color": "green",
      "title": "Where It Lands",
      "content": "Top consumer skill: rui-reports/diagram. Consumer count: 11."
    },
    {
      "color": "amber",
      "title": "Why Review It",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        "skills/rui-reports/diagram/scripts/scan-project.mjs is the hottest touchpoint with 21 textual matches.",
        "skills/rui-reports/diagram/engine/core/src/ignore-generator.js is a secondary touchpoint and should be reviewed when upgrading.",
  ...
  "pipeline": [
    ...
    },
    {
      "badge": "USAGE",
      "badgeClass": "green",
      "info": "4 direct import file(s) and 38 reference-only file(s) were found."
    },
    {
      "badge": "REPORT",
      "badgeClass": "violet",
  ...
  "securityCards": [
    ...
    },
    {
      ...
      "items": [
        ...
        "Primary file hotspot: skills/rui-reports/diagram/scripts/scan-project.mjs.",
  ...
  "scalingTiles": [
    ...
    },
    {
      ...
      "body": "Top spread: <code>rui-reports/diagram</code> with 16 hit(s)."
    },
    {
      "color": "amber",
      "title": "Drift Signal",
    ...
    },
    {
      "color": "violet",
      "title": "Review Focus",
      "body": "Start review at <code>skills/rui-reports/diagram/scripts/scan-project.mjs</code>."
    }
  ],
  "ownership": {
    "headers": [
    ...
    "rows": [
      ...
      [
        "<code>rui-code/vue</code>",
        "8",
        "<code>skills/rui-code/vue/references/vueuse-sensors/onClickOutside.md</code>",
        "direct import"
      ],
      [
        "<code>rui-code/nodejs</code>",
        "5",
        "<code>skills/rui-code/nodejs/SKILL.md</code>",
        "doc / metadata mention"
      ],
      [
        "<code>rui-reports/files</code>",
        "3",
        "<code>skills/rui-reports/files/references/methodology.md</code>",
        "doc / metadata mention"
      ],
      [
        "<code>rui-code/fastapi</code>",
        "2",
        "<code>skills/rui-code/fastapi/references/project-structure.md</code>",
        "direct import"
      ]
    ]
  },
  "apiTable": {
    ...
    "rows": [
      [
        "<code>skills/rui-reports/diagram/scripts/scan-project.mjs</code>",
        "script",
        "21",
        "Automation or analysis script touchpoint"
      ],
      [
        "<code>skills/rui-reports/diagram/engine/core/src/ignore-generator.js</code>",
        "code",
        "20",
      ...
      [
        "<code>skills/rui-code/vue/references/vueuse-watch/watchIgnorable.md</code>",
        "docs",
        "14",
  ...
  "schemaTiles": [
    ...
    },
    {
      ...
      "body": "skills/rui-reports/diagram/scripts/scan-project.mjs"
    },
    {
    ...
    },
    {
      ...
      "body": "docs/deps/ignore/index.html"
    }
  ],
  "roadmap": [
    {
