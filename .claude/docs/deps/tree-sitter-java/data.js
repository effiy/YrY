window.REPORT_DATA = {
  "meta": {
    "title": "tree-sitter-java dependency footprint",
    "pageTitle": "tree-sitter-java · Skills Dependency Report",
    "subtitle": "Runtime dependency · ^0.23.5 · 6 hit files across /Users/yi/YrY/.claude/skills",
    "footer": "Generated for .claude/docs/deps/tree-sitter-java/index.html · package tree-sitter-java · 6 hit files · 1 skill roots",
  ...
  "executiveSummary": [
    {
      ...
      "content": "Java grammar · AST parsing"
    },
    {
      "color": "green",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        "skills/rui-reports/diagram/pnpm-lock.yaml is the hottest touchpoint with 9 textual matches.",
        "skills/rui-reports/diagram/engine/core/src/languages/configs/javascript.js is a secondary touchpoint and should be reviewed when upgrading.",
  ...
  "trace": [
    ...
    },
    {
      "name": "Report",
      "nameClass": "cyan",
      "sub": "deps/tree-sitter-java/index.html",
      "time": "t4"
    }
  ],
  "scalingTiles": [
  ...
  "ownership": {
    ...
    "rows": [
      [
        ...
        "6",
        "<code>skills/rui-reports/diagram/engine/core/src/languages/configs/java.js</code>",
        "direct import"
      ]
    ]
  },
  "apiTable": {
    ...
    "rows": [
      ...
      [
        "<code>skills/rui-reports/diagram/engine/core/src/plugins/extractors/java-extractor.js</code>",
        "code",
        "1",
        "Executable implementation surface"
      ],
  ...
  "schemaTiles": [
    ...
    },
    {
      ...
      "body": "docs/deps/tree-sitter-java/index.html"
    }
  ],
  "roadmap": [
    {
