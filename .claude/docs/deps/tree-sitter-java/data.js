window.REPORT_DATA = {
  "meta": {
    "pageTitle": "tree-sitter-java footprint",
    "subtitle": "Runtime dependency · ^0.23.5 · 5 hit files across .claude/skills",
    "upstream": "https://github.com/tree-sitter/tree-sitter-java",
    "footer": "Generated for .claude/docs/deps/tree-sitter-java/index.html · package tree-sitter-java · 5 hit files · 1 skill roots · rebuilt 2026-07-19"
  },
  "metrics": [
    {
      "label": "Version",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/java.js (2 matches, direct)",
        ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/javascript.js (2 matches, direct)",
  ...
  "ownership": [
    {
      ...
      "fileCount": 5,
      "occurrences": 9,
      "primaryFile": ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/java.js",
      "usageType": "direct"
    }
  ],
  "reviewNotes": [
  ...
  "hitFiles": [
    {
      "path": ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/java.js",
      "occurrences": 2,
      "skillRoot": "rui-reports/diagram",
      "fileKind": "source",
      "usageType": "direct"
    ...
    {
      "path": ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/javascript.js",
      "occurrences": 2,
      "skillRoot": "rui-reports/diagram",
      "fileKind": "source",
      "usageType": "direct"
    ...
    {
      "path": ".claude/skills/rui-reports/diagram/engine/core/src/plugins/extractors/java-extractor.js",
      "occurrences": 1,
      "skillRoot": "rui-reports/diagram",
      "fileKind": "source",
      "usageType": "direct"
