window.REPORT_DATA = {
  "meta": {
    "title": "tree-sitter-python dependency footprint",
    "pageTitle": "tree-sitter-python · Skills Dependency Report",
    "subtitle": "Runtime dependency · ^0.25.0 · 3 hit files across /Users/yi/YrY/.claude/skills",
    "footer": "Generated for .claude/docs/deps/tree-sitter-python/index.html · package tree-sitter-python · 3 hit files · 1 skill roots",
  ...
  "executiveSummary": [
    {
      ...
      "content": "Python grammar · AST parsing"
    },
    {
      "color": "green",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        ...
        "skills/rui-reports/diagram/engine/core/src/languages/configs/python.js is a secondary touchpoint and should be reviewed when upgrading.",
  ...
  "trace": [
    ...
    },
    {
      "name": "Report",
      "nameClass": "cyan",
      "sub": "deps/tree-sitter-python/index.html",
      "time": "t4"
    }
  ],
  "scalingTiles": [
  ...
  "ownership": {
    ...
    "rows": [
      [
        ...
        "3",
        "<code>skills/rui-reports/diagram/engine/core/src/languages/configs/python.js</code>",
        "direct import"
      ]
    ]
  },
  ...
  "schemaTiles": [
    ...
    },
    {
      ...
      "body": "docs/deps/tree-sitter-python/index.html"
    }
  ],
  "roadmap": [
    {
