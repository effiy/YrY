window.REPORT_DATA = {
  "meta": {
    "pageTitle": "tree-sitter-python footprint",
    "subtitle": "Runtime dependency · ^0.25.0 · 2 hit files across .claude/skills",
    "upstream": "https://github.com/tree-sitter/tree-sitter-python",
    "footer": "Generated for .claude/docs/deps/tree-sitter-python/index.html · package tree-sitter-python · 2 hit files · 1 skill roots · rebuilt 2026-07-19"
  },
  "metrics": [
    {
      "label": "Version",
  ...
  "summaryCards": [
    {
      ...
      "items": [
        ...
        "2 direct files and 0 reference-only files currently match the package string."
      ]
    },
    {
      "tone": "violet",
      ...
      "items": [
        ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/python.js (2 matches, direct)",
  ...
  "ownership": [
    {
      ...
      "fileCount": 2,
      "occurrences": 3,
      "primaryFile": ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/python.js",
      "usageType": "direct"
    }
  ],
  "reviewNotes": [
  ...
  "hitFiles": [
    {
      "path": ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/python.js",
      "occurrences": 2,
      "skillRoot": "rui-reports/diagram",
      "fileKind": "source",
      "usageType": "direct"
