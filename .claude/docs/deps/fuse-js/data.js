window.REPORT_DATA = {
  "meta": {
    "pageTitle": "fuse.js footprint",
    "subtitle": "Runtime dependency · ^7.1.0 · 2 hit files across .claude/skills",
    "upstream": "https://fusejs.io/",
    "footer": "Generated for .claude/docs/deps/fuse-js/index.html · package fuse.js · 2 hit files · 1 skill roots · rebuilt 2026-07-19"
  },
  "metrics": [
    {
      "label": "Version",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        ".claude/skills/rui-reports/diagram/engine/core/src/search.js (1 matches, direct)",
    ...
    },
    {
      ...
      "items": [
        ...
        "Upstream reference is fusejs.io."
      ]
    }
  ],
  "ownership": [
    {
      ...
      "fileCount": 2,
      "occurrences": 2,
      "primaryFile": ".claude/skills/rui-reports/diagram/engine/core/src/search.js",
      "usageType": "direct"
    }
  ],
  "reviewNotes": [
  ...
  "hitFiles": [
    {
      "path": ".claude/skills/rui-reports/diagram/engine/core/src/search.js",
      "occurrences": 1,
      "skillRoot": "rui-reports/diagram",
      "fileKind": "source",
      "usageType": "direct"
