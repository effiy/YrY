window.REPORT_DATA = {
  "meta": {
    "title": "fuse.js dependency footprint",
    "pageTitle": "fuse.js · Skills Dependency Report",
    "subtitle": "Runtime dependency · ^7.1.0 · 3 hit files across /Users/yi/YrY/.claude/skills",
    "footer": "Generated for .claude/docs/deps/fuse-js/index.html · package fuse.js · 3 hit files · 1 skill roots",
  ...
  "executiveSummary": [
    {
      ...
      "content": "Lightweight fuzzy search · key-path matching"
    },
    {
      "color": "green",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        ...
        "skills/rui-reports/diagram/engine/core/src/search.js is a secondary touchpoint and should be reviewed when upgrading.",
    ...
    },
    {
      ...
      "items": [
        ...
        "Official reference host is fusejs.io; keep the page link aligned with upstream package naming and release history."
      ]
    }
  ],
  "pipeline": [
  ...
  "securityCards": [
    ...
    },
    {
      ...
      "items": [
        "Official reference resolves to fusejs.io.",
  ...
  "ownership": {
    ...
    "rows": [
      [
        ...
        "3",
        "<code>skills/rui-reports/diagram/engine/core/src/search.js</code>",
        "direct import"
      ]
    ]
  },
  ...
  "schemaTiles": [
    ...
    },
    {
      ...
      "body": "docs/deps/fuse-js/index.html"
    }
  ],
  "roadmap": [
    {
