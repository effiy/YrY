window.REPORT_DATA = {
  "meta": {
    "pageTitle": "tree-sitter-cpp footprint",
    "subtitle": "Runtime dependency · ^0.23.4 · 3 hit files across .claude/skills",
    "upstream": "https://github.com/tree-sitter/tree-sitter-cpp",
    "footer": "Generated for .claude/docs/deps/tree-sitter-cpp/index.html · package tree-sitter-cpp · 3 hit files · 1 skill roots · rebuilt 2026-07-19"
  },
  "metrics": [
    {
      "label": "Version",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/c.js (2 matches, direct)",
        ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/cpp.js (2 matches, direct)",
  ...
  "ownership": [
    {
      ...
      "fileCount": 3,
      "occurrences": 5,
      "primaryFile": ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/c.js",
      "usageType": "direct"
    }
  ],
  "reviewNotes": [
  ...
  "hitFiles": [
    {
      "path": ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/c.js",
      "occurrences": 2,
      "skillRoot": "rui-reports/diagram",
      "fileKind": "source",
      "usageType": "direct"
    ...
    {
      "path": ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/cpp.js",
      "occurrences": 2,
      "skillRoot": "rui-reports/diagram",
      "fileKind": "source",
      "usageType": "direct"
