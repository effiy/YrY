window.REPORT_DATA = {
  "meta": {
    "title": "tree-sitter-cpp dependency footprint",
    "pageTitle": "tree-sitter-cpp · Skills Dependency Report",
    "subtitle": "Runtime dependency · ^0.23.4 · 4 hit files across /Users/yi/YrY/.claude/skills",
    "footer": "Generated for .claude/docs/deps/tree-sitter-cpp/index.html · package tree-sitter-cpp · 4 hit files · 1 skill roots",
  ...
  "executiveSummary": [
    {
      ...
      "content": "C/C++ grammar · AST parsing"
    },
    {
      "color": "green",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        ...
        "skills/rui-reports/diagram/engine/core/src/languages/configs/c.js is a secondary touchpoint and should be reviewed when upgrading.",
  ...
  "pipeline": [
    ...
    },
    {
      "badge": "USAGE",
      "badgeClass": "green",
      "info": "3 direct import file(s) and 1 reference-only file(s) were found."
    },
    {
      "badge": "REPORT",
      "badgeClass": "violet",
  ...
  "trace": [
    ...
    },
    {
      "name": "Report",
      "nameClass": "cyan",
      "sub": "deps/tree-sitter-cpp/index.html",
      "time": "t4"
    }
  ],
  "scalingTiles": [
  ...
  "ownership": {
    ...
    "rows": [
      [
        ...
        "4",
        "<code>skills/rui-reports/diagram/engine/core/src/languages/configs/c.js</code>",
        "direct import"
      ]
    ]
  },
  "apiTable": {
    ...
    "rows": [
      ...
      [
        "<code>skills/rui-reports/diagram/engine/core/src/languages/configs/cpp.js</code>",
        "code",
        "1",
        "Executable implementation surface"
      ],
  ...
  "schemaTiles": [
    ...
    },
    {
      ...
      "body": "docs/deps/tree-sitter-cpp/index.html"
    }
  ],
  "roadmap": [
    {
