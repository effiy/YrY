window.REPORT_DATA = {
  "meta": {
    "title": "@tree-sitter-grammars/tree-sitter-kotlin dependency footprint",
    "pageTitle": "@tree-sitter-grammars/tree-sitter-kotlin · Skills Dependency Report",
    "subtitle": "Runtime dependency · 1.1.0 · 3 hit files across /Users/yi/YrY/.claude/skills",
    "footer": "Generated for .claude/docs/deps/tree-sitter-grammars-tree-sitter-kotlin/index.html · package @tree-sitter-grammars/tree-sitter-kotlin · 3 hit files · 1 skill roots",
  ...
  "executiveSummary": [
    {
      ...
      "content": "Kotlin grammar (KSP scoped) · AST parsing"
    },
    {
      "color": "green",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        "skills/rui-reports/diagram/engine/core/src/languages/configs/kotlin.js is the hottest touchpoint with 1 textual matches.",
  ...
  "pipeline": [
    ...
    },
    {
      "badge": "USAGE",
      "badgeClass": "green",
      "info": "3 direct import file(s) and 0 reference-only file(s) were found."
    },
    {
      "badge": "REPORT",
      "badgeClass": "violet",
  ...
  "securityCards": [
    ...
    },
    {
      ...
      "items": [
        ...
        "Primary file hotspot: skills/rui-reports/diagram/engine/core/src/languages/configs/kotlin.js.",
  ...
  "trace": [
    ...
    },
    {
      "name": "Dependency",
      "nameClass": "green",
      "sub": "@tree-sitter-grammars/tree-sitter-kotlin",
      "time": "t2"
    },
    {
    ...
    },
    {
      "name": "Report",
      "nameClass": "cyan",
      "sub": "deps/tree-sitter-grammars-tree-sitter-kotlin/index.html",
      "time": "t4"
    }
  ],
  "scalingTiles": [
    ...
    },
    {
      "color": "violet",
      "title": "Review Focus",
      "body": "Start review at <code>skills/rui-reports/diagram/engine/core/src/languages/configs/kotlin.js</code>."
    }
  ],
  "ownership": {
    "headers": [
    ...
    "rows": [
      [
        ...
        "3",
        "<code>skills/rui-reports/diagram/engine/core/src/languages/configs/kotlin.js</code>",
        "direct import"
      ]
    ]
  },
  ...
  "stack": [
    {
      "label": "Package",
      "value": "@tree-sitter-grammars/tree-sitter-kotlin",
      "valueClass": "green"
    },
    {
      "label": "Version",
  ...
  "schemaTiles": [
    ...
    },
    {
      ...
      "body": "skills/rui-reports/diagram/engine/core/src/languages/configs/kotlin.js"
    },
    {
    ...
    },
    {
      ...
      "body": "docs/deps/tree-sitter-grammars-tree-sitter-kotlin/index.html"
    }
  ],
  "roadmap": [
    {
