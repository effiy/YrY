window.REPORT_DATA = {
  "meta": {
    "pageTitle": "tree-sitter-javascript footprint",
    "subtitle": "Runtime dependency · ^0.25.0 · 3 hit files across .claude/skills",
    "upstream": "https://github.com/tree-sitter/tree-sitter-javascript",
    "footer": "Generated for .claude/docs/deps/tree-sitter-javascript/index.html · package tree-sitter-javascript · 3 hit files · 1 skill roots · rebuilt 2026-07-19"
  },
  "metrics": [
    {
      "label": "Version",
  ...
  "ownership": [
    {
      ...
      "fileCount": 3,
      "occurrences": 5,
      "primaryFile": ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/javascript.js",
      "usageType": "direct"
    }
  ],
  "reviewNotes": [
