window.REPORT_DATA = {
  "meta": {
    "title": "tree-sitter-javascript dependency footprint",
    "pageTitle": "tree-sitter-javascript · Skills Dependency Report",
    "subtitle": "Runtime dependency · ^0.25.0 · 4 hit files across /Users/yi/YrY/.claude/skills",
    "footer": "Generated for .claude/docs/deps/tree-sitter-javascript/index.html · package tree-sitter-javascript · 4 hit files · 1 skill roots",
  ...
  "executiveSummary": [
    {
      ...
      "content": "JavaScript grammar · AST parsing"
    },
    {
      "color": "green",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        "skills/rui-reports/diagram/pnpm-lock.yaml is the hottest touchpoint with 6 textual matches.",
        "skills/rui-reports/diagram/engine/core/src/plugins/tree-sitter-plugin.js is a secondary touchpoint and should be reviewed when upgrading.",
  ...
  "trace": [
    ...
    },
    {
      "name": "Report",
      "nameClass": "cyan",
      "sub": "deps/tree-sitter-javascript/index.html",
      "time": "t4"
    }
  ],
  "scalingTiles": [
  ...
  "ownership": {
    ...
    "rows": [
      [
        ...
        "4",
        "<code>skills/rui-reports/diagram/engine/core/src/languages/configs/javascript.js</code>",
        "direct import"
      ]
    ]
  },
  ...
  "schemaTiles": [
    ...
    },
    {
      ...
      "body": "docs/deps/tree-sitter-javascript/index.html"
    }
  ],
  "roadmap": [
    {
