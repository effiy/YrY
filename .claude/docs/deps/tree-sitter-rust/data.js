window.REPORT_DATA = {
  "meta": {
    "pageTitle": "tree-sitter-rust footprint",
    "subtitle": "Runtime dependency · ^0.24.0 · 3 hit files across .claude/skills",
    "upstream": "https://github.com/tree-sitter/tree-sitter-rust",
    "footer": "Generated for .claude/docs/deps/tree-sitter-rust/index.html · package tree-sitter-rust · 3 hit files · 1 skill roots · rebuilt 2026-07-19"
  },
  "metrics": [
    {
      "label": "Version",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/rust.js (2 matches, direct)",
        ".claude/skills/rui-reports/diagram/engine/core/src/plugins/extractors/rust/function.js (1 matches, direct)",
  ...
  "ownership": [
    {
      ...
      "fileCount": 3,
      "occurrences": 4,
      "primaryFile": ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/rust.js",
      "usageType": "direct"
    }
  ],
  "reviewNotes": [
  ...
  "hitFiles": [
    {
      "path": ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/rust.js",
      "occurrences": 2,
      "skillRoot": "rui-reports/diagram",
      "fileKind": "source",
      "usageType": "direct"
    ...
    {
      "path": ".claude/skills/rui-reports/diagram/engine/core/src/plugins/extractors/rust/function.js",
      "occurrences": 1,
      "skillRoot": "rui-reports/diagram",
      "fileKind": "source",
      "usageType": "direct"
