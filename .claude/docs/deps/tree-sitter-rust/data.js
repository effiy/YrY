window.REPORT_DATA = {
  "meta": {
    "title": "tree-sitter-rust dependency footprint",
    "pageTitle": "tree-sitter-rust · Skills Dependency Report",
    "subtitle": "Runtime dependency · ^0.24.0 · 4 hit files across /Users/yi/YrY/.claude/skills",
    "footer": "Generated for .claude/docs/deps/tree-sitter-rust/index.html · package tree-sitter-rust · 4 hit files · 1 skill roots",
  ...
  "executiveSummary": [
    {
      ...
      "content": "Rust grammar · AST parsing"
    },
    {
      "color": "green",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        ...
        "skills/rui-reports/diagram/engine/core/src/languages/configs/rust.js is a secondary touchpoint and should be reviewed when upgrading.",
  ...
  "trace": [
    ...
    },
    {
      "name": "Report",
      "nameClass": "cyan",
      "sub": "deps/tree-sitter-rust/index.html",
      "time": "t4"
    }
  ],
  "scalingTiles": [
  ...
  "ownership": {
    ...
    "rows": [
      [
        ...
        "4",
        "<code>skills/rui-reports/diagram/engine/core/src/languages/configs/rust.js</code>",
        "direct import"
      ]
    ]
  },
  "apiTable": {
    ...
    "rows": [
      ...
      [
        "<code>skills/rui-reports/diagram/engine/core/src/plugins/extractors/rust-extractor.js</code>",
        "code",
        "1",
        "Executable implementation surface"
      ],
  ...
  "schemaTiles": [
    ...
    },
    {
      ...
      "body": "docs/deps/tree-sitter-rust/index.html"
    }
  ],
  "roadmap": [
    {
