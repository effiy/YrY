window.REPORT_DATA = {
  "meta": {
    "title": "zod dependency footprint",
    "pageTitle": "zod · Skills Dependency Report",
    "subtitle": "Runtime dependency · ^4.3.6 · 10 hit files across /Users/yi/YrY/.claude/skills",
    "footer": "Generated for .claude/docs/deps/zod/index.html · package zod · 10 hit files · 4 skill roots",
  ...
  "executiveSummary": [
    {
      ...
      "content": "TypeScript-first schema validation · type guards"
    },
    {
      "color": "green",
      "title": "Where It Lands",
      "content": "Top consumer skill: rui-reports/diagram. Consumer count: 4."
    },
    {
      "color": "amber",
      "title": "Why Review It",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        "skills/rui-code/nodejs/references/README-nodebestpractices.md is the hottest touchpoint with 4 textual matches.",
        "skills/rui-reports/diagram/pnpm-lock.yaml is a secondary touchpoint and should be reviewed when upgrading.",
    ...
    },
    {
      ...
      "items": [
        ...
        "Official reference host is zod.dev; keep the page link aligned with upstream package naming and release history."
      ]
    }
  ],
  "pipeline": [
    ...
    },
    {
      "badge": "USAGE",
      "badgeClass": "green",
      "info": "5 direct import file(s) and 5 reference-only file(s) were found."
    },
    {
      "badge": "REPORT",
      "badgeClass": "violet",
  ...
  "securityCards": [
    ...
    },
    {
      ...
      "items": [
        "Official reference resolves to zod.dev.",
    ...
    },
    {
      ...
      "items": [
        ...
        "Primary file hotspot: skills/rui-code/nodejs/references/README-nodebestpractices.md.",
  ...
  "trace": [
    ...
    },
    {
      ...
      "nameClass": "violet",
      "sub": "README-nodebestpractices.md",
      "time": "t3"
    },
    {
      "name": "Report",
      "nameClass": "cyan",
      "sub": "deps/zod/index.html",
      "time": "t4"
    }
  ],
  "scalingTiles": [
    ...
    },
    {
      ...
      "body": "Top spread: <code>rui-reports/diagram</code> with 5 hit(s)."
    },
    {
      "color": "amber",
      "title": "Drift Signal",
    ...
    },
    {
      "color": "violet",
      "title": "Review Focus",
      "body": "Start review at <code>skills/rui-code/nodejs/references/README-nodebestpractices.md</code>."
    }
  ],
  "ownership": {
    "headers": [
    ...
    "rows": [
      ...
      [
        "<code>rui-tools/public-api</code>",
        "3",
        "<code>skills/rui-tools/public-api/references/README-public-api-lists.md</code>",
      ...
      [
        "<code>rui-tools/ui-ux</code>",
        "1",
        "<code>skills/rui-tools/ui-ux/references/shadcn-components.md</code>",
        "direct import"
      ]
    ]
  },
  "apiTable": {
    ...
    "rows": [
      ...
      [
        "<code>skills/rui-reports/diagram/engine/core/src/languages/types.js</code>",
        "code",
        "1",
        "Executable implementation surface"
      ],
      [
        "<code>skills/rui-reports/diagram/engine/core/src/schema.js</code>",
        "code",
        "1",
        "Executable implementation surface"
      ],
  ...
  "schemaTiles": [
    ...
    },
    {
      ...
      "body": "skills/rui-code/nodejs/references/README-nodebestpractices.md"
    },
    {
