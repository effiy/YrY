window.REPORT_DATA = {
  "meta": {
    "pageTitle": "zod footprint",
    "subtitle": "Runtime dependency · ^4.3.6 · 5 hit files across .claude/skills",
    "upstream": "https://zod.dev/",
    "footer": "Generated for .claude/docs/deps/zod/index.html · package zod · 5 hit files · 3 skill roots · rebuilt 2026-07-19"
  },
  "metrics": [
    {
      "label": "Version",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        ".claude/skills/rui-tools/ui-ux/references/shadcn-components.md (4 matches, reference)",
        ".claude/skills/rui-reports/quickstart/templates/data.js (2 matches, direct)",
        ".claude/skills/rui-reports/diagram/engine/core/src/languages/types.js (1 matches, direct)"
      ]
    },
    {
      "tone": "green",
  ...
  "ownership": [
    {
      ...
      "fileCount": 3,
      "occurrences": 3,
      "primaryFile": ".claude/skills/rui-reports/diagram/engine/core/src/languages/types.js",
      "usageType": "direct"
    },
    {
      "skillRoot": "rui-tools/ui-ux",
      "fileCount": 1,
      "occurrences": 4,
      "primaryFile": ".claude/skills/rui-tools/ui-ux/references/shadcn-components.md",
      "usageType": "reference"
    },
    {
  ...
  "hitFiles": [
    {
      "path": ".claude/skills/rui-tools/ui-ux/references/shadcn-components.md",
      "occurrences": 4,
      "skillRoot": "rui-tools/ui-ux",
      "fileKind": "docs",
      "usageType": "reference"
    ...
    {
      "path": ".claude/skills/rui-reports/diagram/engine/core/src/languages/types.js",
      "occurrences": 1,
      "skillRoot": "rui-reports/diagram",
      "fileKind": "source",
      "usageType": "direct"
    ...
    {
      "path": ".claude/skills/rui-reports/diagram/engine/core/src/schema.js",
      "occurrences": 1,
      "skillRoot": "rui-reports/diagram",
      "fileKind": "source",
      "usageType": "direct"
