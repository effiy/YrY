window.REPORT_DATA = {
  "meta": {
    "pageTitle": "tree-sitter-ruby footprint",
    "subtitle": "Runtime dependency · ^0.23.1 · 2 hit files across .claude/skills",
    "upstream": "https://github.com/tree-sitter/tree-sitter-ruby",
    "footer": "Generated for .claude/docs/deps/tree-sitter-ruby/index.html · package tree-sitter-ruby · 2 hit files · 1 skill roots · rebuilt 2026-07-19"
  },
  "metrics": [
    {
      "label": "Version",
  ...
  "summaryCards": [
    ...
    },
    {
      ...
      "items": [
        ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/ruby.js (2 matches, direct)",
  ...
  "ownership": [
    {
      ...
      "fileCount": 2,
      "occurrences": 3,
      "primaryFile": ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/ruby.js",
      "usageType": "direct"
    }
  ],
  "reviewNotes": [
  ...
  "hitFiles": [
    {
      "path": ".claude/skills/rui-reports/diagram/engine/core/src/languages/configs/ruby.js",
      "occurrences": 2,
      "skillRoot": "rui-reports/diagram",
      "fileKind": "source",
      "usageType": "direct"
