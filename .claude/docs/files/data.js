window.REPORT_CONFIG = {
    ...
    options: {
        ...
        noCycles: false,
        theme: 'dark',
        generatedAt: '2026-07-18T05:15:58.441Z', /* ISO 8601 UTC — filled in by the analyzer */
    },
...
window.REPORT_DATA = {
  ...
  "alerts": [
    ...
    },
    {
      ...
      "line": null,
      "message": "Hotspot score 5.43 (>= 5.0)",
      "metric": "hotspot 5.43",
      ...
      "blastRadius": "27 inbound+outbound edges",
      "effort": "medium",
      "estimatedHours": 8,
      "scoreUplift": 5,
      "recommendations": [
    ...
    },
    {
      ...
      "line": null,
      "message": "File exceeds 1000 LOC (1373 lines)",
      "metric": "1373 LOC",
      "impact": "Large file → high cognitive load, merge conflicts, review fatigue, slower onboarding.",
      "risk": "If left unfixed: every PR touching this file scales linearly in review time, and defect density compounds with each new branch.",
      "blastRadius": "file-local + reviewers",
    ...
    },
    {
      ...
      "line": null,
      "message": "File exceeds 1000 LOC (6553 lines)",
      "metric": "6553 LOC",
      "impact": "Large file → high cognitive load, merge conflicts, review fatigue, slower onboarding.",
      "risk": "If left unfixed: every PR touching this file scales linearly in review time, and defect density compounds with each new branch.",
      "blastRadius": "file-local + reviewers",
    ...
    },
    {
      ...
      "line": null,
      "message": "File exceeds 1000 LOC (1181 lines)",
      "metric": "1181 LOC",
      "impact": "Large file → high cognitive load, merge conflicts, review fatigue, slower onboarding.",
      "risk": "If left unfixed: every PR touching this file scales linearly in review time, and defect density compounds with each new branch.",
      "blastRadius": "file-local + reviewers",
    ...
    },
    {
      ...
      "marker": "P1",
      "category": "bloat",
      "file": "rui-init/templates/index.css",
      "line": null,
      "message": "File exceeds 500 LOC (671 lines)",
      "metric": "671 LOC",
      "impact": "Large file → high cognitive load, merge conflicts, review fatigue, slower onboarding.",
      "risk": "If left unfixed: every PR touching this file scales linearly in review time, and defect density compounds with each new branch.",
      "blastRadius": "file-local + reviewers",
      ...
      "scoreUplift": 4,
      "recommendations": [
        "Split by responsibility: extract cohesive regions into rui-init/templates/index.css/{a,b}.ext and re-export from a barrel index.",
        "Move pure helpers into a sibling <name>-utils.ext and unit-test them in isolation.",
        "Add a LOC budget (e.g., 500/1000) to lint or CI so the file cannot silently regress.",
        "After the split, re-run this report and confirm fan-out / depth drop before merge."
      ],
      ...
      "firstStep": "Open rui-init/templates/index.css and list its top-level responsibilities (one sentence each) — that list becomes the split plan.",
      "tooling": [
        {
          "name": "eslint-plugin-import",
          "hint": "enforce per-file LOC budgets via max-lines + boundary rules"
    ...
    },
    {
      ...
      "marker": "P1",
      "category": "bloat",
      "file": "rui-reports/daily/evals/evals.json",
      "line": null,
      ...
      "scoreUplift": 4,
      "recommendations": [
        "Split by responsibility: extract cohesive regions into rui-reports/daily/evals/evals.json/{a,b}.ext and re-export from a barrel index.",
        "Move pure helpers into a sibling <name>-utils.ext and unit-test them in isolation.",
        "Add a LOC budget (e.g., 500/1000) to lint or CI so the file cannot silently regress.",
        "After the split, re-run this report and confirm fan-out / depth drop before merge."
      ],
      ...
      "firstStep": "Open rui-reports/daily/evals/evals.json and list its top-level responsibilities (one sentence each) — that list becomes the split plan.",
      "tooling": [
        {
          "name": "eslint-plugin-import",
          "hint": "enforce per-file LOC budgets via max-lines + boundary rules"
    ...
    },
    {
      ...
      "marker": "P1",
      "category": "bloat",
      "file": "rui-reports/daily/templates/index.js",
      "line": null,
      "message": "File exceeds 500 LOC (870 lines)",
      "metric": "870 LOC",
      "impact": "Large file → high cognitive load, merge conflicts, review fatigue, slower onboarding.",
      "risk": "If left unfixed: every PR touching this file scales linearly in review time, and defect density compounds with each new branch.",
      "blastRadius": "file-local + reviewers",
      ...
      "scoreUplift": 4,
      "recommendations": [
        "Split by responsibility: extract cohesive regions into rui-reports/daily/templates/index.js/{a,b}.ext and re-export from a barrel index.",
        "Move pure helpers into a sibling <name>-utils.ext and unit-test them in isolation.",
        "Add a LOC budget (e.g., 500/1000) to lint or CI so the file cannot silently regress.",
        "After the split, re-run this report and confirm fan-out / depth drop before merge."
      ],
      ...
      "firstStep": "Open rui-reports/daily/templates/index.js and list its top-level responsibilities (one sentence each) — that list becomes the split plan.",
      "tooling": [
        {
          "name": "eslint-plugin-import",
          "hint": "enforce per-file LOC budgets via max-lines + boundary rules"
    ...
    },
    {
      ...
      "line": null,
      "message": "File exceeds 500 LOC (688 lines)",
      "metric": "688 LOC",
      "impact": "Large file → high cognitive load, merge conflicts, review fatigue, slower onboarding.",
      "risk": "If left unfixed: every PR touching this file scales linearly in review time, and defect density compounds with each new branch.",
      "blastRadius": "file-local + reviewers",
  ...
  "treemap": [
    ...
    {
      "name": "rui-reports/daily/templates/",
      "bytes": 162069,
      "humanBytes": "158.3 KB"
    },
    {
    ...
    {
      "name": "rui-reports/daily/references/",
      "bytes": 126962,
      "humanBytes": "124.0 KB"
    },
    {
    ...
    {
      "name": "rui-reports/diagram/languages/",
      "bytes": 85069,
      "humanBytes": "83.1 KB"
    },
    {
      "name": "rui-tools/lighthouse/references/",
      "bytes": 76734,
      "humanBytes": "74.9 KB"
    },
    {
    ...
    {
      "name": "rui-reports/diagram/engine/core/src/analyzer/",
      "bytes": 73783,
      "humanBytes": "72.1 KB"
    },
    {
      "name": "rui-init/templates/",
      "bytes": 72901,
      "humanBytes": "71.2 KB"
    }
  ],
  ...
  "fanin": [
    ...
    {
      "path": "rui-tools/import/lib/config.mjs",
      "fanIn": 6,
      "fanOut": 1,
      "extDeps": 0,
      "lines": 14,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/dart/function.js",
      "fanIn": 4,
      "fanOut": 1,
      "extDeps": 0,
      "lines": 194,
    ...
    {
      "path": "rui-tools/import/lib/io.mjs",
      "fanIn": 4,
      "fanOut": 0,
      "extDeps": 0,
      "lines": 72,
    ...
    {
      "path": "rui-tools/import/lib/scan.mjs",
      "fanIn": 4,
      "fanOut": 1,
      "extDeps": 2,
      "lines": 46,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/function.js",
      "fanIn": 3,
      "fanOut": 1,
      "extDeps": 0,
      "lines": 102,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/php/function.js",
      "fanIn": 3,
      "fanOut": 1,
      "extDeps": 0,
      "lines": 69,
    ...
    {
      "path": "rui-tools/import/lib/api.mjs",
      "fanIn": 3,
      "fanOut": 3,
      "extDeps": 0,
      "lines": 68,
    ...
    {
      "path": "rui-tools/import/lib/constants.mjs",
      "fanIn": 3,
      "fanOut": 0,
      "extDeps": 0,
      "lines": 9,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/function.js",
      "fanIn": 2,
      "fanOut": 1,
      "extDeps": 0,
      "lines": 58,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/rust/function.js",
      "fanIn": 2,
      "fanOut": 1,
      "extDeps": 0,
      "lines": 55,
  ...
  "fanout": [
    ...
    {
      "path": "rui-tools/import/sync.mjs",
      "fanIn": 0,
      "fanOut": 7,
      "extDeps": 2,
      "lines": 141,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/index.js",
      "fanIn": 1,
      "fanOut": 5,
      "extDeps": 0,
      "lines": 151,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/dart/index.js",
      "fanIn": 1,
      "fanOut": 5,
      "extDeps": 0,
      "lines": 108,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/php/index.js",
      "fanIn": 1,
      "fanOut": 5,
      "extDeps": 0,
      "lines": 98,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/index.js",
      "fanIn": 1,
      "fanOut": 4,
      "extDeps": 0,
      "lines": 106,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/rust/index.js",
      "fanIn": 1,
      "fanOut": 4,
      "extDeps": 0,
      "lines": 78,
    ...
    {
      "path": "rui-tools/import/lib/upload.mjs",
      "fanIn": 1,
      "fanOut": 4,
      "extDeps": 1,
      "lines": 47,
    ...
    {
      "path": "rui-tools/import/lib/cli.mjs",
      "fanIn": 1,
      "fanOut": 3,
      "extDeps": 0,
      "lines": 70,
    ...
    {
      "path": "rui-tools/import/lib/diagnose.mjs",
      "fanIn": 0,
      "fanOut": 3,
      "extDeps": 1,
      "lines": 51,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/class.js",
      "fanIn": 1,
      "fanOut": 2,
      "extDeps": 0,
      "lines": 113,
  ...
  "records": [
    ...
    {
      "path": "rui-reports/daily/commands/plan.md",
      "bytes": 8563,
      "lines": 169,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/references/plan-assumptions.md",
      "bytes": 6223,
      "lines": 132,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/references/plan-capacity.md",
      "bytes": 5346,
      "lines": 151,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/references/plan-decisions.md",
      "bytes": 7584,
      "lines": 151,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/references/plan-diff.md",
      "bytes": 6106,
      "lines": 152,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/references/plan-examples.md",
      "bytes": 15229,
      "lines": 288,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/references/plan-metrics.md",
      "bytes": 5802,
      "lines": 114,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/references/plan-render.md",
      "bytes": 12958,
      "lines": 359,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/references/plan-review.md",
      "bytes": 5243,
      "lines": 128,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/references/plan-scenarios.md",
      "bytes": 8069,
      "lines": 191,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/references/plan-validation.md",
      "bytes": 8994,
      "lines": 157,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/references/plan-workflow.md",
      "bytes": 18913,
      "lines": 398,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/references/project-report-workflow.md",
      "bytes": 11703,
      "lines": 240,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/templates/data.js",
      "bytes": 17916,
      "lines": 473,
      "type": "js",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/templates/index.css",
      "bytes": 14393,
      "lines": 383,
      "type": "css",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/templates/index.html",
      "bytes": 3412,
      "lines": 62,
      "type": "other",
      "lastModified": 1784349429,
      "fanIn": 0,
      "fanOut": 0,
      "extDeps": 0,
      "maxDepth": 0,
    ...
    {
      "path": "rui-reports/daily/templates/index.js",
      "bytes": 45036,
      "lines": 870,
      "type": "js",
      "lastModified": 1784349414,
      "fanIn": 0,
      "fanOut": 0,
      "extDeps": 0,
      "maxDepth": 0,
    ...
    {
      "path": "rui-reports/daily/templates/lib/planToMarkdown.js",
      "bytes": 15183,
      "lines": 382,
      "type": "js",
      "lastModified": 1784349289,
      "fanIn": 0,
      "fanOut": 0,
      "extDeps": 0,
      "maxDepth": 0,
    ...
    {
      "path": "rui-reports/daily/templates/report/data.js",
      "bytes": 21048,
      "lines": 391,
      "type": "js",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/templates/report/index.css",
      "bytes": 11876,
      "lines": 384,
      "type": "css",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/templates/report/index.html",
      "bytes": 3204,
      "lines": 60,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/templates/report/index.js",
      "bytes": 21629,
      "lines": 449,
      "type": "js",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/daily/templates/test_load_order.js",
      "bytes": 3595,
      "lines": 74,
      "type": "js",
      "lastModified": 1784349443,
      "fanIn": 0,
      "fanOut": 0,
      "extDeps": 0,
      "maxDepth": 0,
    ...
    {
      "path": "rui-reports/daily/templates/test_planToMarkdown.js",
      "bytes": 4777,
      "lines": 126,
      "type": "js",
      "lastModified": 1784349311,
      "fanIn": 0,
      "fanOut": 0,
      "extDeps": 0,
      "maxDepth": 0,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/calls.js",
      "bytes": 2876,
      "lines": 87,
      "type": "js",
      "lastModified": 1784345874,
      "fanIn": 1,
      "fanOut": 1,
      "extDeps": 0,
      "maxDepth": 2,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/import.js",
      "bytes": 1364,
      "lines": 41,
      "type": "js",
      "lastModified": 1784345869,
      "fanIn": 1,
      "fanOut": 1,
      "extDeps": 0,
      "maxDepth": 1,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/calls.js",
      "bytes": 3084,
      "lines": 82,
      "type": "js",
      "lastModified": 1784345940,
      "fanIn": 1,
      "fanOut": 1,
      "extDeps": 0,
      "maxDepth": 1,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/class.js",
      "bytes": 6974,
      "lines": 211,
      "type": "js",
      "lastModified": 1784345933,
      "fanIn": 1,
      "fanOut": 2,
      "extDeps": 0,
      "maxDepth": 2,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/import.js",
      "bytes": 1606,
      "lines": 44,
      "type": "js",
      "lastModified": 1784345935,
      "fanIn": 1,
      "fanOut": 1,
      "extDeps": 0,
      "maxDepth": 1,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/dart/calls.js",
      "bytes": 7918,
      "lines": 185,
      "type": "js",
      "lastModified": 1784345158,
      "fanIn": 1,
      "fanOut": 2,
      "extDeps": 0,
      "maxDepth": 2,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/dart/class.js",
      "bytes": 7238,
      "lines": 181,
      "type": "js",
      "lastModified": 1784345207,
      "fanIn": 1,
      "fanOut": 2,
      "extDeps": 0,
      "maxDepth": 2,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/dart/import.js",
      "bytes": 2910,
      "lines": 75,
      "type": "js",
      "lastModified": 1784345149,
      "fanIn": 1,
      "fanOut": 2,
      "extDeps": 0,
      "maxDepth": 2,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/php/calls.js",
      "bytes": 3475,
      "lines": 85,
      "type": "js",
      "lastModified": 1784346016,
      "fanIn": 1,
      "fanOut": 1,
      "extDeps": 0,
      "maxDepth": 1,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/php/class.js",
      "bytes": 4729,
      "lines": 131,
      "type": "js",
      "lastModified": 1784346005,
      "fanIn": 1,
      "fanOut": 2,
      "extDeps": 0,
      "maxDepth": 2,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/php/import.js",
      "bytes": 2824,
      "lines": 79,
      "type": "js",
      "lastModified": 1784346010,
      "fanIn": 1,
      "fanOut": 2,
      "extDeps": 0,
      "maxDepth": 2,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/rust/calls.js",
      "bytes": 2254,
      "lines": 71,
      "type": "js",
      "lastModified": 1784345978,
      "fanIn": 1,
      "fanOut": 0,
      "extDeps": 0,
      "maxDepth": 0,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/rust/class.js",
      "bytes": 6569,
      "lines": 198,
      "type": "js",
      "lastModified": 1784345969,
      "fanIn": 1,
      "fanOut": 2,
      "extDeps": 0,
      "maxDepth": 2,
    ...
    {
      "path": "rui-reports/diagram/engine/core/src/plugins/extractors/rust/import.js",
      "bytes": 4031,
      "lines": 110,
      "type": "js",
      "lastModified": 1784345975,
      "fanIn": 1,
      "fanOut": 1,
      "extDeps": 0,
      "maxDepth": 1,
    ...
    {
      "path": "rui-reports/quickstart/commands/create.md",
      "bytes": 10260,
      "lines": 184,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/quickstart/evals/evals.json",
      "bytes": 10828,
      "lines": 145,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-reports/quickstart/SKILL.md",
      "bytes": 11802,
      "lines": 218,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-tools/import/lib/find-root.mjs",
      "bytes": 549,
      "lines": 18,
      "type": "mjs",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-tools/import/lib/pull.mjs",
      "bytes": 5268,
      "lines": 146,
      "type": "mjs",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-tools/import/rules/sync-rules.md",
      "bytes": 4522,
      "lines": 102,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-tools/import/SKILL.md",
      "bytes": 4835,
      "lines": 105,
      "type": "other",
      "lastModified": 1784302058,
    ...
    {
      "path": "rui-tools/public-api/scripts/__pycache__/parse_readme.cpython-313.pyc",
      "bytes": 14375,
      "lines": 131,
      "type": "other",
      "lastModified": 1784349113,
      "fanIn": 0,
      "fanOut": 0,
      "extDeps": 0,
      "maxDepth": 0,
    ...
    {
      "path": "rui-tools/public-api/scripts/parse_readme.py",
      "bytes": 11171,
      "lines": 324,
      "type": "py",
      "lastModified": 1784344882,
      "fanIn": 0,
      "fanOut": 0,
      "extDeps": 3,
      "maxDepth": 0,
    ...
    {
      "path": "rui-tools/public-api/scripts/test_parse_readme.py",
      "bytes": 9233,
      "lines": 252,
      "type": "py",
      "lastModified": 1784349140,
      "fanIn": 0,
      "fanOut": 0,
      "extDeps": 2,
      "maxDepth": 0,
  ...
  "adjacency": {
    ...
    "rui-reports/daily/templates/data.js": [],
    "rui-reports/daily/templates/index.css": [],
    "rui-reports/daily/templates/index.js": [],
    "rui-reports/daily/templates/lib/planToMarkdown.js": [],
    "rui-reports/daily/templates/report/data.js": [],
    "rui-reports/daily/templates/report/index.css": [],
    "rui-reports/daily/templates/report/index.js": [],
    "rui-reports/daily/templates/test_load_order.js": [],
    "rui-reports/daily/templates/test_planToMarkdown.js": [],
    ...
    "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/calls.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/function.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/class.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/function.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/function.js": [
    ...
    "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/import.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/index.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/class.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/import.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/calls.js",
    ...
    "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/calls.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/class.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/function.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/function.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/import.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/index.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/class.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/import.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/calls.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/function.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/dart/calls.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/dart/function.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/dart/class.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/dart/function.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/dart/function.js": [
    ...
    "rui-reports/diagram/engine/core/src/plugins/extractors/dart/import.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/dart/function.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/dart/index.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/dart/function.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/dart/class.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/dart/import.js",
    ...
    "rui-reports/diagram/engine/core/src/plugins/extractors/index.js": [
      ...
      "rui-reports/diagram/engine/core/src/plugins/extractors/cpp/index.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/csharp/index.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/rust/index.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/go-extractor.js",
      ...
      "rui-reports/diagram/engine/core/src/plugins/extractors/php/index.js",
    ...
    "rui-reports/diagram/engine/core/src/plugins/extractors/php/calls.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/php/class.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/php/function.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/php/function.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/php/import.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/php/function.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/php/index.js": [
    ...
    "rui-reports/diagram/engine/core/src/plugins/extractors/rust/calls.js": [],
    "rui-reports/diagram/engine/core/src/plugins/extractors/rust/class.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js",
      "rui-reports/diagram/engine/core/src/plugins/extractors/rust/function.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/rust/function.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/rust/import.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js"
    ],
    "rui-reports/diagram/engine/core/src/plugins/extractors/rust/index.js": [
      "rui-reports/diagram/engine/core/src/plugins/extractors/rust/class.js",
    ...
    "rui-tools/import/lib/api.mjs": [
      ...
      "rui-tools/import/lib/scan.mjs"
    ],
    "rui-tools/import/lib/cli.mjs": [
      "rui-tools/import/lib/constants.mjs",
      "rui-tools/import/lib/io.mjs",
      "rui-tools/import/lib/config.mjs"
    ],
    "rui-tools/import/lib/config.mjs": [
    ...
    "rui-tools/import/lib/constants.mjs": [],
    "rui-tools/import/lib/diagnose.mjs": [
      "rui-tools/import/lib/config.mjs",
      "rui-tools/import/lib/scan.mjs",
      "rui-tools/import/lib/api.mjs"
    ],
    "rui-tools/import/lib/find-root.mjs": [],
    "rui-tools/import/lib/io.mjs": [],
    "rui-tools/import/lib/pull.mjs": [
      "rui-tools/import/lib/io.mjs",
      "rui-tools/import/lib/config.mjs"
    ],
    "rui-tools/import/lib/scan.mjs": [
    ...
    "rui-tools/import/lib/upload.mjs": [
      "rui-tools/import/lib/constants.mjs",
      "rui-tools/import/lib/io.mjs",
      "rui-tools/import/lib/scan.mjs",
      "rui-tools/import/lib/api.mjs"
    ],
    "rui-tools/import/sync.mjs": [
      "rui-tools/import/lib/find-root.mjs",
      "rui-tools/import/lib/config.mjs",
      "rui-tools/import/lib/cli.mjs",
      "rui-tools/import/lib/scan.mjs",
    ...
    "rui-tools/public-api/scripts/parse_readme.py": [],
    "rui-tools/public-api/scripts/test_parse_readme.py": [],
  ...
  "selfImprovement": {
    "topP0": [
      {
        "action": "File exceeds 1000 LOC (3945 lines)",
        "file": "rui-code/vite/references/index.json",
        "line": null,
        "severity": "P0"
      },
      {
        "action": "Hotspot score 5.43 (>= 5.0)",
        "file": "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js",
        "line": null,
        "severity": "P0"
      },
      {
        "action": "File exceeds 1000 LOC (2679 lines)",
        "file": "rui-reports/diagram/engine/tree-sitter-dart-wasm/tree-sitter-dart.wasm",
        "line": null,
        "severity": "P0"
      },
      {
        "action": "File exceeds 1000 LOC (1309 lines)",
        "file": "rui-reports/diagram/pnpm-lock.yaml",
        "line": null,
        "severity": "P0"
      },
      {
        "action": "File exceeds 1000 LOC (1676 lines)",
        "file": "rui-reports/diagram/scripts/extract-import-map.mjs",
        "line": null,
        "severity": "P0"
      }
    ...
    "focusArea": {
      ...
      "score": 58,
      "why": "Oversized files is at 58/100 with 23 P0 and 41 P1 alerts. Address to lift composite score.",
      "hint": "Invest focused effort on top 3 levers for the largest uplift."
    },
    "trendInsight": "Score 87 (grade B). Oversized files is the weakest dimension at 58/100.",
    "weightsHint": "Consider increasing Oversized files weight given its outsized impact on overall health.",
    "narrative": [
      "Overall health at 87/100 (grade B) — good shape with clear remediation path.",
      "23 critical (P0) and 41 major (P1) alerts active. Primary risks cluster around Oversized files (score 58).",
      "Top lever: refactor rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js (+5 pts). Remediation roadmap projects 100/100 after P0+P1 closure.",
      "Score 87 | grade B | gap 0 pts to B | projected 100 after plan | decay risk: -5 pts/quarter without action"
    ],
    "severityDonut": {
      "p0": 23,
      "p1": 41,
    ...
    "levers": [
      {
        ...
        "severity": "P0",
        "kind": "refactor",
        "action": "Refactor rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js (52 LOC, fan-out 0) to reduce hotspot score from 5.43",
        "file": "rui-reports/diagram/engine/core/src/plugins/extractors/base-extractor.js",
        "line": 1,
        "scoreUplift": 5,
        "effort": "medium"
      ...
      },
      {
        ...
        "severity": "P1",
        "kind": "refactor",
        "action": "Refactor rui-reports/diagram/engine/core/src/index.js (23 LOC, fan-out 22) to reduce hotspot score from 3.41",
      ...
      },
      {
        ...
        "severity": "P1",
        "kind": "refactor",
        "action": "Refactor rui-tools/public-api/references/index.json (6553 LOC, fan-out 0) to reduce hotspot score from 3.28",
        "file": "rui-tools/public-api/references/index.json",
        "line": 1,
        "scoreUplift": 3,
        "effort": "medium"
      },
      {
        ...
        "severity": "P1",
        "kind": "refactor",
        "action": "Refactor rui-reports/diagram/engine/core/src/plugins/extractors/index.js (20 LOC, fan-out 11) to reduce hotspot score from 2.31",
        "file": "rui-reports/diagram/engine/core/src/plugins/extractors/index.js",
        "line": 1,
        "scoreUplift": 2,
        "effort": "high"
      }
