(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — Architecture Story",
    "scope": "arch/scene-1-module-location/index.md",
    "scopeShort": "Architecture Story",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — Architecture Story",
    "tagline": "Grounded newcomer orientation for the \"Architecture Story\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "arch/scene-1-module-location/index.md",
    "audience": "Contributors navigating the Architecture Story card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "Architecture Story is a docs-home card under \"Story Catalog (arch + test)\" in the \"Story Documents & Scenes\" section. Architecture orientation for the skills catalog, including module location, onboarding, upgrade impact, and trust boundary analysis. Metadata: 5 scenes · 2 project-specific slugs kept from the existing tree. The closest local artifact is `arch/scene-1-module-location/index.md`.",
      "hero": {
        "eyebrow": "Story Catalog (arch + test)",
        "title": "Understand Architecture Story in about 9 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/story-catalog-arch-test-architecture-story/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for Architecture Story."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "arch/scene-1-module-location/index.md",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "story-catalog-arch-test-architecture-story",
            "accent": "accent",
          ...
          },
          {
            ...
            "count": 7,
            "share": 25,
            "top": "arch/scene-1-module-location/index.md",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "arch/scene-1-module-location/index.md",
                "sub": "local",
                "token": "qs-pass"
              },
              {
                "name": "arch/scene-2-skill-composition-flow/index.md",
                "sub": "local",
                "token": "qs-pass"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/story-catalog-arch-test-architecture-story",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "arch/scene-1-module-location/index.md"
        }
      ],
      "stats": [
        {
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "file": "arch/scene-1-module-location/index.md",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "5 scenes · 2 project-specific slugs kept from the existing tree",
          "file": "arch/scene-1-module-location/index.md",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── story-catalog-arch-test-architecture-story/index.html\n├── arch/scene-1-module-location/index.md\n├── arch/scene-2-skill-composition-flow/index.md\n├── arch/scene-3-newcomer-onboarding/index.md",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/story-catalog-arch-test-architecture-story/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how Architecture Story is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/story-catalog-arch-test-architecture-story/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "arch/scene-1-module-location/index.md",
          "command": "open '/Users/yi/YrY/.claude/docs/arch/scene-1-module-location/index.md'"
        },
        {
          "order": 4,
          "type": "run",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/story-catalog-arch-test-architecture-story/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/docs/arch/scene-1-module-location/index.md'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "arch/scene-1-module-location/index.md"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "Architecture orientation for the skills catalog, including module location, onboarding, upgrade impact, and trust boundary analysis.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `arch/scene-1-module-location/index.md`.",
          "source": "arch/scene-1-module-location/index.md"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `arch/scene-1-module-location/index.md` first, then return to docs/index.html to verify the homepage link path.",
          "source": "arch/scene-1-module-location/index.md"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "arch/scene-1-module-location/index.md",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "story-catalog-arch-test-architecture-story", label: "Architecture Story", data: dataset }],
    default: dataset
  };
})();
