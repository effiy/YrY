(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — tree-sitter-ruby",
    "scope": "deps/tree-sitter-ruby/index.html",
    "scopeShort": "tree-sitter-ruby",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — tree-sitter-ruby",
    "tagline": "Grounded newcomer orientation for the \"tree-sitter-ruby\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "deps/tree-sitter-ruby/index.html",
    "audience": "Contributors navigating the tree-sitter-ruby card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "tree-sitter-ruby is a docs-home card under \"Runtime Dependencies (15)\" in the \"Third-Party Dependencies / Frameworks\" section. Ruby grammar package in the language coverage matrix. Metadata: Runtime · ^0.23.1. The closest local artifact is `deps/tree-sitter-ruby/index.html`. The primary external reference is `https://github.com/tree-sitter/tree-sitter-ruby`.",
      "hero": {
        "eyebrow": "Runtime Dependencies (15)",
        "title": "Understand tree-sitter-ruby in about 11 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/tree-sitter-ruby/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for tree-sitter-ruby."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "deps/tree-sitter-ruby/index.html",
          ...
          },
          {
            ...
            "color": "warn",
            "type": "view",
            "ref": "https://github.com/tree-sitter/tree-sitter-ruby",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "deps/tree-sitter-ruby/index.html",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "deps/tree-sitter-ruby/index.html",
                "sub": "local",
                "token": "qs-pass"
              },
              {
                "name": "external ref",
                "sub": "https://github.com/tree-sitter/tree-sitter-ruby",
                "token": "qs-warn"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/tree-sitter-ruby",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "deps/tree-sitter-ruby/index.html"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "tree-sitter-ruby",
          "role": "card",
          "description": "Ruby grammar package in the language coverage matrix.",
        ...
        },
        {
          ...
          "file": "deps/tree-sitter-ruby/index.html",
          "line": 1
        },
        {
          ...
          "file": "https://github.com/tree-sitter/tree-sitter-ruby",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Runtime · ^0.23.1",
          "file": "deps/tree-sitter-ruby/index.html",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── tree-sitter-ruby/index.html\n├── deps/tree-sitter-ruby/index.html",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/tree-sitter-ruby/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "deps/tree-sitter-ruby/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how tree-sitter-ruby is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/tree-sitter-ruby/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "deps/tree-sitter-ruby/index.html",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/tree-sitter-ruby/index.html'"
        },
        {
          "order": 4,
          "type": "view",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/tree-sitter-ruby/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/tree-sitter-ruby/index.html'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "deps/tree-sitter-ruby/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "Ruby grammar package in the language coverage matrix.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `deps/tree-sitter-ruby/index.html`.",
          "source": "deps/tree-sitter-ruby/index.html"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `deps/tree-sitter-ruby/index.html` first, then return to docs/index.html to verify the homepage link path.",
          "source": "deps/tree-sitter-ruby/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "deps/tree-sitter-ruby/index.html",
          "href": "../../deps/tree-sitter-ruby/index.html",
          "description": "Closest local artifact carried by the card.",
          "kind": "directory"
        },
        {
          "title": "tree-sitter-ruby upstream",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "tree-sitter-ruby", label: "tree-sitter-ruby", data: dataset }],
    default: dataset
  };
})();
