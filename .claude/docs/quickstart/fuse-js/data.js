(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — fuse.js",
    "scope": "deps/fuse-js/index.html",
    "scopeShort": "fuse.js",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — fuse.js",
    "tagline": "Grounded newcomer orientation for the \"fuse.js\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "deps/fuse-js/index.html",
    "audience": "Contributors navigating the fuse.js card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "fuse.js is a docs-home card under \"Runtime Dependencies (15)\" in the \"Third-Party Dependencies / Frameworks\" section. Fuzzy search support for codebase analysis and report generation. Metadata: Runtime · ^7.1.0. The closest local artifact is `deps/fuse-js/index.html`. The primary external reference is `https://fusejs.io/`.",
      "hero": {
        "eyebrow": "Runtime Dependencies (15)",
        "title": "Understand fuse.js in about 11 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/fuse-js/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for fuse.js."
          },
          {
            "id": "artifact",
            "n": 3,
      ...
      "items": [
        {
          "name": "fuse.js",
          "role": "card",
          "description": "Fuzzy search support for codebase analysis and report generation.",
        ...
        },
        {
          ...
          "file": "https://fusejs.io/",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Runtime · ^7.1.0",
          "file": "deps/fuse-js/index.html",
          "line": 1
        }
      ]
    },
    {
      ...
      "annotations": [
        ...
        {
          "path": "docs/quickstart/fuse-js/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "deps/fuse-js/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how fuse.js is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/fuse-js/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "deps/fuse-js/index.html",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/fuse-js/index.html'"
        },
        {
          "order": 4,
          "type": "view",
      ...
      "items": [
        {
          ...
          "answer": "Fuzzy search support for codebase analysis and report generation.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `deps/fuse-js/index.html`.",
          "source": "deps/fuse-js/index.html"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `deps/fuse-js/index.html` first, then return to docs/index.html to verify the homepage link path.",
          "source": "deps/fuse-js/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "deps/fuse-js/index.html",
          "href": "../../deps/fuse-js/index.html",
          "description": "Closest local artifact carried by the card.",
          "kind": "directory"
        },
        {
          "title": "fuse.js upstream",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "fuse-js", label: "fuse.js", data: dataset }],
    default: dataset
  };
})();
