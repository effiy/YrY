(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — tree-sitter-go",
    "scope": "deps/tree-sitter-go/index.html",
    "scopeShort": "tree-sitter-go",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — tree-sitter-go",
    "tagline": "Grounded newcomer orientation for the \"tree-sitter-go\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "deps/tree-sitter-go/index.html",
    "audience": "Contributors navigating the tree-sitter-go card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "tree-sitter-go is a docs-home card under \"Runtime Dependencies (15)\" in the \"Third-Party Dependencies / Frameworks\" section. Go grammar package for source structure extraction. Metadata: Runtime · ^0.25.0. The closest local artifact is `deps/tree-sitter-go/index.html`. The primary external reference is `https://github.com/tree-sitter/tree-sitter-go`.",
      "hero": {
        "eyebrow": "Runtime Dependencies (15)",
        "title": "Understand tree-sitter-go in about 11 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/tree-sitter-go/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for tree-sitter-go."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "deps/tree-sitter-go/index.html",
          ...
          },
          {
            ...
            "color": "warn",
            "type": "view",
            "ref": "https://github.com/tree-sitter/tree-sitter-go",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "deps/tree-sitter-go/index.html",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "deps/tree-sitter-go/index.html",
                "sub": "local",
                "token": "qs-pass"
              },
              {
                "name": "external ref",
                "sub": "https://github.com/tree-sitter/tree-sitter-go",
                "token": "qs-warn"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/tree-sitter-go",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "deps/tree-sitter-go/index.html"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "tree-sitter-go",
          "role": "card",
          "description": "Go grammar package for source structure extraction.",
        ...
        },
        {
          ...
          "file": "deps/tree-sitter-go/index.html",
          "line": 1
        },
        {
          ...
          "file": "https://github.com/tree-sitter/tree-sitter-go",
          "line": 1
        },
        {
          "name": "Metadata cue",
    ...
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── tree-sitter-go/index.html\n├── deps/tree-sitter-go/index.html",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/tree-sitter-go/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "deps/tree-sitter-go/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how tree-sitter-go is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/tree-sitter-go/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "deps/tree-sitter-go/index.html",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/tree-sitter-go/index.html'"
        },
        {
          "order": 4,
          "type": "view",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/tree-sitter-go/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/tree-sitter-go/index.html'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "deps/tree-sitter-go/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "Go grammar package for source structure extraction.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `deps/tree-sitter-go/index.html`.",
          "source": "deps/tree-sitter-go/index.html"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `deps/tree-sitter-go/index.html` first, then return to docs/index.html to verify the homepage link path.",
          "source": "deps/tree-sitter-go/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "deps/tree-sitter-go/index.html",
          "href": "../../deps/tree-sitter-go/index.html",
          "description": "Closest local artifact carried by the card.",
          "kind": "directory"
        },
        {
          "title": "tree-sitter-go upstream",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "tree-sitter-go", label: "tree-sitter-go", data: dataset }],
    default: dataset
  };
})();
