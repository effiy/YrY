(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — ignore",
    "scope": "deps/ignore/index.html",
    "scopeShort": "ignore",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — ignore",
    "tagline": "Grounded newcomer orientation for the \"ignore\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "deps/ignore/index.html",
    "audience": "Contributors navigating the ignore card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "ignore is a docs-home card under \"Runtime Dependencies (15)\" in the \"Third-Party Dependencies / Frameworks\" section. Gitignore-compatible filtering during scans and imports. Metadata: Runtime · ^7.0.5. The closest local artifact is `deps/ignore/index.html`. The primary external reference is `https://github.com/kaelzhang/node-ignore`.",
      "hero": {
        "eyebrow": "Runtime Dependencies (15)",
        "title": "Understand ignore in about 11 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/ignore/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for ignore."
          },
          {
            "id": "artifact",
            "n": 3,
          ...
          },
          {
            ...
            "color": "warn",
            "type": "view",
            "ref": "https://github.com/kaelzhang/node-ignore",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "deps/ignore/index.html",
                "sub": "local",
                "token": "qs-pass"
              },
              {
                "name": "external ref",
                "sub": "https://github.com/kaelzhang/node-ignore",
                "token": "qs-warn"
              }
            ]
          },
      ...
      "items": [
        {
          "name": "ignore",
          "role": "card",
          "description": "Gitignore-compatible filtering during scans and imports.",
        ...
        },
        {
          ...
          "file": "https://github.com/kaelzhang/node-ignore",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Runtime · ^7.0.5",
          "file": "deps/ignore/index.html",
          "line": 1
        }
      ]
    },
    {
      ...
      "annotations": [
        ...
        {
          "path": "docs/quickstart/ignore/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "deps/ignore/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how ignore is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/ignore/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "deps/ignore/index.html",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/ignore/index.html'"
        },
        {
          "order": 4,
          "type": "view",
      ...
      "items": [
        {
          ...
          "answer": "Gitignore-compatible filtering during scans and imports.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `deps/ignore/index.html`.",
          "source": "deps/ignore/index.html"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `deps/ignore/index.html` first, then return to docs/index.html to verify the homepage link path.",
          "source": "deps/ignore/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "deps/ignore/index.html",
          "href": "../../deps/ignore/index.html",
          "description": "Closest local artifact carried by the card.",
          "kind": "directory"
        },
        {
          "title": "ignore upstream",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "ignore", label: "ignore", data: dataset }],
    default: dataset
  };
})();
