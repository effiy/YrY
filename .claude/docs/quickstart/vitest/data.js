(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — vitest",
    "scope": "deps/vitest/index.html",
    "scopeShort": "vitest",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — vitest",
    "tagline": "Grounded newcomer orientation for the \"vitest\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "deps/vitest/index.html",
    "audience": "Contributors navigating the vitest card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "vitest is a docs-home card under \"Dev Dependencies (1)\" in the \"Third-Party Dependencies / Frameworks\" section. The only declared test framework in the catalog, used by rui-reports/diagram. Metadata: Dev · ^3.1.0. The closest local artifact is `deps/vitest/index.html`. The primary external reference is `https://vitest.dev/`.",
      "hero": {
        "eyebrow": "Dev Dependencies (1)",
        "title": "Understand vitest in about 11 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/vitest/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for vitest."
          },
          {
            "id": "artifact",
            "n": 3,
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "deps/vitest/index.html",
                "sub": "local",
                "token": "qs-pass"
              },
              {
                "name": "external ref",
                "sub": "https://vitest.dev/",
                "token": "qs-warn"
              }
            ]
          },
      ...
      "items": [
        {
          "name": "vitest",
          "role": "card",
          "description": "The only declared test framework in the catalog, used by rui-reports/diagram.",
          "file": "docs/index.html",
          "line": 1
        },
        {
          "name": "Dev Dependencies (1)",
          "role": "group",
        ...
        },
        {
          ...
          "file": "https://vitest.dev/",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Dev · ^3.1.0",
          "file": "deps/vitest/index.html",
          "line": 1
        }
      ]
    },
    {
      ...
      "annotations": [
        ...
        {
          "path": "docs/quickstart/vitest/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "deps/vitest/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how vitest is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/vitest/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "deps/vitest/index.html",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/vitest/index.html'"
        },
        {
          "order": 4,
          "type": "view",
      ...
      "items": [
        {
          ...
          "answer": "The only declared test framework in the catalog, used by rui-reports/diagram.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `deps/vitest/index.html`.",
          "source": "deps/vitest/index.html"
        },
        {
          "question": "Which group owns this card on the homepage?",
          "answer": "The card is rendered in the group \"Dev Dependencies (1)\" inside the section \"Third-Party Dependencies / Frameworks\".",
          "source": "docs/data.js"
        },
        {
          "question": "What should I open next after reading this page?",
          "answer": "Open `deps/vitest/index.html` first, then return to docs/index.html to verify the homepage link path.",
          "source": "deps/vitest/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "deps/vitest/index.html",
          "href": "../../deps/vitest/index.html",
          "description": "Closest local artifact carried by the card.",
          "kind": "directory"
        },
        {
          "title": "vitest upstream",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "vitest", label: "vitest", data: dataset }],
    default: dataset
  };
})();
