(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — tree-sitter-typescript",
    "scope": "deps/tree-sitter-typescript/index.html",
    "scopeShort": "tree-sitter-typescript",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — tree-sitter-typescript",
    "tagline": "Grounded newcomer orientation for the \"tree-sitter-typescript\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "deps/tree-sitter-typescript/index.html",
    "audience": "Contributors navigating the tree-sitter-typescript card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "tree-sitter-typescript is a docs-home card under \"Runtime Dependencies (15)\" in the \"Third-Party Dependencies / Frameworks\" section. TypeScript grammar package for parser-driven exploration. Metadata: Runtime · ^0.23.2. The closest local artifact is `deps/tree-sitter-typescript/index.html`. The primary external reference is `https://github.com/tree-sitter/tree-sitter-typescript`.",
      "hero": {
        "eyebrow": "Runtime Dependencies (15)",
        "title": "Understand tree-sitter-typescript in about 11 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/tree-sitter-typescript/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for tree-sitter-typescript."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "deps/tree-sitter-typescript/index.html",
          ...
          },
          {
            ...
            "color": "warn",
            "type": "view",
            "ref": "https://github.com/tree-sitter/tree-sitter-typescript",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "deps/tree-sitter-typescript/index.html",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "deps/tree-sitter-typescript/index.html",
                "sub": "local",
                "token": "qs-pass"
              },
              {
                "name": "external ref",
                "sub": "https://github.com/tree-sitter/tree-sitter-typescript",
                "token": "qs-warn"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/tree-sitter-typescript",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "deps/tree-sitter-typescript/index.html"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "tree-sitter-typescript",
          "role": "card",
          "description": "TypeScript grammar package for parser-driven exploration.",
        ...
        },
        {
          ...
          "file": "deps/tree-sitter-typescript/index.html",
          "line": 1
        },
        {
          ...
          "file": "https://github.com/tree-sitter/tree-sitter-typescript",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Runtime · ^0.23.2",
          "file": "deps/tree-sitter-typescript/index.html",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── tree-sitter-typescript/index.html\n├── deps/tree-sitter-typescript/index.html",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/tree-sitter-typescript/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "deps/tree-sitter-typescript/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how tree-sitter-typescript is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/tree-sitter-typescript/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "deps/tree-sitter-typescript/index.html",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/tree-sitter-typescript/index.html'"
        },
        {
          "order": 4,
          "type": "view",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/tree-sitter-typescript/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/tree-sitter-typescript/index.html'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "deps/tree-sitter-typescript/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "TypeScript grammar package for parser-driven exploration.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `deps/tree-sitter-typescript/index.html`.",
          "source": "deps/tree-sitter-typescript/index.html"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `deps/tree-sitter-typescript/index.html` first, then return to docs/index.html to verify the homepage link path.",
          "source": "deps/tree-sitter-typescript/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "deps/tree-sitter-typescript/index.html",
          "href": "../../deps/tree-sitter-typescript/index.html",
          "description": "Closest local artifact carried by the card.",
          "kind": "directory"
        },
        {
          "title": "tree-sitter-typescript upstream",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "tree-sitter-typescript", label: "tree-sitter-typescript", data: dataset }],
    default: dataset
  };
})();
