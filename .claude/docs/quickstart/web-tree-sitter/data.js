(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — web-tree-sitter",
    "scope": "deps/web-tree-sitter/index.html",
    "scopeShort": "web-tree-sitter",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — web-tree-sitter",
    "tagline": "Grounded newcomer orientation for the \"web-tree-sitter\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "deps/web-tree-sitter/index.html",
    "audience": "Contributors navigating the web-tree-sitter card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "web-tree-sitter is a docs-home card under \"Runtime Dependencies (15)\" in the \"Third-Party Dependencies / Frameworks\" section. WASM runtime for the tree-sitter-based diagram engine. Metadata: Runtime · ^0.26.6. The closest local artifact is `deps/web-tree-sitter/index.html`. The primary external reference is `https://github.com/tree-sitter/tree-sitter/tree/master/lib/binding_web`.",
      "hero": {
        "eyebrow": "Runtime Dependencies (15)",
        "title": "Understand web-tree-sitter in about 11 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/web-tree-sitter/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for web-tree-sitter."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "deps/web-tree-sitter/index.html",
          ...
          },
          {
            ...
            "color": "warn",
            "type": "view",
            "ref": "https://github.com/tree-sitter/tree-sitter/tree/master/lib/binding_web",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "deps/web-tree-sitter/index.html",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "deps/web-tree-sitter/index.html",
                "sub": "local",
                "token": "qs-pass"
              },
              {
                "name": "external ref",
                "sub": "https://github.com/tree-sitter/tree-sitter/tree/master/lib/binding_web",
                "token": "qs-warn"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/web-tree-sitter",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "deps/web-tree-sitter/index.html"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "web-tree-sitter",
          "role": "card",
          "description": "WASM runtime for the tree-sitter-based diagram engine.",
        ...
        },
        {
          ...
          "file": "deps/web-tree-sitter/index.html",
          "line": 1
        },
        {
          ...
          "file": "https://github.com/tree-sitter/tree-sitter/tree/master/lib/binding_web",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Runtime · ^0.26.6",
          "file": "deps/web-tree-sitter/index.html",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── web-tree-sitter/index.html\n├── deps/web-tree-sitter/index.html",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/web-tree-sitter/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "deps/web-tree-sitter/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how web-tree-sitter is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/web-tree-sitter/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "deps/web-tree-sitter/index.html",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/web-tree-sitter/index.html'"
        },
        {
          "order": 4,
          "type": "view",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/web-tree-sitter/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/web-tree-sitter/index.html'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "deps/web-tree-sitter/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "WASM runtime for the tree-sitter-based diagram engine.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `deps/web-tree-sitter/index.html`.",
          "source": "deps/web-tree-sitter/index.html"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `deps/web-tree-sitter/index.html` first, then return to docs/index.html to verify the homepage link path.",
          "source": "deps/web-tree-sitter/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "deps/web-tree-sitter/index.html",
          "href": "../../deps/web-tree-sitter/index.html",
          "description": "Closest local artifact carried by the card.",
          "kind": "directory"
        },
        {
          "title": "web-tree-sitter upstream",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "web-tree-sitter", label: "web-tree-sitter", data: dataset }],
    default: dataset
  };
})();
