(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — rui-stats-grid",
    "scope": "shared/components/rui-stats-grid/",
    "scopeShort": "rui-stats-grid",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — rui-stats-grid",
    "tagline": "Grounded newcomer orientation for the \"rui-stats-grid\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "shared/components/rui-stats-grid/",
    "audience": "Contributors navigating the rui-stats-grid card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "rui-stats-grid is a docs-home card under \"shared/ — Cross-Page UI Substrate\" in the \"Main Source Code\" section. Stat grid component used by the docs home and report pages. Metadata: Component · shared/components/rui-stats-grid/. The closest local artifact is `shared/components/rui-stats-grid/`.",
      "hero": {
        "eyebrow": "shared/ — Cross-Page UI Substrate",
        "title": "Understand rui-stats-grid in about 9 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/src-shared-rui-stats-grid/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for rui-stats-grid."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "shared/components/rui-stats-grid/",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "shared/components/rui-stats-grid/",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "shared/components/rui-stats-grid/",
                "sub": "local",
                "token": "qs-pass"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/src-shared-rui-stats-grid",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "shared/components/rui-stats-grid/"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "rui-stats-grid",
          "role": "card",
          "description": "Stat grid component used by the docs home and report pages.",
        ...
        },
        {
          ...
          "file": "shared/components/rui-stats-grid/",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Component · shared/components/rui-stats-grid/",
          "file": "shared/components/rui-stats-grid/",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── src-shared-rui-stats-grid/index.html\n├── shared/components/rui-stats-grid/",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/src-shared-rui-stats-grid/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "shared/components/rui-stats-grid/",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how rui-stats-grid is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/src-shared-rui-stats-grid/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "shared/components/rui-stats-grid/",
          "command": "open '/Users/yi/YrY/.claude/shared/components/rui-stats-grid/'"
        },
        {
          "order": 4,
          "type": "run",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/src-shared-rui-stats-grid/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/shared/components/rui-stats-grid/'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "shared/components/rui-stats-grid/"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "Stat grid component used by the docs home and report pages.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `shared/components/rui-stats-grid/`.",
          "source": "shared/components/rui-stats-grid/"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `shared/components/rui-stats-grid/` first, then return to docs/index.html to verify the homepage link path.",
          "source": "shared/components/rui-stats-grid/"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "shared/components/rui-stats-grid/",
          "href": "../../shared/components/rui-stats-grid",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "src-shared-rui-stats-grid", label: "rui-stats-grid", data: dataset }],
    default: dataset
  };
})();
