      ...
      "items": [
        {
          ...
          "answer": "Fact baseline extraction: project type, inventory, security surface, test framework.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `skills/rui-init/steps/01-detect/`.",
          "source": "skills/rui-init/steps/01-detect/"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `skills/rui-init/steps/01-detect/` first, then return to docs/index.html to verify the homepage link path.",
          "source": "skills/rui-init/steps/01-detect/"
        }
      ]
    },
