(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — 01-detect",
    "scope": "skills/rui-init/steps/01-detect/",
    "scopeShort": "01-detect",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — 01-detect",
    "tagline": "Grounded newcomer orientation for the \"01-detect\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "skills/rui-init/steps/01-detect/",
    "audience": "Contributors navigating the 01-detect card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "01-detect is a docs-home card under \"skills/rui-init — Initialization Pipeline\" in the \"Main Source Code\" section. Fact baseline extraction: project type, inventory, security surface, test framework. Metadata: Step · skills/rui-init/steps/01-detect/. The closest local artifact is `skills/rui-init/steps/01-detect/`.",
      "hero": {
        "eyebrow": "skills/rui-init — Initialization Pipeline",
        "title": "Understand 01-detect in about 9 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/src-rui-init-01-detect/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for 01-detect."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "skills/rui-init/steps/01-detect/",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "skills/rui-init/steps/01-detect/",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "skills/rui-init/steps/01-detect/",
                "sub": "local",
                "token": "qs-pass"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/src-rui-init-01-detect",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "skills/rui-init/steps/01-detect/"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "01-detect",
          "role": "card",
          "description": "Fact baseline extraction: project type, inventory, security surface, test framework.",
        ...
        },
        {
          ...
          "file": "skills/rui-init/steps/01-detect/",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Step · skills/rui-init/steps/01-detect/",
          "file": "skills/rui-init/steps/01-detect/",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── src-rui-init-01-detect/index.html\n├── skills/rui-init/steps/01-detect/",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/src-rui-init-01-detect/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "skills/rui-init/steps/01-detect/",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how 01-detect is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/src-rui-init-01-detect/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "skills/rui-init/steps/01-detect/",
          "command": "open '/Users/yi/YrY/.claude/skills/rui-init/steps/01-detect/'"
        },
        {
          "order": 4,
          "type": "run",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/src-rui-init-01-detect/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/skills/rui-init/steps/01-detect/'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "skills/rui-init/steps/01-detect/"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "This page is a child surface under `skills/rui-init/steps/01-detect/`, but the canonical benchmark still lives in `skills/rui-init/evals/evals.json`. It currently contains 10 prompt cases for `rui-init`, so it is the fastest way to see what behavior the skill must preserve.",
    ...
    },
    {
      ...
      "items": [
        ...
        {
          "title": "skills/rui-init/steps/01-detect/",
          "href": "../../skills/rui-init/steps/01-detect",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "src-rui-init-01-detect", label: "01-detect", data: dataset }],
    default: dataset
  };
})();
