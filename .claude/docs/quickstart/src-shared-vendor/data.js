(function () {
  ...
  "header": {
    ...
    "title": "Quickstart — vendor/",
    "tagline": "Grounded newcomer orientation for the \"vendor/\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "shared/vendor/",
    "audience": "Contributors navigating the vendor/ card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "vendor/ is a docs-home card under \"shared/ — Cross-Page UI Substrate\" in the \"Main Source Code\" section. Pinned browser assets: Vue, html2canvas, jsPDF, xlsx, and a local mermaid build. Metadata: Vendor · shared/vendor/. The closest local artifact is `shared/vendor/`.",
      "hero": {
        "eyebrow": "shared/ — Cross-Page UI Substrate",
        "title": "Understand vendor/ in about 9 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/src-shared-vendor/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for vendor/."
          },
          {
            "id": "artifact",
            "n": 3,
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/src-shared-vendor",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "items": [
        {
          "name": "vendor/",
          "role": "card",
          "description": "Pinned browser assets: Vue, html2canvas, jsPDF, xlsx, and a local mermaid build.",
        ...
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Vendor · shared/vendor/",
          "file": "shared/vendor/",
          "line": 1
        }
      ]
    },
    {
      ...
      "annotations": [
        ...
        {
          "path": "docs/quickstart/src-shared-vendor/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how vendor/ is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/src-shared-vendor/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "shared/vendor/",
          "command": "open '/Users/yi/YrY/.claude/shared/vendor/'"
        },
        {
          "order": 4,
          "type": "run",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/src-shared-vendor/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/shared/vendor/'",
      ...
      "items": [
        {
          ...
          "answer": "Pinned browser assets: Vue, html2canvas, jsPDF, xlsx, and a local mermaid build.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `shared/vendor/`.",
          "source": "shared/vendor/"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `shared/vendor/` first, then return to docs/index.html to verify the homepage link path.",
          "source": "shared/vendor/"
        }
      ]
    },
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "src-shared-vendor", label: "vendor/", data: dataset }],
    default: dataset
  };
})();
