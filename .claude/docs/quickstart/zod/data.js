(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — zod",
    "scope": "deps/zod/index.html",
    "scopeShort": "zod",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — zod",
    "tagline": "Grounded newcomer orientation for the \"zod\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "deps/zod/index.html",
    "audience": "Contributors navigating the zod card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "zod is a docs-home card under \"Runtime Dependencies (15)\" in the \"Third-Party Dependencies / Frameworks\" section. Schema validation for structured analysis results and configs. Metadata: Runtime · ^4.3.6. The closest local artifact is `deps/zod/index.html`. The primary external reference is `https://zod.dev/`.",
      "hero": {
        "eyebrow": "Runtime Dependencies (15)",
        "title": "Understand zod in about 11 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/zod/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for zod."
          },
          {
            "id": "artifact",
            "n": 3,
      ...
      "items": [
        {
          "name": "zod",
          "role": "card",
          "description": "Schema validation for structured analysis results and configs.",
    ...
    },
    {
      ...
      "annotations": [
        ...
        {
          "path": "docs/quickstart/zod/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "deps/zod/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how zod is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/zod/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "deps/zod/index.html",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/zod/index.html'"
        },
        {
          "order": 4,
          "type": "view",
      ...
      "items": [
        {
          ...
          "answer": "Schema validation for structured analysis results and configs.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `deps/zod/index.html`.",
          "source": "deps/zod/index.html"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `deps/zod/index.html` first, then return to docs/index.html to verify the homepage link path.",
          "source": "deps/zod/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "deps/zod/index.html",
          "href": "../../deps/zod/index.html",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "zod", label: "zod", data: dataset }],
    default: dataset
  };
})();
