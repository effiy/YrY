      ...
      "items": [
        {
          ...
          "answer": "The canonical benchmark for this surface lives in `skills/rui-test/evals/evals.json`. It currently contains 12 prompt cases for `rui-test`, so it is the fastest way to see what behavior the skill must preserve.",
