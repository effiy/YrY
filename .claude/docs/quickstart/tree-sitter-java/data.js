(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — tree-sitter-java",
    "scope": "deps/tree-sitter-java/index.html",
    "scopeShort": "tree-sitter-java",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — tree-sitter-java",
    "tagline": "Grounded newcomer orientation for the \"tree-sitter-java\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "deps/tree-sitter-java/index.html",
    "audience": "Contributors navigating the tree-sitter-java card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "tree-sitter-java is a docs-home card under \"Runtime Dependencies (15)\" in the \"Third-Party Dependencies / Frameworks\" section. Java grammar package used by the analysis engine. Metadata: Runtime · ^0.23.5. The closest local artifact is `deps/tree-sitter-java/index.html`. The primary external reference is `https://github.com/tree-sitter/tree-sitter-java`.",
      "hero": {
        "eyebrow": "Runtime Dependencies (15)",
        "title": "Understand tree-sitter-java in about 11 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/tree-sitter-java/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for tree-sitter-java."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "deps/tree-sitter-java/index.html",
          ...
          },
          {
            ...
            "color": "warn",
            "type": "view",
            "ref": "https://github.com/tree-sitter/tree-sitter-java",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "deps/tree-sitter-java/index.html",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "deps/tree-sitter-java/index.html",
                "sub": "local",
                "token": "qs-pass"
              },
              {
                "name": "external ref",
                "sub": "https://github.com/tree-sitter/tree-sitter-java",
                "token": "qs-warn"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/tree-sitter-java",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "deps/tree-sitter-java/index.html"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "tree-sitter-java",
          "role": "card",
          "description": "Java grammar package used by the analysis engine.",
        ...
        },
        {
          ...
          "file": "deps/tree-sitter-java/index.html",
          "line": 1
        },
        {
          ...
          "file": "https://github.com/tree-sitter/tree-sitter-java",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Runtime · ^0.23.5",
          "file": "deps/tree-sitter-java/index.html",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── tree-sitter-java/index.html\n├── deps/tree-sitter-java/index.html",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/tree-sitter-java/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "deps/tree-sitter-java/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how tree-sitter-java is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/tree-sitter-java/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "deps/tree-sitter-java/index.html",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/tree-sitter-java/index.html'"
        },
        {
          "order": 4,
          "type": "view",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/tree-sitter-java/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/tree-sitter-java/index.html'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "deps/tree-sitter-java/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "Java grammar package used by the analysis engine.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `deps/tree-sitter-java/index.html`.",
          "source": "deps/tree-sitter-java/index.html"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `deps/tree-sitter-java/index.html` first, then return to docs/index.html to verify the homepage link path.",
          "source": "deps/tree-sitter-java/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "deps/tree-sitter-java/index.html",
          "href": "../../deps/tree-sitter-java/index.html",
          "description": "Closest local artifact carried by the card.",
          "kind": "directory"
        },
        {
          "title": "tree-sitter-java upstream",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "tree-sitter-java", label: "tree-sitter-java", data: dataset }],
    default: dataset
  };
})();
