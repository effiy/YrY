(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — graphology",
    "scope": "deps/graphology/index.html",
    "scopeShort": "graphology",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — graphology",
    "tagline": "Grounded newcomer orientation for the \"graphology\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "deps/graphology/index.html",
    "audience": "Contributors navigating the graphology card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "graphology is a docs-home card under \"Runtime Dependencies (15)\" in the \"Third-Party Dependencies / Frameworks\" section. Graph data structure library for diagram and dependency analysis. Metadata: Runtime · ^0.26.0. The closest local artifact is `deps/graphology/index.html`. The primary external reference is `https://graphology.github.io/`.",
      "hero": {
        "eyebrow": "Runtime Dependencies (15)",
        "title": "Understand graphology in about 11 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/graphology/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for graphology."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "deps/graphology/index.html",
          ...
          },
          {
            ...
            "color": "warn",
            "type": "view",
            "ref": "https://graphology.github.io/",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "deps/graphology/index.html",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "deps/graphology/index.html",
                "sub": "local",
                "token": "qs-pass"
              },
              {
                "name": "external ref",
                "sub": "https://graphology.github.io/",
                "token": "qs-warn"
              }
            ]
          },
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "deps/graphology/index.html"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "graphology",
          "role": "card",
          "description": "Graph data structure library for diagram and dependency analysis.",
        ...
        },
        {
          ...
          "file": "deps/graphology/index.html",
          "line": 1
        },
        {
          ...
          "file": "https://graphology.github.io/",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Runtime · ^0.26.0",
          "file": "deps/graphology/index.html",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── graphology/index.html\n├── deps/graphology/index.html",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/graphology/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "deps/graphology/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how graphology is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/graphology/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "deps/graphology/index.html",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/graphology/index.html'"
        },
        {
          "order": 4,
          "type": "view",
      ...
      "items": [
        {
          ...
          "answer": "Graph data structure library for diagram and dependency analysis.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `deps/graphology/index.html`.",
          "source": "deps/graphology/index.html"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `deps/graphology/index.html` first, then return to docs/index.html to verify the homepage link path.",
          "source": "deps/graphology/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "deps/graphology/index.html",
          "href": "../../deps/graphology/index.html",
          "description": "Closest local artifact carried by the card.",
          "kind": "directory"
        },
        {
          "title": "graphology upstream",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "graphology", label: "graphology", data: dataset }],
    default: dataset
  };
})();
