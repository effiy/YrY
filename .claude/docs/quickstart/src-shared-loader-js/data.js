(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — loader.js",
    "scope": "shared/loader.js",
    "scopeShort": "loader.js",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — loader.js",
    "tagline": "Grounded newcomer orientation for the \"loader.js\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "shared/loader.js",
    "audience": "Contributors navigating the loader.js card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "loader.js is a docs-home card under \"shared/ — Cross-Page UI Substrate\" in the \"Main Source Code\" section. Unified browser loader that injects Vue and asynchronously mounts shared components. Metadata: Loader · shared/loader.js. The closest local artifact is `shared/loader.js`.",
      "hero": {
        "eyebrow": "shared/ — Cross-Page UI Substrate",
        "title": "Understand loader.js in about 9 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/src-shared-loader-js/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for loader.js."
          },
          {
            "id": "artifact",
            "n": 3,
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/src-shared-loader-js",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "items": [
        {
          "name": "loader.js",
          "role": "card",
          "description": "Unified browser loader that injects Vue and asynchronously mounts shared components.",
        ...
        },
        {
          ...
          "file": "shared/loader.js",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Loader · shared/loader.js",
          "file": "shared/loader.js",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── src-shared-loader-js/index.html\n├── shared/loader.js",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/src-shared-loader-js/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "shared/loader.js",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how loader.js is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/src-shared-loader-js/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "shared/loader.js",
          "command": "open '/Users/yi/YrY/.claude/shared/loader.js'"
        },
        {
          "order": 4,
          "type": "run",
      ...
      "items": [
        {
          ...
          "answer": "Unified browser loader that injects Vue and asynchronously mounts shared components.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `shared/loader.js`.",
          "source": "shared/loader.js"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `shared/loader.js` first, then return to docs/index.html to verify the homepage link path.",
          "source": "shared/loader.js"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "shared/loader.js",
          "href": "../../shared/loader.js",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "src-shared-loader-js", label: "loader.js", data: dataset }],
    default: dataset
  };
})();
