(function () {
  ...
  "header": {
    ...
    "title": "Quickstart — mermaid",
    "tagline": "Grounded newcomer orientation for the \"mermaid\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "mermaid",
    "audience": "Contributors navigating the mermaid card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "mermaid is a docs-home card under \"skills/rui-tools — Meta Tooling\" in the \"Main Source Code\" section. Mermaid-focused tooling and references. Metadata: Sub-skill · references + evals.",
      "hero": {
        "eyebrow": "skills/rui-tools — Meta Tooling",
        "title": "Understand mermaid in about 6 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/src-rui-tools-mermaid/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for mermaid."
          },
          {
            "id": "verify",
            "n": 3,
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/src-rui-tools-mermaid",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "items": [
        {
          "name": "mermaid",
          "role": "card",
          "description": "Mermaid-focused tooling and references.",
        ...
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Sub-skill · references + evals",
          "file": "docs/data.js",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── src-rui-tools-mermaid/index.html",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/src-rui-tools-mermaid/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how mermaid is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/src-rui-tools-mermaid/index.html'"
        },
        {
          "order": 3,
          "type": "run",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/src-rui-tools-mermaid/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "This page is a child surface under `mermaid`, but the canonical benchmark still lives in `skills/rui-tools/mermaid/evals/evals.json`. It currently contains 10 prompt cases for `rui-tools-mermaid`, so it is the fastest way to see what behavior the skill must preserve.",
          "source": "skills/rui-tools/mermaid/evals/evals.json"
        },
        {
          "question": "What kinds of prompts does this eval file cover?",
          "answer": "Representative prompts include \"Render this .mmd flowchart to SVG with the tokyo-night theme.\"; \"Create a sequence diagram for this API call flow and render it as ASCII.\"; \"Batch render every .mmd file in ./diagrams/ to SVG.\". Read them as the supported question shapes and the routing surface the skill is expected to handle.",
          "source": "skills/rui-tools/mermaid/evals/evals.json"
        },
        {
        ...
        },
        {
          ...
          "answer": "Common checks in this file include \"Picks SVG output format\"; \"Applies the tokyo-night theme\"; \"Verifies the output file opens\"; \"Picks sequence diagram type\". If your change weakens or removes those signals, it is probably regressing the skill contract.",
          "source": "skills/rui-tools/mermaid/evals/evals.json"
        }
      ]
    },
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "src-rui-tools-mermaid", label: "mermaid", data: dataset }],
    default: dataset
  };
})();
