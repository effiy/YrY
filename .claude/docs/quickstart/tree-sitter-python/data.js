(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — tree-sitter-python",
    "scope": "deps/tree-sitter-python/index.html",
    "scopeShort": "tree-sitter-python",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — tree-sitter-python",
    "tagline": "Grounded newcomer orientation for the \"tree-sitter-python\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "deps/tree-sitter-python/index.html",
    "audience": "Contributors navigating the tree-sitter-python card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "tree-sitter-python is a docs-home card under \"Runtime Dependencies (15)\" in the \"Third-Party Dependencies / Frameworks\" section. Python grammar package for code graph extraction. Metadata: Runtime · ^0.25.0. The closest local artifact is `deps/tree-sitter-python/index.html`. The primary external reference is `https://github.com/tree-sitter/tree-sitter-python`.",
      "hero": {
        "eyebrow": "Runtime Dependencies (15)",
        "title": "Understand tree-sitter-python in about 11 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/tree-sitter-python/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for tree-sitter-python."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "deps/tree-sitter-python/index.html",
          ...
          },
          {
            ...
            "color": "warn",
            "type": "view",
            "ref": "https://github.com/tree-sitter/tree-sitter-python",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "deps/tree-sitter-python/index.html",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "deps/tree-sitter-python/index.html",
                "sub": "local",
                "token": "qs-pass"
              },
              {
                "name": "external ref",
                "sub": "https://github.com/tree-sitter/tree-sitter-python",
                "token": "qs-warn"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/tree-sitter-python",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "deps/tree-sitter-python/index.html"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "tree-sitter-python",
          "role": "card",
          "description": "Python grammar package for code graph extraction.",
        ...
        },
        {
          ...
          "file": "deps/tree-sitter-python/index.html",
          "line": 1
        },
        {
          ...
          "file": "https://github.com/tree-sitter/tree-sitter-python",
          "line": 1
        },
        {
          "name": "Metadata cue",
    ...
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── tree-sitter-python/index.html\n├── deps/tree-sitter-python/index.html",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/tree-sitter-python/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "deps/tree-sitter-python/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how tree-sitter-python is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/tree-sitter-python/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "deps/tree-sitter-python/index.html",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/tree-sitter-python/index.html'"
        },
        {
          "order": 4,
          "type": "view",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/tree-sitter-python/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/tree-sitter-python/index.html'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "deps/tree-sitter-python/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "Python grammar package for code graph extraction.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `deps/tree-sitter-python/index.html`.",
          "source": "deps/tree-sitter-python/index.html"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `deps/tree-sitter-python/index.html` first, then return to docs/index.html to verify the homepage link path.",
          "source": "deps/tree-sitter-python/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "deps/tree-sitter-python/index.html",
          "href": "../../deps/tree-sitter-python/index.html",
          "description": "Closest local artifact carried by the card.",
          "kind": "directory"
        },
        {
          "title": "tree-sitter-python upstream",
          "href": "https://github.com/tree-sitter/tree-sitter-python",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "tree-sitter-python", label: "tree-sitter-python", data: dataset }],
    default: dataset
  };
})();
