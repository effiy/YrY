      ...
      "items": [
        {
          ...
          "answer": "The canonical benchmark for this surface lives in `skills/rui-init/evals/evals.json`. It currently contains 10 prompt cases for `rui-init`, so it is the fastest way to see what behavior the skill must preserve.",
