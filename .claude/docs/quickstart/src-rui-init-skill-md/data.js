(function () {
  ...
  "meta": {
    ...
    "scope": "skills/rui-init/SKILL.md",
    "scopeShort": "SKILL.md",
    "language": "en",
    "depth": 3,
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "SKILL.md is a docs-home card under \"skills/rui-init — Initialization Pipeline\" in the \"Main Source Code\" section. User-invocable pipeline entry for detect → explore → generate → arch → verify. Metadata: Manifest · skills/rui-init/SKILL.md. The closest local artifact is `skills/rui-init/SKILL.md`.",
      "hero": {
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/src-rui-init-skill-md/index.html",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/src-rui-init-skill-md",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "skills/rui-init/SKILL.md"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "SKILL.md",
          "role": "card",
          "description": "User-invocable pipeline entry for detect → explore → generate → arch → verify.",
        ...
        },
        {
          ...
          "file": "skills/rui-init/SKILL.md",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Manifest · skills/rui-init/SKILL.md",
          "file": "skills/rui-init/SKILL.md",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── src-rui-init-skill-md/index.html\n├── skills/rui-init/SKILL.md",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/src-rui-init-skill-md/index.html",
    ...
    },
    {
      ...
      "steps": [
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/src-rui-init-skill-md/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "skills/rui-init/SKILL.md",
          "command": "open '/Users/yi/YrY/.claude/skills/rui-init/SKILL.md'"
        },
        {
          "order": 4,
          "type": "run",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/src-rui-init-skill-md/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/skills/rui-init/SKILL.md'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "skills/rui-init/SKILL.md"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "User-invocable pipeline entry for detect → explore → generate → arch → verify.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `skills/rui-init/SKILL.md`.",
          "source": "skills/rui-init/SKILL.md"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `skills/rui-init/SKILL.md` first, then return to docs/index.html to verify the homepage link path.",
          "source": "skills/rui-init/SKILL.md"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "skills/rui-init/SKILL.md",
          "href": "../../skills/rui-init/SKILL.md",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "src-rui-init-skill-md", label: "SKILL.md", data: dataset }],
    default: dataset
  };
})();
