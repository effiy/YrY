(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — tree-sitter-javascript",
    "scope": "deps/tree-sitter-javascript/index.html",
    "scopeShort": "tree-sitter-javascript",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — tree-sitter-javascript",
    "tagline": "Grounded newcomer orientation for the \"tree-sitter-javascript\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "deps/tree-sitter-javascript/index.html",
    "audience": "Contributors navigating the tree-sitter-javascript card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "tree-sitter-javascript is a docs-home card under \"Runtime Dependencies (15)\" in the \"Third-Party Dependencies / Frameworks\" section. JavaScript grammar package for parser-driven indexing. Metadata: Runtime · ^0.25.0. The closest local artifact is `deps/tree-sitter-javascript/index.html`. The primary external reference is `https://github.com/tree-sitter/tree-sitter-javascript`.",
      "hero": {
        "eyebrow": "Runtime Dependencies (15)",
        "title": "Understand tree-sitter-javascript in about 11 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/tree-sitter-javascript/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for tree-sitter-javascript."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "deps/tree-sitter-javascript/index.html",
          ...
          },
          {
            ...
            "color": "warn",
            "type": "view",
            "ref": "https://github.com/tree-sitter/tree-sitter-javascript",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "deps/tree-sitter-javascript/index.html",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "deps/tree-sitter-javascript/index.html",
                "sub": "local",
                "token": "qs-pass"
              },
              {
                "name": "external ref",
                "sub": "https://github.com/tree-sitter/tree-sitter-javascript",
                "token": "qs-warn"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/tree-sitter-javascript",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "deps/tree-sitter-javascript/index.html"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "tree-sitter-javascript",
          "role": "card",
          "description": "JavaScript grammar package for parser-driven indexing.",
        ...
        },
        {
          ...
          "file": "deps/tree-sitter-javascript/index.html",
          "line": 1
        },
        {
          ...
          "file": "https://github.com/tree-sitter/tree-sitter-javascript",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Runtime · ^0.25.0",
          "file": "deps/tree-sitter-javascript/index.html",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── tree-sitter-javascript/index.html\n├── deps/tree-sitter-javascript/index.html",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/tree-sitter-javascript/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "deps/tree-sitter-javascript/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how tree-sitter-javascript is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/tree-sitter-javascript/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "deps/tree-sitter-javascript/index.html",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/tree-sitter-javascript/index.html'"
        },
        {
          "order": 4,
          "type": "view",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/tree-sitter-javascript/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/tree-sitter-javascript/index.html'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "deps/tree-sitter-javascript/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "JavaScript grammar package for parser-driven indexing.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `deps/tree-sitter-javascript/index.html`.",
          "source": "deps/tree-sitter-javascript/index.html"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `deps/tree-sitter-javascript/index.html` first, then return to docs/index.html to verify the homepage link path.",
          "source": "deps/tree-sitter-javascript/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "deps/tree-sitter-javascript/index.html",
          "href": "../../deps/tree-sitter-javascript/index.html",
          "description": "Closest local artifact carried by the card.",
          "kind": "directory"
        },
        {
          "title": "tree-sitter-javascript upstream",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "tree-sitter-javascript", label: "tree-sitter-javascript", data: dataset }],
    default: dataset
  };
})();
