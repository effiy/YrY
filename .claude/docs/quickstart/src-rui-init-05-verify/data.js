(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — 05-verify",
    "scope": "skills/rui-init/steps/05-verify/",
    "scopeShort": "05-verify",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — 05-verify",
    "tagline": "Grounded newcomer orientation for the \"05-verify\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "skills/rui-init/steps/05-verify/",
    "audience": "Contributors navigating the 05-verify card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "05-verify is a docs-home card under \"skills/rui-init — Initialization Pipeline\" in the \"Main Source Code\" section. Readiness gate that checks the generated baseline and scene counts. Metadata: Step · skills/rui-init/steps/05-verify/. The closest local artifact is `skills/rui-init/steps/05-verify/`.",
      "hero": {
        "eyebrow": "skills/rui-init — Initialization Pipeline",
        "title": "Understand 05-verify in about 9 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/src-rui-init-05-verify/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for 05-verify."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "skills/rui-init/steps/05-verify/",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "skills/rui-init/steps/05-verify/",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "skills/rui-init/steps/05-verify/",
                "sub": "local",
                "token": "qs-pass"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/src-rui-init-05-verify",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "skills/rui-init/steps/05-verify/"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "05-verify",
          "role": "card",
          "description": "Readiness gate that checks the generated baseline and scene counts.",
        ...
        },
        {
          ...
          "file": "skills/rui-init/steps/05-verify/",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Step · skills/rui-init/steps/05-verify/",
          "file": "skills/rui-init/steps/05-verify/",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── src-rui-init-05-verify/index.html\n├── skills/rui-init/steps/05-verify/",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/src-rui-init-05-verify/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "skills/rui-init/steps/05-verify/",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how 05-verify is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/src-rui-init-05-verify/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "skills/rui-init/steps/05-verify/",
          "command": "open '/Users/yi/YrY/.claude/skills/rui-init/steps/05-verify/'"
        },
        {
          "order": 4,
          "type": "run",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/src-rui-init-05-verify/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/skills/rui-init/steps/05-verify/'",
    ...
    },
    {
      ...
      "items": [
        ...
        {
          "title": "skills/rui-init/steps/05-verify/",
          "href": "../../skills/rui-init/steps/05-verify",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "src-rui-init-05-verify", label: "05-verify", data: dataset }],
    default: dataset
  };
})();
