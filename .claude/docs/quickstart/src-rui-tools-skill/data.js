(function () {
  ...
  "header": {
    ...
    "title": "Quickstart — skill",
    "tagline": "Grounded newcomer orientation for the \"skill\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "skill",
    "audience": "Contributors navigating the skill card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "skill is a docs-home card under \"skills/rui-tools — Meta Tooling\" in the \"Main Source Code\" section. Create, evaluate, optimize, and package skill manifests. Metadata: Sub-skill · agents + workflows.",
      "hero": {
        "eyebrow": "skills/rui-tools — Meta Tooling",
        "title": "Understand skill in about 6 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/src-rui-tools-skill/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for skill."
          },
          {
            "id": "verify",
            "n": 3,
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/src-rui-tools-skill",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "items": [
        {
          "name": "skill",
          "role": "card",
          "description": "Create, evaluate, optimize, and package skill manifests.",
        ...
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Sub-skill · agents + workflows",
          "file": "docs/data.js",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── src-rui-tools-skill/index.html",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/src-rui-tools-skill/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how skill is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/src-rui-tools-skill/index.html'"
        },
        {
          "order": 3,
          "type": "run",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/src-rui-tools-skill/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "Create, evaluate, optimize, and package skill manifests.",
          "source": "docs/data.js"
        },
        {
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "src-rui-tools-skill", label: "skill", data: dataset }],
    default: dataset
  };
})();
