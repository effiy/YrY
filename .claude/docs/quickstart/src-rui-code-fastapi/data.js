(function () {
  ...
  "header": {
    ...
    "title": "Quickstart — fastapi",
    "tagline": "Grounded newcomer orientation for the \"fastapi\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "fastapi",
    "audience": "Contributors navigating the fastapi card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "fastapi is a docs-home card under \"skills/rui-code — Technology Guidance\" in the \"Main Source Code\" section. FastAPI guidance with commands for scaffold, review, and refactor. Metadata: Sub-skill · commands + references + evals.",
      "hero": {
        "eyebrow": "skills/rui-code — Technology Guidance",
        "title": "Understand fastapi in about 6 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/src-rui-code-fastapi/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for fastapi."
          },
          {
            "id": "verify",
            "n": 3,
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/src-rui-code-fastapi",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "items": [
        {
          "name": "fastapi",
          "role": "card",
          "description": "FastAPI guidance with commands for scaffold, review, and refactor.",
        ...
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Sub-skill · commands + references + evals",
          "file": "docs/data.js",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── src-rui-code-fastapi/index.html",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/src-rui-code-fastapi/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how fastapi is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/src-rui-code-fastapi/index.html'"
        },
        {
          "order": 3,
          "type": "run",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/src-rui-code-fastapi/index.html"
        }
      ]
    },
    {
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "src-rui-code-fastapi", label: "fastapi", data: dataset }],
    default: dataset
  };
})();
