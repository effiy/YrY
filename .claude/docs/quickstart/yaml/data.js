(function () {
  ...
  "header": {
    ...
    "title": "Quickstart — yaml",
    "tagline": "Grounded newcomer orientation for the \"yaml\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "deps/yaml/index.html",
    "audience": "Contributors navigating the yaml card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "yaml is a docs-home card under \"Runtime Dependencies (15)\" in the \"Third-Party Dependencies / Frameworks\" section. YAML parser used by import, indexing, and config workflows. Metadata: Runtime · ^2.8.3. The closest local artifact is `deps/yaml/index.html`. The primary external reference is `https://eemeli.org/yaml/`.",
      "hero": {
        "eyebrow": "Runtime Dependencies (15)",
        "title": "Understand yaml in about 11 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/yaml/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for yaml."
          },
          {
            "id": "artifact",
            "n": 3,
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "deps/yaml/index.html",
                "sub": "local",
                "token": "qs-pass"
              },
              {
                "name": "external ref",
                "sub": "https://eemeli.org/yaml/",
                "token": "qs-warn"
              }
            ]
          },
      ...
      "items": [
        {
          "name": "yaml",
          "role": "card",
          "description": "YAML parser used by import, indexing, and config workflows.",
        ...
        },
        {
          ...
          "file": "https://eemeli.org/yaml/",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Runtime · ^2.8.3",
          "file": "deps/yaml/index.html",
          "line": 1
        }
      ]
    },
    {
      ...
      "annotations": [
        ...
        {
          "path": "docs/quickstart/yaml/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "deps/yaml/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how yaml is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/yaml/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "deps/yaml/index.html",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/yaml/index.html'"
        },
        {
          "order": 4,
          "type": "view",
      ...
      "items": [
        {
          ...
          "answer": "YAML parser used by import, indexing, and config workflows.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `deps/yaml/index.html`.",
          "source": "deps/yaml/index.html"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `deps/yaml/index.html` first, then return to docs/index.html to verify the homepage link path.",
          "source": "deps/yaml/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "deps/yaml/index.html",
          "href": "../../deps/yaml/index.html",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "yaml", label: "yaml", data: dataset }],
    default: dataset
  };
})();
