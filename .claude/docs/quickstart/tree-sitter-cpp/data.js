(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — tree-sitter-cpp",
    "scope": "deps/tree-sitter-cpp/index.html",
    "scopeShort": "tree-sitter-cpp",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — tree-sitter-cpp",
    "tagline": "Grounded newcomer orientation for the \"tree-sitter-cpp\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "deps/tree-sitter-cpp/index.html",
    "audience": "Contributors navigating the tree-sitter-cpp card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "tree-sitter-cpp is a docs-home card under \"Runtime Dependencies (15)\" in the \"Third-Party Dependencies / Frameworks\" section. C/C++ grammar package for the diagram parser. Metadata: Runtime · ^0.23.4. The closest local artifact is `deps/tree-sitter-cpp/index.html`. The primary external reference is `https://github.com/tree-sitter/tree-sitter-cpp`.",
      "hero": {
        "eyebrow": "Runtime Dependencies (15)",
        "title": "Understand tree-sitter-cpp in about 11 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/tree-sitter-cpp/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for tree-sitter-cpp."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "deps/tree-sitter-cpp/index.html",
          ...
          },
          {
            ...
            "color": "warn",
            "type": "view",
            "ref": "https://github.com/tree-sitter/tree-sitter-cpp",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "deps/tree-sitter-cpp/index.html",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "deps/tree-sitter-cpp/index.html",
                "sub": "local",
                "token": "qs-pass"
              },
              {
                "name": "external ref",
                "sub": "https://github.com/tree-sitter/tree-sitter-cpp",
                "token": "qs-warn"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/tree-sitter-cpp",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "deps/tree-sitter-cpp/index.html"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "tree-sitter-cpp",
          "role": "card",
          "description": "C/C++ grammar package for the diagram parser.",
        ...
        },
        {
          ...
          "file": "deps/tree-sitter-cpp/index.html",
          "line": 1
        },
        {
          ...
          "file": "https://github.com/tree-sitter/tree-sitter-cpp",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Runtime · ^0.23.4",
          "file": "deps/tree-sitter-cpp/index.html",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── tree-sitter-cpp/index.html\n├── deps/tree-sitter-cpp/index.html",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/tree-sitter-cpp/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "deps/tree-sitter-cpp/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how tree-sitter-cpp is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/tree-sitter-cpp/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "deps/tree-sitter-cpp/index.html",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/tree-sitter-cpp/index.html'"
        },
        {
          "order": 4,
          "type": "view",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/tree-sitter-cpp/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/docs/deps/tree-sitter-cpp/index.html'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "deps/tree-sitter-cpp/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "C/C++ grammar package for the diagram parser.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `deps/tree-sitter-cpp/index.html`.",
          "source": "deps/tree-sitter-cpp/index.html"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `deps/tree-sitter-cpp/index.html` first, then return to docs/index.html to verify the homepage link path.",
          "source": "deps/tree-sitter-cpp/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "deps/tree-sitter-cpp/index.html",
          "href": "../../deps/tree-sitter-cpp/index.html",
          "description": "Closest local artifact carried by the card.",
          "kind": "directory"
        },
        {
          "title": "tree-sitter-cpp upstream",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "tree-sitter-cpp", label: "tree-sitter-cpp", data: dataset }],
    default: dataset
  };
})();
