      ...
      "items": [
        {
          ...
          "answer": "Module map and conventions for the current repository layout.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `skills/rui-init/steps/02-explore/`.",
          "source": "skills/rui-init/steps/02-explore/"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `skills/rui-init/steps/02-explore/` first, then return to docs/index.html to verify the homepage link path.",
          "source": "skills/rui-init/steps/02-explore/"
        }
      ]
    },
