(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — 02-explore",
    "scope": "skills/rui-init/steps/02-explore/",
    "scopeShort": "02-explore",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — 02-explore",
    "tagline": "Grounded newcomer orientation for the \"02-explore\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "skills/rui-init/steps/02-explore/",
    "audience": "Contributors navigating the 02-explore card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "02-explore is a docs-home card under \"skills/rui-init — Initialization Pipeline\" in the \"Main Source Code\" section. Module map and conventions for the current repository layout. Metadata: Step · skills/rui-init/steps/02-explore/. The closest local artifact is `skills/rui-init/steps/02-explore/`.",
      "hero": {
        "eyebrow": "skills/rui-init — Initialization Pipeline",
        "title": "Understand 02-explore in about 9 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/src-rui-init-02-explore/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for 02-explore."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "skills/rui-init/steps/02-explore/",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "skills/rui-init/steps/02-explore/",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "skills/rui-init/steps/02-explore/",
                "sub": "local",
                "token": "qs-pass"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/src-rui-init-02-explore",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "skills/rui-init/steps/02-explore/"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "02-explore",
          "role": "card",
          "description": "Module map and conventions for the current repository layout.",
        ...
        },
        {
          ...
          "file": "skills/rui-init/steps/02-explore/",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Step · skills/rui-init/steps/02-explore/",
          "file": "skills/rui-init/steps/02-explore/",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── src-rui-init-02-explore/index.html\n├── skills/rui-init/steps/02-explore/",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/src-rui-init-02-explore/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "skills/rui-init/steps/02-explore/",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how 02-explore is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/src-rui-init-02-explore/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "skills/rui-init/steps/02-explore/",
          "command": "open '/Users/yi/YrY/.claude/skills/rui-init/steps/02-explore/'"
        },
        {
          "order": 4,
          "type": "run",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/src-rui-init-02-explore/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/skills/rui-init/steps/02-explore/'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "skills/rui-init/steps/02-explore/"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "This page is a child surface under `skills/rui-init/steps/02-explore/`, but the canonical benchmark still lives in `skills/rui-init/evals/evals.json`. It currently contains 10 prompt cases for `rui-init`, so it is the fastest way to see what behavior the skill must preserve.",
    ...
    },
    {
      ...
      "items": [
        ...
        {
          "title": "skills/rui-init/steps/02-explore/",
          "href": "../../skills/rui-init/steps/02-explore",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "src-rui-init-02-explore", label: "02-explore", data: dataset }],
    default: dataset
  };
})();
