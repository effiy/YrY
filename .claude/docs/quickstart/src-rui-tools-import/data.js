(function () {
  ...
  "header": {
    ...
    "title": "Quickstart — import",
    "tagline": "Grounded newcomer orientation for the \"import\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "import",
    "audience": "Contributors navigating the import card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "import is a docs-home card under \"skills/rui-tools — Meta Tooling\" in the \"Main Source Code\" section. Remote session import/sync tooling with token-based HTTP access. Metadata: Sub-skill · lib + sync.mjs.",
      "hero": {
        "eyebrow": "skills/rui-tools — Meta Tooling",
        "title": "Understand import in about 6 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/src-rui-tools-import/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for import."
          },
          {
            "id": "verify",
            "n": 3,
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/src-rui-tools-import",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "items": [
        {
          "name": "import",
          "role": "card",
          "description": "Remote session import/sync tooling with token-based HTTP access.",
        ...
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Sub-skill · lib + sync.mjs",
          "file": "docs/data.js",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── src-rui-tools-import/index.html",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/src-rui-tools-import/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how import is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/src-rui-tools-import/index.html'"
        },
        {
          "order": 3,
          "type": "run",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/src-rui-tools-import/index.html"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "Remote session import/sync tooling with token-based HTTP access.",
          "source": "docs/data.js"
        },
        {
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "src-rui-tools-import", label: "import", data: dataset }],
    default: dataset
  };
})();
