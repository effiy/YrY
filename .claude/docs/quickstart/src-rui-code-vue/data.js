(function () {
  ...
  "header": {
    ...
    "title": "Quickstart — vue",
    "tagline": "Grounded newcomer orientation for the \"vue\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "vue",
    "audience": "Contributors navigating the vue card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "vue is a docs-home card under \"skills/rui-code — Technology Guidance\" in the \"Main Source Code\" section. Largest reference corpus in the catalog, covering Vue 3 and VueUse topics. Metadata: Sub-skill · multi-topic references.",
      "hero": {
        "eyebrow": "skills/rui-code — Technology Guidance",
        "title": "Understand vue in about 6 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/src-rui-code-vue/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for vue."
          },
          {
            "id": "verify",
            "n": 3,
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/src-rui-code-vue",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "items": [
        {
          "name": "vue",
          "role": "card",
          "description": "Largest reference corpus in the catalog, covering Vue 3 and VueUse topics.",
        ...
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Sub-skill · multi-topic references",
          "file": "docs/data.js",
          "line": 1
        }
      ]
    },
    {
      ...
      "annotations": [
        ...
        {
          "path": "docs/quickstart/src-rui-code-vue/index.html",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how vue is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/src-rui-code-vue/index.html'"
        },
        {
          "order": 3,
          "type": "run",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/src-rui-code-vue/index.html"
        }
      ]
    },
    {
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "src-rui-code-vue", label: "vue", data: dataset }],
    default: dataset
  };
})();
