(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — 04-arch",
    "scope": "skills/rui-init/steps/04-arch/",
    "scopeShort": "04-arch",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — 04-arch",
    "tagline": "Grounded newcomer orientation for the \"04-arch\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "skills/rui-init/steps/04-arch/",
    "audience": "Contributors navigating the 04-arch card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "04-arch is a docs-home card under \"skills/rui-init — Initialization Pipeline\" in the \"Main Source Code\" section. Story-tree generation for architecture and test documentation. Metadata: Step · skills/rui-init/steps/04-arch/. The closest local artifact is `skills/rui-init/steps/04-arch/`.",
      "hero": {
        "eyebrow": "skills/rui-init — Initialization Pipeline",
        "title": "Understand 04-arch in about 9 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/src-rui-init-04-arch/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for 04-arch."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "skills/rui-init/steps/04-arch/",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "skills/rui-init/steps/04-arch/",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "skills/rui-init/steps/04-arch/",
                "sub": "local",
                "token": "qs-pass"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/src-rui-init-04-arch",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Primary scope",
          "value": "skills/rui-init/steps/04-arch/"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "04-arch",
          "role": "card",
          "description": "Story-tree generation for architecture and test documentation.",
        ...
        },
        {
          ...
          "file": "skills/rui-init/steps/04-arch/",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Step · skills/rui-init/steps/04-arch/",
          "file": "skills/rui-init/steps/04-arch/",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── src-rui-init-04-arch/index.html\n├── skills/rui-init/steps/04-arch/",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/src-rui-init-04-arch/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "skills/rui-init/steps/04-arch/",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how 04-arch is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/src-rui-init-04-arch/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "skills/rui-init/steps/04-arch/",
          "command": "open '/Users/yi/YrY/.claude/skills/rui-init/steps/04-arch/'"
        },
        {
          "order": 4,
          "type": "run",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/src-rui-init-04-arch/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/skills/rui-init/steps/04-arch/'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "skills/rui-init/steps/04-arch/"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "This page is a child surface under `skills/rui-init/steps/04-arch/`, but the canonical benchmark still lives in `skills/rui-init/evals/evals.json`. It currently contains 10 prompt cases for `rui-init`, so it is the fastest way to see what behavior the skill must preserve.",
    ...
    },
    {
      ...
      "items": [
        ...
        {
          "title": "skills/rui-init/steps/04-arch/",
          "href": "../../skills/rui-init/steps/04-arch",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "src-rui-init-04-arch", label: "04-arch", data: dataset }],
    default: dataset
  };
})();
