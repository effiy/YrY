      ...
      "items": [
        {
          ...
          "answer": "Story-tree generation for architecture and test documentation.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `skills/rui-init/steps/04-arch/`.",
          "source": "skills/rui-init/steps/04-arch/"
        },
        {
        ...
        },
        {
          ...
          "answer": "Open `skills/rui-init/steps/04-arch/` first, then return to docs/index.html to verify the homepage link path.",
          "source": "skills/rui-init/steps/04-arch/"
        }
      ]
    },
