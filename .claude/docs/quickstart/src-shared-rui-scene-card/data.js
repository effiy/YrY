(function () {
  ...
  var dataset = {
  "meta": {
    "title": "Quickstart — rui-scene-card",
    "scope": "shared/components/rui-scene-card/",
    "scopeShort": "rui-scene-card",
    "language": "en",
    "depth": 3,
  ...
  "header": {
    ...
    "title": "Quickstart — rui-scene-card",
    "tagline": "Grounded newcomer orientation for the \"rui-scene-card\" docs card. Built from homepage metadata, linked artifacts, and local report paths.",
    "scope": "shared/components/rui-scene-card/",
    "audience": "Contributors navigating the rui-scene-card card",
  ...
  "sections": [
    {
      ...
      "coverage": 94,
      "verdict": "pass",
      "summary": "rui-scene-card is a docs-home card under \"shared/ — Cross-Page UI Substrate\" in the \"Main Source Code\" section. The core card primitive used by the dashboard and report pages. Metadata: Component · shared/components/rui-scene-card/. The closest local artifact is `shared/components/rui-scene-card/`.",
      "hero": {
        "eyebrow": "shared/ — Cross-Page UI Substrate",
        "title": "Understand rui-scene-card in about 9 min",
        ...
        "steps": [
          ...
          },
          {
            ...
            "color": "accent",
            "type": "read",
            "ref": "docs/quickstart/src-shared-rui-scene-card/index.html",
            "outcome": "Use this quickstart page to collect the grounded paths, links, and first actions for rui-scene-card."
          },
          {
            "id": "artifact",
            "n": 3,
            ...
            "color": "pass",
            "type": "read",
            "ref": "shared/components/rui-scene-card/",
      ...
      "landscape": {
        ...
        "groups": [
          ...
          },
          {
            ...
            "count": 1,
            "share": 25,
            "top": "shared/components/rui-scene-card/",
            "accent": "pass",
      ...
      "stack": {
        "layers": [
          ...
          },
          {
            ...
            "items": [
              {
                "name": "shared/components/rui-scene-card/",
                "sub": "local",
                "token": "qs-pass"
              }
            ]
          },
          {
            ...
            "items": [
              {
                "name": "quickstart/src-shared-rui-scene-card",
                "sub": "card directory",
                "token": "qs-todo"
              }
            ]
      ...
      "tiles": [
        ...
        {
          "label": "Group",
          "value": "shared/ — Cross-Page UI Substrate"
        },
        {
          "label": "Card kind",
          "value": "items"
        ...
        {
          "label": "Primary scope",
          "value": "shared/components/rui-scene-card/"
        }
      ],
      "stats": [
        {
      ...
      "items": [
        {
          "name": "rui-scene-card",
          "role": "card",
          "description": "The core card primitive used by the dashboard and report pages.",
          "file": "docs/index.html",
          "line": 1
        },
        {
          "name": "shared/ — Cross-Page UI Substrate",
          "role": "group",
        ...
        },
        {
          ...
          "file": "shared/components/rui-scene-card/",
          "line": 1
        },
        {
          "name": "Metadata cue",
          "role": "meta",
          "description": "Component · shared/components/rui-scene-card/",
          "file": "shared/components/rui-scene-card/",
          "line": 1
        }
      ]
    },
    {
      ...
      "verdict": "pass",
      "depth": 3,
      "tree": ".claude/\n├── docs/index.html\n├── docs/quickstart/\n│   ├── index.html\n│   └── src-shared-rui-scene-card/index.html\n├── shared/components/rui-scene-card/",
      "annotations": [
        {
        ...
        {
          "path": "docs/quickstart/src-shared-rui-scene-card/index.html",
          "note": "Per-card quickstart page generated for this card."
        },
        {
          "path": "shared/components/rui-scene-card/",
      ...
      "steps": [
        {
          ...
          "outcome": "You see how rui-scene-card is grouped and what related cards sit nearby.",
        ...
        },
        {
          ...
          "command": "open '/Users/yi/YrY/.claude/docs/quickstart/src-shared-rui-scene-card/index.html'"
        },
        {
          "order": 3,
          "type": "read",
          ...
          "file": "shared/components/rui-scene-card/",
          "command": "open '/Users/yi/YrY/.claude/shared/components/rui-scene-card/'"
        },
        {
          "order": 4,
          "type": "run",
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "source": "docs/quickstart/src-shared-rui-scene-card/index.html"
        },
        {
          "name": "open-artifact",
          "command": "open '/Users/yi/YrY/.claude/shared/components/rui-scene-card/'",
          "description": "Open the closest local artifact attached to the card metadata or links.",
          "source": "shared/components/rui-scene-card/"
        }
      ]
    },
    {
      ...
      "items": [
        {
          ...
          "answer": "The core card primitive used by the dashboard and report pages.",
          "source": "docs/data.js"
        },
        {
          "question": "Where is the closest local artifact for this card?",
          "answer": "The nearest local artifact is `shared/components/rui-scene-card/`.",
          "source": "shared/components/rui-scene-card/"
        },
        {
          "question": "Which group owns this card on the homepage?",
          "answer": "The card is rendered in the group \"shared/ — Cross-Page UI Substrate\" inside the section \"Main Source Code\".",
          "source": "docs/data.js"
        },
        {
          "question": "What should I open next after reading this page?",
          "answer": "Open `shared/components/rui-scene-card/` first, then return to docs/index.html to verify the homepage link path.",
          "source": "shared/components/rui-scene-card/"
        }
      ]
    },
    {
      ...
      "items": [
        ...
        {
          "title": "shared/components/rui-scene-card/",
          "href": "../../shared/components/rui-scene-card",
  ...
  window.QUICKSTART_DATA = {
    datasets: [{ key: "src-shared-rui-scene-card", label: "rui-scene-card", data: dataset }],
    default: dataset
  };
})();
