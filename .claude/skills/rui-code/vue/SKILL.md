...
| `v-once`, `v-memo`, virtualize large list, `updated` hook perf, component abstraction in lists | `perf/` | [perf-v-once-v-memo-directives.md](./references/perf/perf--perf-v-once-v-memo-directives.md), [perf-virtualize-large-lists.md](./references/perf/perf--perf-virtualize-large-lists.md), [perf-avoid-component-abstraction-in-lists.md](./references/perf/perf--perf-avoid-component-abstraction-in-lists.md), [updated-hook-performance.md](./references/perf/perf--updated-hook-performance.md) |
