...
description: Categorized checklist for reviewing Vue 3 SFCs against the rui-html-vue rules — correctness, reactivity, performance, accessibility, and 4-file pattern conformance.
---
...
- [ ] `index.css` uses `--rui-doc-*` tokens, never raw `--rui-*` (see
