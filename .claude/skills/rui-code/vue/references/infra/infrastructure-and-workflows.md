---
description: "Infrastructure scripts, workflow specifications, critical rules, and pre-delivery checklist for rui-html-vue."
---
...
- Entry point: rui-loader → rui-tag-chip → rui-scene-card → rui-back-top → mount-component.js → include.js → main.js

### Theme Tokens
- ALL colors use `var(--rui-*)` — zero hardcoded hex
- `tokens.css` bridges CDN tokens → `--rui-doc-*` tokens
