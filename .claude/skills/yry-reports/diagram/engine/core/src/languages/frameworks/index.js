...
export const builtinFrameworkConfigs = [
    djangoConfig,
    fastapiConfig,
    flaskConfig,
    reactConfig,
...
export { djangoConfig, fastapiConfig, flaskConfig, reactConfig, nextjsConfig, expressConfig, vueConfig, springConfig, railsConfig, ginConfig, };
