 ...
 */
export function extractFileFingerprint(filePath, content, analysis) {
 ...
 */
export function buildFingerprintStore(projectDir, filePaths, registry, gitCommitHash) {
    const files = {};
 ...
 */
export function analyzeChanges(projectDir, changedFiles, existingStore, registry) {
    const fileChanges = [];
    const newFiles = [];
    const deletedFiles = [];
