...
> Full methodology for `yry-report-apis`. The implementing agent
...
3. Tables use `yry-sortable` utility for sort and filter
4. CSS uses `--yry-*` design tokens (semantic names, no numbers)
