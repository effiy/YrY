...
(function () {
  ...
  var EXAMPLE_DATA = {
    ...
    summary: {
      ...
      hotFiles: [
        { rank: 1,  path: '.claude/skills/yry-reports/diagram/templates/architecture-diagram.html', touches: 39 },
        { rank: 2,  path: '.claude/skills/yry-reports/diagram/SKILL.md',                              touches: 25 },
        { rank: 3,  path: '.claude/skills/yry-reports/diagram/references/design-system.md',           touches: 14 },
        { rank: 4,  path: '.claude/skills/yry-reports/files/SKILL.md',                                touches:  9 },
        { rank: 5,  path: '.claude/skills/yry-reports/daily/SKILL.md',                                 touches:  9 },
        { rank: 6,  path: '.claude/skills/yry-tools/public-api/SKILL.md',                             touches:  8 },
        { rank: 7,  path: '.claude/skills/yry-tools/cc/SKILL.md',                                      touches:  8 },
        { rank: 8,  path: '.claude/skills/yry-reports/files/templates/index.html',                    touches:  8 },
        { rank: 9,  path: '.claude/skills/yry-reports/test/SKILL.md',                            touches:  8 },
        { rank: 10, path: '.claude/skills/yry-reports/diagram/commands/create.md',                     touches:  8 }
      ],
      narrative: {
        shipped:
          'The <code>yry-reports</code> family (daily, files, diagram, test) absorbed the ' +
          ...
          'canonical-snippet model documented in <code>yry-init</code>, with template assets ' +
        ...
        drifting:
          ...
          '<code>git log</code>.',
        watch:
          'The skill subproject under <code>yry-reports/diagram/engine</code> is now a real ' +
    ...
    risk: {
      ...
      items: [
        ...
        },
        {
          ...
          name: 'TODO / FIXME density in yry-reports',
          hint: '66 of the 82 <code>TODO|FIXME|XXX</code> markers in the entire skills tree live under <code>yry-reports/</code>. The other 4 skills combined account for 16.',
          action: 'Open a "tech-debt sweep" pass over <code>yry-reports</code> before the next reporting cycle lands.'
        },
        {
        ...
        },
        {
          ...
          hint: '<code>yry-reports/diagram/engine</code> contains ≈ 2,762 files (889 <code>.js</code>, 807 <code>.ts</code>, plus a <code>tree-sitter-dart-wasm</code> bundle). It is no longer a skill definition — it is a delivered library with no CI, no release process, no <code>CHANGELOG</code>, and no version tag.',
    ...
    health: {
      ...
      skills: [
        { name: 'yry-code',    files: 338,  skillMd: 9, evals: 9, references: 317, notes: '9 sub-skills; heavy with vueuse references' },
        { name: 'yry-init',    files: 52,   skillMd: 1, evals: 0, references: 12,  notes: '5-step pipeline (detect → explore → generate → arch → verify)' },
        { name: 'yry-reports', files: 2841, skillMd: 5, evals: 5, references: 24,  notes: '5 sub-skills; the diagram sub-skill contains the engine (≈ 2,762 files)' },
        { name: 'yry-test',    files: 21,   skillMd: 1, evals: 1, references: 14,  notes: 'Smallest skill; the fixture topic bundle has the test-contracts rule set' },
        { name: 'yry-tools',   files: 207,  skillMd: 9, evals: 8, references: 60,  notes: '9 sub-skills; ui-ux/shared/fonts bundle is 81 of the 207 files' }
      ],
      tests: {
        testLoc: 1161,
        allJsLoc: 400568,
      ...
      techDebt: [
        { marker: 'TODO in skills',   count: 82,     verdict: 'AMBER', color: 'amber', share: '80% concentrated in yry-reports' },
    ...
    people: {
      ...
      activityPulse: [
        ...
        { date: '2026-07-16', day: 'Thu', commits: 10, hint: 'Page-HTML-Generation removals across yry-tools',barWidth: 48  },
        { date: '2026-07-17', day: 'Fri', commits: 11, hint: 'continuing yry-tools cleanup',                  barWidth: 52  }
      ],
      review: {
