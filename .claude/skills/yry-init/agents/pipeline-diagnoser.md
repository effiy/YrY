...
| `arch` | Missing scene templates, story directory conflict, disk write failure |
| `verify` | Check failures (see verify's 7 checks), artifact not found, checksum mismatch |
