---
description: "Check generated rui-init artifacts for consistency — CLAUDE.md vs README.md alignment, docs/ file inventory, cross-reference integrity."
---

# Artifact Consistency Checker Agent

After the rui-init pipeline completes successfully, this agent verifies cross-artifact consistency: do CLAUDE.md, README.md, and docs/ agree with each other?
...
Compare `docs/{theme,index.html,index.css,index.js}` against `rui-init/templates/`:
...
```json
{
  ...
  "checks": [
    ...
    { "name": "cross-reference-integrity", "passed": false, "detail": "Broken link: ./rui-init-explore/SKILL.md" },
