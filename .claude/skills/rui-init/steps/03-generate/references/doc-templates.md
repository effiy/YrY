---
description: "Document template reference for rui-init-generate — CLAUDE.md section layout, README.md structure, and docs/data.js shape."
---
...
`rui-init/templates/data.js`; the snippet below is the canonical
...
- Layout files: copied verbatim from `rui-init/templates/` with path rewrites
