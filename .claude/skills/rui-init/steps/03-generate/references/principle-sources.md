...
Users can provide custom principles via the `principles` input to rui-init-generate. Each principle becomes one bullet in the appropriate CLAUDE.md section.
