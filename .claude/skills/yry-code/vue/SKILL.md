...
This skill consolidates the 27 `yry-html-vue-*` source skills into a
...
| User wants the previous 28-skill split | The 27 source skills still exist under `yry-html-vue-*` and can be installed individually. This skill supersedes them for daily use. |
