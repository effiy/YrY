...
description: Categorized checklist for reviewing Vue 3 SFCs against the yry-html-vue rules — correctness, reactivity, performance, accessibility, and 4-file pattern conformance.
---
