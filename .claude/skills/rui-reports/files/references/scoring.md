...
> Unified score + alert spec for rui-report-files. Conforms to
> [rui-report/references/scoring-alert-spec.md](../../rui-report/references/scoring-alert-spec.md) v1.0.
> The orchestrator (`rui-report`) reads this block to compute the composite score.
