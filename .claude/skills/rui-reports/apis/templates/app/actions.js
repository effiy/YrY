...
(function () {
    ...
    RuiReportApp.methods = {
        toggleRemediation: function (key) {
            ...
            try { localStorage.setItem('rui-report-api-remediation-done', JSON.stringify(next)); } catch (e) {}
        },

        clearRemediationDone: function () {
            this.remediationDone = {};
            try { localStorage.removeItem('rui-report-api-remediation-done'); } catch (e) {}
        },
