...
| 6 | Include keyboard shortcuts (1–N, t, ?) | Consistency with other rui-reports |
...
├── components/
│   ├── rui-report-api-summary/    # Health score + stat cards
│   ├── rui-report-api-endpoints/  # Request inventory (sortable, filterable)
│   ├── rui-report-api-semantics/  # HTTP semantics analysis (NEW)
│   ├── rui-report-api-patterns/   # Pattern analysis table
│   ├── rui-report-api-security/   # Security audit table
│   ├── rui-report-api-health/     # Error handling + response quality + contracts
│   └── rui-report-api-remediation/# P0/P1/P2 action queue
├── lib/
│   └── rui-sortable.js           # Sortable table utility
└── references/
