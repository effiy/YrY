 ...
 *           besides the rui-daily-report namespace banner so other tools
...
<div class="wrap">
      ...
      <table v-if="health.tests">
        ...
        <tbody>
          ...
          <tr><td>Test files</td>
              ...
              <td>—</td>
              <td><span class="muted">all under rui-reports/diagram/engine</span></td></tr>
        </tbody>
      </table>
  ...
  <footer>
    <p>
      Generated by <code>/daily report</code> (<code>rui-reports/daily</code>) ·
...
`;
  ...
  waitForVue().then(function (Vue) {
    ...
    window.dispatchEvent(new CustomEvent('rui-daily-report-ready', { detail: { version: (schema && schema.version) || 1 } }));
