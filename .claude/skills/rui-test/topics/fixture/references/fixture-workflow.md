...
```json
{
  "test": "rui-scene-card/basic-render",
  "result": "pass",
  "diff_pct": 0.3,
  "diff_regions": [],
...
`rui-html-test-vitest-setup`), E2E Playwright (see
`rui-html-test-e2e-playwright`), or browser-runner unit tests (see
`rui-html-test-runner-choice`). Use those for runtime / behavioral
