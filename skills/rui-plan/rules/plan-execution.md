...
| 类别 | 内容 |
|------|------|
| 上游规则 | [doc-generation](../../rui-html/rules/doc-generation.md)（文档基线）· [code-pipeline](../../rui-code/rules/code-pipeline.md)（管线阶段） |
| 上游 Agent | [pm](../../rui/pm.md)（故事文档基线）· [architect](../architect.md)（架构设计） |
| 执行 Agent | [planner](../planner.md)（计划创建）· [coder](../../rui/coder.md)（计划执行）· [tester](../../rui/tester.md)（验证执行） |
| 技能 | [rui](../../rui/SKILL.md)（`/rui plan` 命令） |
