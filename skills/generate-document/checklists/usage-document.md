...
> **Related specs**: [Usage Document Spec](../rules/usage-document.md) | [General Document Checklist](./general-document.md)
...
- Scenario structure is uniform (contains applicability, operation steps, expected results, and notes)
- Question categories are clear
- Tips exist (at least 3)
- Aligned with design document

## P2 — Nice to Have

- Shortcut key table, glossary, command cheat sheet
