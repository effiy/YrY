// skills/rui-story/scripts/pipeline.mjs — 端到端执行：抽取 → 生成审查.html → 清理 6 个 html
// 用法:
//   node skills/rui-story/scripts/pipeline.mjs                           # 跑所有场景
//   node skills/rui-story/scripts/pipeline.mjs <subdir>                  # 跑某个子目录
//   node skills/rui-story/scripts/pipeline.mjs <subdir>/<scenarioDir>    # 跑某个场景
import { forEachScenario } from '../lib/walk.mjs';
import { extractScenarioData, writeCache } from '../lib/extract-scenario.mjs';
import { generateReviewHtml, scrubScenarioHtmls } from '../lib/generate-review.mjs';
