// skills/rui-story/scripts/scrub-html.mjs — 单个场景的 6 个 html 清理
// 用法: node skills/rui-story/scripts/scrub-html.mjs <subdir> <scenarioDir>
import path from 'node:path';
import { DOCS_DIR } from '../lib/paths.mjs';
import { readCache } from '../lib/extract-scenario.mjs';
import { scrubScenarioHtmls } from '../lib/generate-review.mjs';

const [, , subdir, scenarioDir] = process.argv;
if (!subdir || !scenarioDir) {
  console.error('用法: node skills/rui-story/scripts/scrub-html.mjs <subdir> <scenarioDir>');
  process.exit(1);
}
