// skills/rui-story/scripts/generate-review-html.mjs — 单个场景的审查.html 生成
// 用法: node skills/rui-story/scripts/generate-review-html.mjs <subdir> <scenarioDir>
import path from 'node:path';
import { DOCS_DIR } from '../lib/paths.mjs';
import { readCache } from '../lib/extract-scenario.mjs';
import { generateReviewHtml } from '../lib/generate-review.mjs';

const [, , subdir, scenarioDir] = process.argv;
if (!subdir || !scenarioDir) {
  console.error('用法: node skills/rui-story/scripts/generate-review-html.mjs <subdir> <scenarioDir>');
  process.exit(1);
}
