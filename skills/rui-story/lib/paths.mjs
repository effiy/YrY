// skills/rui-story/lib/paths.mjs — 路径与场景配置
...
export const SKILL_SCRIPTS_DIR = path.join(__dirname, '../scripts');
export const DOCS_DIR = path.join(ROOT, STORY_PANEL_DIR);
export const TEMPLATE_DIR = path.join(DOCS_DIR, '架构/场景-1-新人上手');
export const CACHE_DIR = path.join(SKILL_SCRIPTS_DIR, '.cache');
