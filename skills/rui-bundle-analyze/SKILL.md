...
| 等级 | 分数 | 含义 | YrY 实测 |
|------|------|------|---------|
| **Low** | 0-20 | 健康文件，风险低 | 1011 个文件 (96.6%) |
| **Medium** | 20-40 | 需要关注 | 36 个文件 (3.4%) |
| **High** | 40-60 | 需要行动 | 0 个 |
| **Critical** | 60-80 | 需尽快处理 | 0 个 |
| **Extreme** | 80-100 | 紧急重构 | 0 个 |

#### 风险分布

风险桶统计帮助快速评估项目整体健康度。YrY 平均风险 9.9/100，96.6% 文件处于低风险区域 — 项目整体健康。
