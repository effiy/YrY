...
// 用法: node skills/rui/record.mjs <command> [args]
...
import { readProjectName, findProjectRoot, findStoryDirs, readJsonl, readJson } from "../../lib/fs.mjs";
...
function showHelp() {
  ...
  console.log("");
  console.log("用法: node skills/rui/record.mjs <command> [args]");
  console.log("");
  console.log("命令:");
