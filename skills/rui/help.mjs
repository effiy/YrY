...
${section("常用场景示例", [
  ...
  ["", ""],
  ["# 从文档开始编码", ""],
  ["/rui code user-login", "基于已有文档实现故事"],
  ["", ""],
  ["# 存量代码补文档", ""],
  ["/rui doc --from-code", "pm 扫描源码推荐待文档化模块"],
  ["/rui doc --from-code user-login", "从指定模块源码反推完整故事文档"],
  ["", ""],
  ["# 小修小补", ""],
  ["/rui update user-login \"新增OAuth登录\"", "T1～T3 自动判定变更范围"],
  ["", ""],
  ["# 补充文档到已有故事", ""],
  ["/rui code --from-doc user-login", "只读源码补全缺失的 02/03/05/06"],
  ["", ""],
  ["# 查看进度", ""],
