 ...
 */
export function getSkillMeta(/** @type {string} */ skill) {
  const found = LOOP_SKILLS.find((/** @type {any} */ s) => s.skill === skill);
 ...
 */
export function getCheckItems(/** @type {string} */ skill) {
  return (/** @type {any} */ (LOOP_CHECK_ITEMS))[skill] || DEFAULT_CHECK_ITEMS;
}

/**
 * Lookup helper: get cross-reference for a skill.
 */
export function getCrossRef(/** @type {string} */ skill) {
  return (/** @type {any} */ (LOOP_CROSS_REFS))[skill] || null;
}
