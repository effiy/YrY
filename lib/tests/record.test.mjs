...
function createExecRecord(/** @type {any} */ opts = {}) {
  return {
...
function createDeliveryRecord(/** @type {any} */ opts = {}) {
  return {
...
function createAuditRecord(/** @type {any} */ opts = {}) {
  return {
...
function createInitialState(/** @type {string} */ storyName) {
...
function transitionState(/** @type {any} */ state, /** @type {string} */ newStage, /** @type {string} */ trigger = "record state command") {
  const now = new Date().toISOString();
