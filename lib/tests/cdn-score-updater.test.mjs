...
function classifyScore(/** @type {number} */ score) {
...
function buildRecommendations(/** @type {any[]} */ breakdown) {
  return breakdown
...
function computeDiagRate(/** @type {number} */ triggered, /** @type {number} */ total) {
  return total > 0 ? Math.round((triggered / total) * 100) : 0;
}

function getComponentLabel(/** @type {string} */ cat) {
...
function mapCategory(/** @type {string} */ dimLabel) {
