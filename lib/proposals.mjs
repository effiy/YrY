...
import { readJsonl, readJson } from "./fs.mjs";
...
function computeDocIssues(storyPath, execCount) {
  ...
  const proposalsPath = join(storyPath, PROPOSALS_DIR, PROPOSALS_FILE);
...
import { cmdEvaluate, evaluateProposal } from "./engine/evaluate.mjs";
