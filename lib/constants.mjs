...
/** D0-D8 diagnostic labels (shared: proposals.mjs, collect.mjs) */
 ...
 */
export const ARCH_HEALTH_DIM_WEIGHTS = {
  arch_kernel:     20,  // 内核体积合规
  arch_srp:        15,  // SRP 合规（description 不含"和/与/也"）
  arch_imports:    15,  // 导入规范合规
  arch_extensions: 15,  // 扩展隔离
  arch_isp:        10,  // ISP 合规（Agent 工具集最小化）
  arch_frontmatter:15,  // 配置 frontmatter 完整
  arch_paradigm:   10,  // 范式合规（无 class/default export）
  arch_docs:       10,  // 文档新鲜度（链接有效·引用正确）
  arch_healthcheck:10,  // 原则可验证性
};
