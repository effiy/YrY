 ...
 *
 * @param {object} proposal - Proposal entry with id/action/target
 * @param {object} preMetrics - Metrics snapshot before implementation
 * @param {object} postMetrics - Metrics snapshot after implementation
 ...
 *
 * @param {Array<object>} memories - Execution memory records
 * @returns {{ blockedCount: number, totalP0: number, totalIssues: number, block_rate: number }}
 */
 ...
 *
 * @param {object} opts - CLI options (since, limit, etc.)
