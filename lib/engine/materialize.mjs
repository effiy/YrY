...
import { readProjectName, readJsonl, findProjectRoot } from "../fs.mjs";

export function deriveStoryDirName(proposal, projectRoot) {
...
export function createRuiState(storyPath, proposal) {
...
export function generateBaselineDoc(proposal, projectName, storyDirName) {
...
export function updateProposalRecord(proposalsPath, proposal, storyDirName) {
...
export function materializeProposal(proposal, projectRoot, projectName, dryRun) {
