 ...
 *
 * @param {object} data - Aggregated execution memory data (allExec, blocked, p0, etc.)
 * @param {Array} [docIssues=[]] - Document quality issues from doc-scan
 * @param {object|null} [archIssues=null] - Architecture check result, or null to skip
 * @returns {Array<object>} Diagnostic entries with id/triggered/evidence fields
 */
 ...
 * @param {Array<object>} history - Past diagnostic entries
 * @returns {{ severity: string, consecutive: number }}
 */
 ...
 *
 * @param {Array<object>} history - Past diagnostic entries
 * @returns {object} Correlation matrix keyed by `D1+D2`
 */
