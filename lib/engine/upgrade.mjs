 ...
 *
 * @param {object} opts - CLI options (since, min-occurrences, etc.)
 * @returns {Promise<object>} Upgrade candidate list with evidence trails
 */
export function cmdUpgradeCandidates(opts) {
