 ...
 *
 * @param {number} value - Raw value on the source scale
 * @param {number} sourceMin - Minimum of source scale
 * @param {number} sourceMax - Maximum of source scale
 * @param {number} targetMin - Minimum of target scale (default 0)
 * @param {number} targetMax - Maximum of target scale (default 100)
 * @returns {number} Normalized score
 */
export function normalizeScore(value, sourceMin, sourceMax, targetMin, targetMax) {
