...
async function query(img_base64, action, serviceVersion, appid, secret) {
    ...
    const approximate_pixel = 0; // When the height difference between text lines is approximate_pixel, they are treated as the same line. Defaults to "0".
    const mode = 'default'; // OCR mode: "default" - default mode, "text_block" - text block mode
    const filter_thresh = 80; // Text lines with confidence below filter_thresh are filtered out. Defaults to "80", max is "100".
