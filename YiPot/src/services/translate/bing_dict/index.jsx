...
const DISPLAY_FORMAT_DEFAULT = 'Pronunciation, Quick Definition, Inflection';
...
export async function translate(text, from, to) {
    ...
    if (res.ok) {
        ...
        for (const pronunciation of formatGroups['Pronunciation']) {
        ...
        for (const explanation of formatGroups['Quick Definition']) {
        ...
        if (formatGroups['Inflection'][0]) {
            for (const association of formatGroups['Inflection'][0].meanings[0].richDefinitions[0].fragments) {
