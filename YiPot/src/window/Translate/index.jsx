...
const listenBlur = () => {
    return listen('tauri://blur', () => {
        if (appWindow.label === 'translate') {
            ...
            info('Blur');
            // Close the window after 100ms, because on Windows dragging the window first triggers blur then immediately focus
...
// Listen for the move event to cancel closing within the blurTimeout window
...
export default function Translate() {
    ...
    // Whether to be always on top by default
    useEffect(() => {
