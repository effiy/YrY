...
|----|-------|------|------|--------|
| TC-N1 | help.mjs 可执行 | `node skills/rui-bot/help.mjs` | exit 0，含"快速入门""可执行入口""使用场景" | P0 |
...
|------|------|
| 通过状态 | TC-N1, TC-E1 通过 |
| 验证命令 | `node skills/rui-bot/help.mjs` |
...
> | 日期 | 变更 | 触发 | 证据 |
> |------|------|------|------|
> | 2026-05-23 | 初始生成 | /rui doc --from-code rui-bot-help-doc | 故事任务 §5 + 源码 |
