...
> | v1.1.0 | 2026-06-06 | deepseek-v4-pro | 🌿 feat/rui-npm | 📎 [CLAUDE.md](../../../CLAUDE.md) |
...
|-------------|-----|---------|-------------|:--:|
| Story 1: 包搜索与发现 | FP1 | [场景 1](场景-1-包搜索与发现/场景-1-包搜索与发现.md) | npm search → JSON 解析 → 排序 → 表格/JSON 输出 · 降级处理 | ✓ |
