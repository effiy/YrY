...
|-----------|---------|------------|---------|------|
| §1 Story 1 | 远端查询引擎需求 | 03-技术评审 §1 §2 | 架构设计 + API 接口 | 待生成 |
| §1 Story 2 | 同步与清理需求 | 03-技术评审 §1 §3 | 架构设计 + 数据模型 | 待生成 |
| §2 FP1–FP3 | 查询/状态/类型功能点 | 03-技术评审 §1 §2 | 系统架构 + API 接口 | 待生成 |
| §2 FP9–FP11 | 同步/清理/删除功能点 | 04-测试设计 §2 | 测试用例覆盖 | 待生成 |
| §2 R1–R8 | 业务规则 | 05-安全审计 §5 | 合规检查 | 待生成 |
| §5 AC1–AC12 | 验收标准 | 04-测试设计 §0 §2 | 测试用例逐一覆盖 | 待生成 |
