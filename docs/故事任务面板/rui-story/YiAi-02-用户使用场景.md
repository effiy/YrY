...
> **导航**: [← 01-故事任务](./01-YiAi-故事任务.md) · [05-测试用例评审 →](./05-YiAi-测试用例评审.md)
...
| 2026-05-17 | v1.1 强化用户空间基线 | 双基线模型升级 | 01-故事任务 同步升级 |
| 2026-05-18 | v1.2 去除创建场景 | T2 增量更新 | 01-故事任务 同步移除 create |
| 2026-05-18 | v1.2.1 明确同步方向 | T1 措辞修正 | 场景 4 方向翻转 |
