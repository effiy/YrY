  ...
  var layerScene = {
    ...
    sections: [
      ...
      },
      {
        ...
        grid: 'scene',
        items: [
          { num: '场景 1', name: 'CDN资源加载与页面渲染', nameHref: '故事任务面板/cdn/场景-1-cdn资源加载与页面渲染/index.md',  nameTarget: '_blank', desc: '5 步加载链 · shared.css + 主题 CSS + shared.js — 55 页面统一渲染', meta: sceneMeta('故事任务面板/cdn/场景-1-cdn资源加载与页面渲染') },
