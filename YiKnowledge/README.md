...
AI 赋能层（贯穿整个流水线）
─────────────────────────────────────────────────────────────────────────────
  aier/foundations/   aier/methods/   aier/platform/   aier/machine-learning/
  "AI 如何加速每个阶段"
...
| 子目录 | 回答 | 嵌入阶段 |
|---|---|---|
| [基础/](./aier/foundations/) | AI 基础与理论 | 设计（理解 AI 能力边界） |
| [方法/](./aier/methods/) | RAG 模式、LLM 评估、Agent 架构 | 构建（AI 功能实现） |
| [平台/](./aier/platform/) | 向量数据库选型、Embedding 模型选型 | 设计 + 构建（AI 基础设施） |
| [机器学习/](./aier/machine-learning/) | 传统 ML 模式 | 构建（非 LLM 的 ML 需求） |
...
| 子目录 | 职责 |
|---|---|
| [governance/](./curator/governance/) | 知识生命周期、分类标准、就绪检查清单 |
| [diagrams/](./curator/diagrams/) | 知识地图、用户旅程、目录蓝图 |
| [archive/](./curator/archive/) | 已弃用内容索引 |
| [templates/](./curator/templates/) | 知识叶子、ADR、等模板 |
...
YiKnowledge 同时服务于人类和 AI（YiAi Agent 的 RAG 数据源）：
