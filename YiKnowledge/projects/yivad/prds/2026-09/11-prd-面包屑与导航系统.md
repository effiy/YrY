...
> 实现方案见 [开发方案](../../devs/2026-09/11-prd-task-面包屑与导航系统.md)，验证方案见 [测试方案](../../tests/2026-09/11-prd-test-面包屑与导航系统.md)。
> 依赖：无（纯前端功能，不依赖后端变更）
...
| 编号 | 功能 | 说明 |
|------|------|------|
| FR-1 | 导航状态 Store | 参见 §导航状态 Store |
| FR-2 | 面包屑组件 | 参见 §面包屑组件 |
| FR-3 | 标签页栏组件 | 参见 §标签页栏组件 |
| FR-4 | useTabManager Composable | 参见 §useTabManager Compos |
| FR-5 | 路由 Meta 扩展 | 参见 §路由 Meta 扩展 |
