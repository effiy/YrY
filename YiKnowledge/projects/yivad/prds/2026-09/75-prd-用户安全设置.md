...
> 实现方案见 [开发方案](../../devs/2026-09/75-prd-task-用户安全设置.md)，验证方案见 [测试方案](../../tests/2026-09/75-prd-test-用户安全设置.md)。
...
| 编号 | 功能 | 说明 |
|------|------|------|
| FR-1 | 当前安全系统现状 | 参见 §当前安全系统现状 |
| FR-2 | 安全设置数据流 | 参见 §安全设置数据流 |
| FR-3 | 根因矩阵 | 参见 §根因矩阵 |
| FR-4 | 安全设置操作流程 | 参见 §安全设置操作流程 |
| FR-5 | 安全设置指标 | 参见 §安全设置指标 |
| FR-6 | 安全服务层 | 参见 §安全服务层 |
| FR-7 | 安全设置主页面 | 参见 §安全设置主页面 |
