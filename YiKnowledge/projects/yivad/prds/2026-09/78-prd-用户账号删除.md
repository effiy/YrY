...
> 实现方案见 [开发方案](../../devs/2026-09/78-prd-task-用户账号删除.md)，验证方案见 [测试方案](../../tests/2026-09/78-prd-test-用户账号删除.md)。
...
| 编号 | 功能 | 说明 |
|------|------|------|
| FR-1 | 当前账号管理系统现状 | 参见 §当前账号管理系统现状 |
| FR-2 | 账号删除数据流 | 参见 §账号删除数据流 |
| FR-3 | 根因矩阵 | 参见 §根因矩阵 |
| FR-4 | 账号删除步骤流程 | 参见 §账号删除步骤流程 |
| FR-5 | 账号删除指标 | 参见 §账号删除指标 |
| FR-6 | 账号删除服务 | 参见 §账号删除服务 |
| FR-7 | 账号删除页面 | 参见 §账号删除页面 |
