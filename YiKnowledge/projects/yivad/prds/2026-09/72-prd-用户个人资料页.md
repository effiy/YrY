...
> 实现方案见 [开发方案](../../devs/2026-09/72-prd-task-用户个人资料页.md)，验证方案见 [测试方案](../../tests/2026-09/72-prd-test-用户个人资料页.md)。
...
| 编号 | 功能 | 说明 |
|------|------|------|
| FR-1 | 当前用户资料现状 | 参见 §当前用户资料现状 |
| FR-2 | 用户资料数据流 | 参见 §用户资料数据流 |
| FR-3 | 根因矩阵 | 参见 §根因矩阵 |
| FR-4 | 个人资料页数据流 | 参见 §个人资料页数据流 |
| FR-5 | 个人资料页指标 | 参见 §个人资料页指标 |
| FR-6 | 个人资料页核心服务 | 参见 §个人资料页核心服务 |
| FR-7 | 个人资料页主组件 | 参见 §个人资料页主组件 |
| FR-8 | 贡献热力图组件 | 参见 §贡献热力图组件 |
