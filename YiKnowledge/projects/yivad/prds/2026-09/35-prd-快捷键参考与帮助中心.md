...
> 实现方案见 [开发方案](../../devs/2026-09/35-prd-task-快捷键参考与帮助中心.md)，验证方案见 [测试方案](../../tests/2026-09/35-prd-test-快捷键参考与帮助中心.md)。
...
| 编号 | 功能 | 说明 |
|------|------|------|
| FR-1 | 当前帮助体系 | 参见 §当前帮助体系 |
| FR-2 | 用户求助路径分析 | 参见 §用户求助路径分析 |
| FR-3 | 改造前帮助流程 | 参见 §改造前帮助流程 |
| FR-4 | 根因矩阵 | 参见 §根因矩阵 |
| FR-5 | 帮助面板交互流程 | 参见 §帮助面板交互流程 |
| FR-6 | 帮助面板组件 | 参见 §帮助面板组件 |
| FR-7 | 帮助中心面板 | 参见 §帮助中心面板 |
| FR-8 | 上下文感知帮助 | 参见 §上下文感知帮助 |
