...
> 实现方案见 [开发方案](../../devs/2026-09/74-prd-task-用户外观设置.md)，验证方案见 [测试方案](../../tests/2026-09/74-prd-test-用户外观设置.md)。
...
| 编号 | 功能 | 说明 |
|------|------|------|
| FR-1 | 当前外观设置现状 | 参见 §当前外观设置现状 |
| FR-2 | 外观设置数据流 | 参见 §外观设置数据流 |
| FR-3 | 根因矩阵 | 参见 §根因矩阵 |
| FR-4 | 外观设置生效流程 | 参见 §外观设置生效流程 |
| FR-5 | 外观设置指标 | 参见 §外观设置指标 |
| FR-6 | 外观设置 Store | 参见 §外观设置 Store |
| FR-7 | 外观设置页面 | 参见 §外观设置页面 |
