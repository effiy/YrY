...
> 实现方案见 [开发方案](../../devs/2026-09/55-prd-task-系统公告管理.md)，验证方案见 [测试方案](../../tests/2026-09/55-prd-test-系统公告管理.md)。
...
| 编号 | 功能 | 说明 |
|------|------|------|
| FR-1 | 当前公告管理现状 | 参见 §当前公告管理现状 |
| FR-2 | 公告类型 | 参见 §公告类型 |
| FR-3 | 根因分析矩阵 | 参见 §根因分析矩阵 |
| FR-4 | 改造前数据流 | 参见 §改造前数据流 |
| FR-5 | 公告生命周期 | 参见 §公告生命周期 |
| FR-6 | 定向规则引擎 | 参见 §定向规则引擎 |
| FR-7 | 核心类型定义 | 参见 §核心类型定义 |
| FR-8 | 核心 Composable | 参见 §核心 Composable |
