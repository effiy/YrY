...
> 实现方案见 [开发方案](../../devs/2026-09/73-prd-task-用户通知设置.md)，验证方案见 [测试方案](../../tests/2026-09/73-prd-test-用户通知设置.md)。
> 依赖：YV-09-27（通知中心）
...
| 编号 | 功能 | 说明 |
|------|------|------|
| FR-1 | 当前通知系统现状 | 参见 §当前通知系统现状 |
| FR-2 | 通知设置数据流 | 参见 §通知设置数据流 |
| FR-3 | 根因矩阵 | 参见 §根因矩阵 |
| FR-4 | 通知发送决策流程 | 参见 §通知发送决策流程 |
| FR-5 | 通知设置指标 | 参见 §通知设置指标 |
| FR-6 | 通知偏好服务 | 参见 §通知偏好服务 |
| FR-7 | 通知设置页主组件 | 参见 §通知设置页主组件 |
