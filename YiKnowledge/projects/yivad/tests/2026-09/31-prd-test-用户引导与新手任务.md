...
| FR | 需求 | 测试覆盖 | 状态 |
|----|------|---------|------|
| FR-1 | 引导类型定义 | UT + CT + IT | ✅ 已完成 |
| FR-2 | 引导 API 服务 | IT | ✅ 已完成 |
| FR-3 | useOnboarding Composable | UT + CT + IT | ✅ 已完成 |
| FR-4 | useTour Composable | UT + CT + IT | ✅ 已完成 |
| FR-5 | OnboardingWizard 引导向导 | UT + CT + IT | ✅ 已完成 |
| FR-6 | WelcomeTour 欢迎导览 | UT + CT + IT | ✅ 已完成 |
| FR-7 | TooltipHighlight 工具提示 | UT + CT | ✅ 已完成 |
| FR-8 | 辅助组件 | CT | ✅ 已完成 |
| FR-9 | v-onboarding 指令 | CT | ✅ 已完成 |
