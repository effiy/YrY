...
title: "YP-09-31: 聊天窗口多标签页同步 — 跨 Tab 会话状态共享 — 开发任务"
status: 已完成
priority: P2
owner: 陈铭
roles: [engineer]
...
# YP-09-31: 聊天窗口多标签页同步 — 跨 Tab 会话状态共享 — 开发任务

> 来源 PRD：[38-架构设计-多标签页同步.md](../../prds/2026-09/38-架构设计-多标签页同步.md)
> 需求编号：YP-09-31 · 优先级：P2 · 人天：0.5d
> 类型：架构 · 状态：已完成
