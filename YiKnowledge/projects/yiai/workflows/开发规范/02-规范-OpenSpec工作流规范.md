...
| 规范 | 文件 | 适用阶段 |
|------|------|----------|
| API 规范 | `specs/api-conventions.md` | Design + Apply |
| 认证规范 | `specs/auth-conventions.md` | Design + Apply |
| 数据库规范 | `specs/database-conventions.md` | Design + Apply |
| 模块结构规范 | `specs/module-structure.md` | Design + Apply |
| Domain Service 模式 | `specs/domain-service.md` | Design + Apply |
