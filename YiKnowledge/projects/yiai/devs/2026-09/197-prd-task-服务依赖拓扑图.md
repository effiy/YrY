...
title: "YA-09-192: 服务依赖拓扑图 — 依赖关系可视化、健康状态传播、依赖健康评分、循环依赖检测、影响分析、拓扑图导出 — 开发任务"
status: 需求已编写
priority: P2
owner: 陈铭
roles: [engineer]
...
# YA-09-192: 服务依赖拓扑图 — 依赖关系可视化、健康状态传播、依赖健康评分、循环依赖检测、影响分析、拓扑图导出 — 开发任务

> 来源 PRD：[197-需求-服务依赖拓扑图.md](../../prds/2026-09/197-需求-服务依赖拓扑图.md)
> 需求编号：YA-09-192 · 优先级：P2 · 人天：0.3d
> 类型：基础设施 · 状态：需求已编写
