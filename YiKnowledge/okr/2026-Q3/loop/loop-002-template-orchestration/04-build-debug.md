...
| `YiKnowledge/okr/2026-Q3/loop/_templates/03-code-review.md` | 新增 | 代码审查模板（5 维度：架构/类型/安全/性能/可维护） |
| `YiKnowledge/okr/2026-Q3/loop/_templates/06-deployment.md` | 新增 | 部署记录模板（部署步骤 + 验证 + 回滚预案） |
| `YiKnowledge/okr/2026-Q3/loop/_templates/08-retrospective.md` | 新增 | 复盘总结模板（Keep/Improve/行动项） |
| `YiKnowledge/okr/2026-Q3/loop/INDEX.md` | 修改 | 更新为 8 阶段目录结构 + frontmatter 规范 |
