...
created: '2026-08-29'
source: https://danluu.com/tracing-analytics/
type: rss
source_name: Dan Luu
source_url: https://danluu.com/atom.xml
published: Sun, 31 May 2020 00:06:34 -0700
---
...
<p><img alt="Diagram of RPC call graph; this will implicitly described in the relevant sections, although the entire SDE section in showing off a visual tool and will probably be unsatisfying if you're just reading the alt text; the tables described in the previous section are more likely to be what you want if you want a non-visual interpretation of the data, the SDE is a kind of visualization" height="488" src="https://danluu.com/images/tracing-analytics/rpc-tree.webp" width="610" /></p>

<p>If we look at SDE from the standpoint of node E, we'll see the following:
<img alt="SDE centered on service E, showing callers and callees, direct and indirect" height="576" src="https://danluu.com/images/tracing-analytics/e.webp" width="1266" /></p>
...
<p><img alt="SDE centered on service E, with callee C highlighted" height="239" src="https://danluu.com/images/tracing-analytics/e.webp" width="1263" /></p>
...
<p><img alt="SDE centered on service D, with different calls to D expanded by having clicked on D" height="364" src="https://danluu.com/images/tracing-analytics/d.webp" width="1262" /></p>
...
<p><img alt="SDE centered on service D, with call4 of D highlighted by clicking on call 4; shows only upstream and downstream load that are relevant to call4" height="343" src="https://danluu.com/images/tracing-analytics/d-4.webp" width="1263" /></p>
