...
roles:
- executiver
benefit: "Executives find market intelligence, competitor analysis, and industry reports organized by subdomain for evidence-based strategic decisions"
acceptance_criteria:
...
| [use-cases/](../../producter/strategy) | AI customer service / after-sales / RAG+Agent landing case studies, case study templates |
...
- [../../engineer/run/understand-competitors.md](../../engineer/run/understand-competitors.md) — Scenario entry: competitors and industry
- [../../aier/ml/find-ai-deployment-cases.md](../../aier/ml/find-ai-deployment-cases.md) — Scenario entry: AI landing case studies
- [../../curator/diagrams/knowledge-map.md](../../curator/diagrams/knowledge-map.md) — Knowledge map
