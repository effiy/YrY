...
| 产物 | 路径 | 说明 |
|---|---|---|
| 代码审查模板 | `loop/_templates/03-编排-code-review.md` | 5 维度审查模板 |
| 部署记录模板 | `loop/_templates/06-编排-deployment.md` | 部署步骤 + 验证 + 回滚 |
| 复盘总结模板 | `loop/_templates/08-编排-retrospective.md` | Keep/Improve/行动项 |
