...
| 阶段 | 记录 | 产出角色 | 关键产物 |
|---|---|---|---|
| 需求评审 | [01-编排-requirement-review.md](./01-编排-requirement-review.md) | producter | PRD + 6 验收标准（AC1~AC6）+ WSJF |
...
| 测试报告 | [05-编排-test-report.md](./05-编排-test-report.md) | srer | typecheck/build 门禁 + 数据契约 + 手动验证 |
| 部署 | [06-编排-deployment.md](./06-编排-deployment.md) | srer | 5 步部署流水线 + 5 项验证 + 回滚预案 |
| 上线记录 | [07-编排-launch-record.md](./07-编排-launch-record.md) | srer | artifact/version/env + 审批 |
| 复盘总结 | [08-编排-retrospective.md](./08-编排-retrospective.md) | executiver | 5 Keep + 4 Improve + 5 行动项 |
