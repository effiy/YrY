...
| [governance/](./governance/) ([README](./governance/README.md)) | KB 生命周期、inbox/triage、准备清单、隐性知识 backlog——9 个文件 |
| [diagrams/](./diagrams/) ([README](./diagrams/README.md)) | 4 张规范图：knowledge-map、user-journey、directory-blueprint、dashboard-index——4 个文件 |
| [templates/](./templates/) ([README](./templates/README.md)) | 可复用模板：知识叶子、ADR、PRD、技术设计、会议等——15 个文件 |
...
- **4 张图**：[knowledge map](./diagrams/03-图表-知识地图.md)、[user-journey](./diagrams/04-图表-用户旅程.md)、[directory blueprint](./diagrams/02-图表-目录蓝图.md)、[governance flow](./governance/governance.md)
- **模板**：[knowledge leaf](./templates/02-模板-知识叶子模板.md)、[ADR](./templates/adr-template.md)、[PRD](./templates/05-模板-PRD模板.md)、[tech design](./templates/07-模板-技术设计模板.md) 等
- **Archive 管理**：通过 [archive.md](./archive/01-归档-归档说明.md) 跟踪和清理已废弃文件
- **横切领域索引**：[SECURITY](../engineer/SECURITY.md)、[COLLABORATION](./COLLABORATION.md)、[ENGINEERING](../engineer/ENGINEERING.md)
- **运营节奏**：周/月/季度/年度审查（参见 [governance.md](./governance/governance.md)）
...
| KB 审查流程 | [curator/治理/](./governance/) | KB 运营 |
| 代码审查流程 | [engineer/ship/](../engineer/ship/) | 领域内容 |
| Frontmatter 规范 | [curator/治理/](./governance/) | KB 标准 |
...
| KB 文件废弃策略 | [curator/治理/](./governance/) | KB 生命周期 |
...
- **质量**（类似 [engineer/ship/](../engineer/ship/)）——frontmatter 校验、[准备清单](./governance/readiness-checklist.md)
...
- 4 张图各自独立文件：[knowledge-map](./diagrams/03-图表-知识地图.md) / [user-journey](./diagrams/04-图表-用户旅程.md) / [directory-blueprint](./diagrams/02-图表-目录蓝图.md) / [governance](./governance/governance.md)
- 同时服务于人类和 YiAi Agent：frontmatter 的 `lifecycle`/`related`/`tacit`/`tags`/`category` 是跨目录 RAG 召回的关键信号
...
1. 阅读 [governance flow](./governance/governance.md)——理解 4 角色、3 节奏模型
2. 审查 [4 张图](./diagrams/)——建立 KB 拓扑的思维模型
3. 运行 [准备清单](./governance/readiness-checklist.md)——任何 KB 变更前的 10 题门禁
4. 检查 [inbox.md](./governance/inbox.md) 和 [triage.md](./governance/triage.md)——处理 incoming 内容
5. 创建新文件时使用 [templates/](./templates/)——从 [knowledge-leaf.md](./templates/02-模板-知识叶子模板.md) 开始
...
| 状态 | 含义 | 典型文件 | 管理位置 |
|---|---|---|---|
| `inbox` | 刚捕获的原始来源，未分类未精炼 | 原始捕获、链接、笔记 | [inbox.md](./governance/inbox.md) |
| `triage` | 已分类到正确叶子，待总结 | 已分类但未总结 | [triage.md](./governance/triage.md) |
| `active` | 已总结并引用 | 大多数 `*-summary.md` | 角色目录 |
| `reference` | 稳定的方法/模板，很少变更 | `*-template.md`、方法论文件 | [templates/](./templates/) |
| `archive` | 已废弃或被取代 | 旧版本、过时内容 | [archive.md](./archive/01-归档-归档说明.md) |

### 4 张图实践

| 图 | 文件 | 回答的问题 | 子 README |
|---|---|---|---|
| 知识地图 | [knowledge-map.md](./diagrams/03-图表-知识地图.md) | 存在哪些知识？显性 vs 隐性？ | [diagrams/](./diagrams/) |
| 用户旅程图 | [user-journey.md](./diagrams/04-图表-用户旅程.md) | 知识在哪里？断点在哪里？ | [diagrams/](./diagrams/) |
| 目录蓝图 | [directory-blueprint.md](./diagrams/02-图表-目录蓝图.md) | 用户如何一目了然地找到东西？ | [diagrams/](./diagrams/) |
| 治理流程 | [governance.md](./governance/governance.md) | 谁维护？多久一次？4 角色、3 节奏 | [governance/](./governance/) |

### 总入口和场景入口

| 入口 | 用途 |
|---|---|
| [inbox.md](./governance/inbox.md) | 总入口——原始捕获的知识中转站 |
| [triage.md](./governance/triage.md) | 待精炼队列——已分类但尚未总结 |
| [archive.md](./archive/01-归档-归档说明.md) | 归档索引——已废弃文件登记表 |

## 运营节奏

| 节奏 | 操作 | 治理依据 |
|---|---|---|
| **每周** | 处理 inbox → triage，分类新内容 | [governance.md](./governance/governance.md) |
| **每月** | 审查 [review-log.md](./governance/review-log.md)，检查新鲜度标签 | [governance.md](./governance/governance.md) |
| **每季度** | 扫描 4 张图是否过时，审查 [tacit-knowledge-backlog.md](./governance/tacit-knowledge-backlog.md) | [governance.md](./governance/governance.md) |
| **每年** | 扫描 [archive.md](./archive/01-归档-归档说明.md) 进行物理清理，全面 KB 审计 | [governance.md](./governance/governance.md) |
...
| 模板 | 消费者 |
|---|---|
| [knowledge-leaf.md](./templates/02-模板-知识叶子模板.md) | [write-a-prd.md](../producter/discovery/write-a-prd.md)、[design-architecture-decision.md](../leader/架构/design-architecture-decision.md)、[implement-an-api.md](../engineer/build/implement-an-api.md) |
| [adr-template.md](./templates/adr-template.md) | [design-architecture-decision.md](../leader/架构/design-architecture-decision.md) |
| [prd.md](./templates/05-模板-PRD模板.md) | [producter/discovery/prd/](../producter/discovery/prd/) |
| [.md](./templates.md) | [executiver/strategy/](../executiver/strategy/) |
| [tech-design.md](./templates/07-模板-技术设计模板.md) | [engineer/build/](../engineer/build/) |
...
| [readiness-checklist.md](./governance/readiness-checklist.md) | 所有新 KB 内容的上线前门禁 |
| [review-log.md](./governance/review-log.md) | 内容审查跟踪 |
| [tacit-knowledge-backlog.md](./governance/tacit-knowledge-backlog.md) | 隐性知识捕获 |
...
1. 新内容首先进入 [inbox.md](./governance/inbox.md)，frontmatter `lifecycle: inbox`
2. 每周审查时，分类到正确叶子并将 `lifecycle` 改为 `triage`，注册到 [triage.md](./governance/triage.md)
3. 完成总结后，将 `lifecycle` 改为 `active`；原始来源变为 `lifecycle: reference`
4. 季度审查：扫描 4 张图和 [tacit-knowledge-backlog.md](./governance/tacit-knowledge-backlog.md)；年度审查：扫描 [archive.md](./archive/01-归档-归档说明.md) 进行物理清理

## 反模式 / 常见误用

- **将此目录当作主题分类**——后果：与 7 个角色目录重叠，污染目录结构。修复：使用上方的[决策规则](#边界情况决策规则)表。
- **新文件缺少 lifecycle 字段**——后果：AI 召回信号弱，运营无法批量过滤未精炼内容。修复：发布前运行[准备清单](./governance/readiness-checklist.md)。
...
- **跳过 inbox → triage → active 流程**——后果：未分类内容堆积，可发现性降低。修复：每周处理 [inbox.md](./governance/inbox.md)。

## 相关

- **Curator 子 README**：[governance/](./governance/README.md) · [diagrams/](./diagrams/README.md) · [templates/](./templates/README.md) · [archive/](./archive/README.md)
...
- **4 张图**：[knowledge-map.md](./diagrams/03-图表-知识地图.md) · [user-journey.md](./diagrams/04-图表-用户旅程.md) · [directory-blueprint.md](./diagrams/02-图表-目录蓝图.md) · [governance.md](./governance/governance.md)