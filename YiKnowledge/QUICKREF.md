...
| Learn YiAi architecture | [engineer/learn/projects/yiai/架构设计.md](engineer/learn/projects/yiai/01-项目-架构设计.md) |
| Learn YiVad architecture | [engineer/learn/projects/yivad/架构设计.md](engineer/learn/projects/yivad/01-项目-架构设计.md) |
| Learn YiPet architecture | [engineer/learn/projects/yipet/架构设计.md](engineer/learn/projects/yipet/01-项目-架构设计.md) |
...
| I want to... | Go to |
|---|---|
| Choose an LLM | [aier/foundations/大模型基础.md](aier/foundations/大模型基础.md) |
| Understand RAG patterns | [aier/foundations/RAG设计模式.md](aier/foundations/RAG设计模式.md) |
| Choose a vector DB | [aier/platform/向量数据库选择.md](aier/platform/向量数据库选择.md) |
| Choose an embedding model | [aier/platform/嵌入模型选择.md](aier/platform/嵌入模型选择.md) |
| Design an agent | [aier/methods/智能体架构模式.md](aier/methods/智能体架构模式.md) |
| Evaluate an LLM | [aier/methods/大模型评估.md](aier/methods/大模型评估.md) |
| Evaluate an agent | [aier/methods/智能体评估.md](aier/methods/智能体评估.md) |
| Write a prompt | [aier/methods/prompts工程.md](aier/methods/prompts工程.md) |
| Review code with AI | [aier/methods/prompts/代码审查.md](aier/methods/prompts/代码审查.md) |
| Use RAG prompt | [aier/methods/prompts/RAG系统.md](aier/methods/prompts/RAG系统.md) |
| Use agent tool prompt | [aier/methods/prompts/智能体工具调用.md](aier/methods/prompts/智能体工具调用.md) |
| Generate a with AI | [aier/methods/prompts生成.md](aier/methods/prompts生成.md) |
| Apply chain-of-thought | [aier/methods/prompts/思维链.md](aier/methods/prompts/思维链.md) |
| Use traditional ML | [aier/machine-learning/传统机器学习模式.md](aier/machine-learning/传统机器学习模式.md) |
...
| Write a | [curator/templates.md](curator/templates.md) |
