...
> **As an** engineer, **I want to** README, **so that** same mistake avoided.
...
- [../../../knowledge-curator/governance/tacit-knowledge-backlog.md](../../knowledge-curator/governance/tacit-knowledge-backlog.md) — tacit knowledge backlog
