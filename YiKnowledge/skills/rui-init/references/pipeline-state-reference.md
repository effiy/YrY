...
## Verify Checks (4-point)

| # | Check | What it verifies |
|---|-------|-----------------|
| 1 | `claude-md-exists` | `CLAUDE.md` present and non-empty |
| 2 | `readme-exists` | `README.md` present and non-empty |
| 3 | `cross-refs-valid` | All markdown links in CLAUDE.md resolve |
| 4 | `domain-language-preserved` | README.md Domain Language section preserved if pre-existing |
