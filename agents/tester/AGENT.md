...
triggers:
  - rui C1 (test-first: E2E test design + UI prototype)
  - rui C2 (code review per module)
  - rui C3 (full code review + smoke test)
  - rui D4 (markdown QA + mermaid review + doc review + quality tracking)
