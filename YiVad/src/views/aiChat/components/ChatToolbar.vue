    ...
    <div class="ct-right">
      ...
      <div class="ct-pills-group">
        ...
        <AgentSettingsControls
          ...
          :agent-system-prompt="props.agentSystemPrompt"
          :agent-model-rotation="props.agentModelRotation"
          :agent-model-fallback="props.agentModelFallback"
          @toggle-agent="emit('toggle-agent')"
          @update-agent-system-prompt="emit('update-agent-system-prompt', $event)"
