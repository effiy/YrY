...
export const QUICK_BUTTONS: QuickButton[] = [
  {
    ...
    content: "Tech roadmap review: this quarter's investment distribution and milestone alignment across platform, middleware, and business domains",
  ...
  },
  {
    ...
    content: "Engineering productivity metrics: lead time, change failure rate, MTTR, and per-capita throughput trends with attribution",
    value: "dora_metrics",
  },
  {
...
export const QUICK_BUTTONS_NEW: QuickButton[] = [
  ...
  },
  {
    ...
    content: "Capacity and cost: resource utilization, scaling thresholds, per-request cost, and quarterly FinOps optimization items",
    value: "capacity_cost",
  },
];
