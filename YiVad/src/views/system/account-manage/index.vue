...
const handleDelete = async (row: UserDocument) => {
  try {
    await ElMessageBox.confirm(t("common.deleteConfirm", { name: row.username }), t("common.deleteTitle"), { type: "warning" });
...
const batchDelete = async (ids: string[]) => {
  try {
    await ElMessageBox.confirm(t("common.batchDeleteConfirm", { count: ids.length }), t("common.batchDeleteTitle"), {
      type: "warning"
    });
