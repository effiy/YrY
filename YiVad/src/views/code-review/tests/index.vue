<script setup lang="ts" name="crTestsList">
import { ref } from "vue";
...
<template>
  <TopicListPage tree="code-review" topic="tests" label="Generate tests" :meta-columns="schema.metaColumns" @meta-click="onMetaClick" />
  <el-drawer
    v-model="drawerOpen"
