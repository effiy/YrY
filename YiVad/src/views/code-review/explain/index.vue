<script setup lang="ts" name="crExplainList">
import { ref } from "vue";
...
const schema = crMetaSchemas["explain"];
...
<template>
  <TopicListPage tree="code-review" topic="explain" label="Explain the logic" :meta-columns="schema.metaColumns" @meta-click="onMetaClick" />
  <el-drawer
    v-model="drawerOpen"
