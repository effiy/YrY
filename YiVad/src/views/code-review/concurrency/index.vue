<script setup lang="ts" name="crConcurrencyList">
import { ref } from "vue";
...
const schema = crMetaSchemas["concurrency"];
...
<template>
  <TopicListPage tree="code-review" topic="concurrency" label="Concurrency review" :meta-columns="schema.metaColumns" @meta-click="onMetaClick" />
  <el-drawer
    v-model="drawerOpen"
