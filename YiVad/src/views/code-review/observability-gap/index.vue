<script setup lang="ts" name="crObservabilityGapList">
import { ref } from "vue";
...
const schema = crMetaSchemas["observability-gap"];
...
<template>
  <TopicListPage tree="code-review" topic="observability-gap" label="Observability gap" :meta-columns="schema.metaColumns" @meta-click="onMetaClick" />
  <el-drawer
    v-model="drawerOpen"
  ...
  >
    <RelatedByProjectPanel
      ...
      current-tree="cr"
      current-topic="observability-gap"
