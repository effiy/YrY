<script setup lang="ts" name="crRefactorList">
import { ref } from "vue";
...
const schema = crMetaSchemas["refactor"];
...
<template>
  <TopicListPage tree="code-review" topic="refactor" label="Refactor suggestions" :meta-columns="schema.metaColumns" @meta-click="onMetaClick" />
  <el-drawer
    v-model="drawerOpen"
