...
const schema = crMetaSchemas["error-handling"];
...
<template>
  <TopicListPage tree="code-review" topic="error-handling" label="Error handling review" :meta-columns="schema.metaColumns" @meta-click="onMetaClick" />
  <el-drawer
    v-model="drawerOpen"
