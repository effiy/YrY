<script setup lang="ts" name="crPerfList">
import { ref } from "vue";
...
<template>
  <TopicListPage tree="code-review" topic="perf" label="Performance analysis" :meta-columns="schema.metaColumns" @meta-click="onMetaClick" />
  <el-drawer
    v-model="drawerOpen"
