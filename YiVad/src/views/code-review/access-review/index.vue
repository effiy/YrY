<script setup lang="ts" name="crAccessReviewList">
import { ref } from "vue";
...
const schema = crMetaSchemas["access-review"];
...
<template>
  <TopicListPage tree="code-review" topic="access-review" label="Access review" :meta-columns="schema.metaColumns" @meta-click="onMetaClick" />
  <el-drawer
    v-model="drawerOpen"
