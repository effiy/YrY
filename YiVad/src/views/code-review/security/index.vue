<script setup lang="ts" name="crSecurityList">
import { ref } from "vue";
...
<template>
  <TopicListPage tree="code-review" topic="security" label="Security review" :meta-columns="schema.metaColumns" @meta-click="onMetaClick" />
  <el-drawer
    v-model="drawerOpen"
