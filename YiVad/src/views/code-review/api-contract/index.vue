<script setup lang="ts" name="crApiContractList">
import { ref } from "vue";
...
const schema = crMetaSchemas["api-contract"];
...
<template>
  <TopicListPage tree="code-review" topic="api-contract" label="API contract check" :meta-columns="schema.metaColumns" @meta-click="onMetaClick" />
  <el-drawer
    v-model="drawerOpen"
