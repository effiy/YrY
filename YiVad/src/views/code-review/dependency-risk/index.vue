<script setup lang="ts" name="crDependencyRiskList">
import { ref } from "vue";
...
const schema = crMetaSchemas["dependency-risk"];
...
<template>
  <TopicListPage tree="code-review" topic="dependency-risk" label="Dependency risk" :meta-columns="schema.metaColumns" @meta-click="onMetaClick" />
  <el-drawer
    v-model="drawerOpen"
