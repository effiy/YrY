<script setup lang="ts" name="crStyleList">
import { ref } from "vue";
...
<template>
  <TopicListPage tree="code-review" topic="style" label="Naming & style" :meta-columns="schema.metaColumns" @meta-click="onMetaClick" />
  <el-drawer
    v-model="drawerOpen"
