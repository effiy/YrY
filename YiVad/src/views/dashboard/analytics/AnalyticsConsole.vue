  ...
  <div class="analytics-console">
    <header class="analytics-console__header">
      ...
      <div class="analytics-console__actions">
        ...
        <el-button :icon="Download" size="small" @click="$router.push('/export/wizard')">Export</el-button>
      </div>
    </header>
...
const quickLinks = [
  { label: "Efficiency Dashboard", path: "/dashboard/analytics/efficiency", icon: DataAnalysis },
  { label: "Quality Trends", path: "/dashboard/analytics/quality", icon: TrendCharts },
  { label: "System Health", path: "/dashboard/analytics/console", icon: Monitor }
];
