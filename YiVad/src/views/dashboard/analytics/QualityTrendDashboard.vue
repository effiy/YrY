  ...
  <div class="quality-page">
    ...
    <el-row :gutter="16">
      <el-col :span="6" class="mb16">
        <KpiCard label="Quality Score" :value="metrics.quality_score" trend-direction="up" format="number" />
      </el-col>
      <el-col :span="6" class="mb16">
        <KpiCard
          label="Bug Rate"
          ...
          unit="%"
          format="percent"
          :trend-direction="metrics.bug_rate > 10 ? 'up' : 'down'"
        />
      </el-col>
      <el-col :span="6" class="mb16">
        <KpiCard
          ...
          unit="%"
          format="percent"
          :trend-direction="metrics.rework_rate > 15 ? 'up' : 'down'"
        />
      </el-col>
      <el-col :span="6" class="mb16">
...
const metrics = ref({
  ...
  rework_rate: 0,
  bug_count: 0,
  defect_density: [] as { module: string; bugs: number }[]
});
