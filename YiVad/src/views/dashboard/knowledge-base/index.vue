  ...
  <div class="knowledge-base-box" v-loading="loading">
    ...
    <div class="card top-box">
      ...
      <el-row :gutter="12">
        <el-col class="mb12" :xs="12" :sm="12" :md="6" :lg="6" :xl="6">
          <div
            ...
            :class="{ 'stat-pulse': pulsingCard === 'total' }"
            @click="
              pulseCard('total');
              clearAllFilters();
            "
          >
            ...
            <div class="stat-info">
              <div class="stat-value">
                {{ formatNumber(statDeltas ? statDeltas.total.filtered : (knowledgeData?.total ?? 0)) }}
              </div>
              <div class="stat-label">Total Files</div>
              <div class="stat-delta" v-if="statDeltas">
                {{ formatNumber(statDeltas.total.baseline) }} → {{ formatNumber(statDeltas.total.filtered) }}
              </div>
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="12" :sm="12" :md="6" :lg="6" :xl="6">
          <div
            class="stat-card stat-categories"
            :class="{ 'stat-pulse': pulsingCard === 'categories' }"
            @click="
              pulseCard('categories');
              scrollToDrillDown();
            "
          >
            <div class="stat-icon">
            ...
            <div class="stat-info">
              <div class="stat-value">
                {{ statDeltas ? statDeltas.categories.filtered : (knowledgeData?.categories.length ?? 0) }}
              </div>
              <div class="stat-label">
                Categories <span class="stat-sub">({{ topCategory }})</span>
              </div>
              <div class="stat-delta" v-if="statDeltas">
                {{ statDeltas.categories.baseline }} → {{ statDeltas.categories.filtered }}
              </div>
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="12" :sm="12" :md="6" :lg="6" :xl="6">
          <div
            class="stat-card stat-modules"
            :class="{ 'stat-pulse': pulsingCard === 'modules' }"
            @click="
              pulseCard('modules');
              scrollToDrillDown();
            "
          >
            ...
            <div class="stat-info">
              ...
              <div class="stat-label">
                Modules <span class="stat-sub">(top role: {{ topRole }})</span>
              </div>
              <div class="stat-delta" v-if="statDeltas">
                {{ statDeltas.modules.baseline }} → {{ statDeltas.modules.filtered }}
              </div>
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="12" :sm="12" :md="6" :lg="6" :xl="6">
          <div
            ...
            :class="{ 'stat-pulse': pulsingCard === 'recent' }"
            @click="
              pulseCard('recent');
          ...
          >
            ...
            <div class="stat-info">
              ...
              <div class="stat-label">
                Active This Week <span class="stat-sub">({{ recentWeekPct }}%)</span>
              </div>
            </div>
          </div>
        </el-col>
      ...
      <el-row :gutter="12">
        <el-col class="mb12" :xs="12" :sm="12" :md="6" :lg="6" :xl="6">
          <div
            class="stat-card stat-coverage"
            :class="{ 'stat-pulse': pulsingCard === 'coverage' }"
            @click="
              pulseCard('coverage');
          ...
          >
            ...
            <div class="stat-info">
              ...
              <div class="stat-label">
                Review Coverage <span class="stat-sub">({{ clientMissingStats.no_review_cycle }} missing)</span>
              </div>
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="12" :sm="12" :md="6" :lg="6" :xl="6">
          <div
            class="stat-card"
            :class="{
              'stat-healthy': dataQualityScore >= 80,
              'stat-warn': dataQualityScore >= 50 && dataQualityScore < 80,
              'stat-stale': dataQualityScore < 50,
              'stat-pulse': pulsingCard === 'quality'
            }"
            @click="
              pulseCard('quality');
              setQualityFilter('status');
            "
          >
            <div class="stat-icon">
            ...
            <div class="stat-info">
              ...
              <div class="stat-label">
                Data Quality <span class="stat-sub">({{ missingMetadataCount }} incomplete)</span>
              </div>
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="12" :sm="12" :md="6" :lg="6" :xl="6">
          <div
            class="stat-card stat-tacit"
            :class="{ 'stat-pulse': pulsingCard === 'tacit' }"
            @click="
              pulseCard('tacit');
              setFilter('tacit', 'true');
            "
          >
            <div class="stat-icon">
            ...
            <div class="stat-info">
              ...
              <div class="stat-label">
                Tacit <span class="stat-sub">({{ tacitPct }}%)</span>
              </div>
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="12" :sm="12" :md="6" :lg="6" :xl="6">
          <div
            class="stat-card"
            :class="{
              'stat-stale': (knowledgeData?.health.stale_count ?? 0) > 0,
              'stat-healthy': (knowledgeData?.health.stale_count ?? 0) === 0,
              'stat-pulse': pulsingCard === 'stale'
            }"
            @click="
              pulseCard('stale');
              setFilter('stale', 'true');
            "
          >
            <div class="stat-icon">
            ...
            <div class="stat-info">
              <div class="stat-value">
                {{ statDeltas ? statDeltas.stale.filtered : (knowledgeData?.health.stale_count ?? 0) }}
              </div>
              <div class="stat-label">
                Stale <span class="stat-sub">({{ stalePct }}%)</span>
              </div>
        ...
        <el-col class="mb12" :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
          <div class="chart-box" :class="{ 'chart-highlight': isDimensionFiltered('review_cycle') }">
            <div class="chart-title">
              Review Cycle <span class="chart-count-badge" v-if="chartContextFiles">({{ chartContextFiles.length }})</span>
            </div>
            <div class="chart-body">
              <ECharts :option="reviewCycleDonutOption" height="220" @chart-click="onChartClick('review_cycle', $event)" />
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
          <div class="chart-box" :class="{ 'chart-highlight': isDimensionFiltered('status') }">
            <div class="chart-title">
              Status <span class="chart-count-badge" v-if="chartContextFiles">({{ chartContextFiles.length }})</span>
            </div>
            <div class="chart-body">
              <ECharts :option="statusBarOption" height="220" @chart-click="onChartClick('status', $event)" />
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
          <div class="chart-box" :class="{ 'chart-highlight': isDimensionFiltered('type') }">
            <div class="chart-title">
              Type <span class="chart-count-badge" v-if="chartContextFiles">({{ chartContextFiles.length }})</span>
            </div>
            <div class="chart-body">
              <ECharts :option="typeBarOption" height="220" @chart-click="onChartClick('type', $event)" />
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
          <div class="chart-box" :class="{ 'chart-highlight': isDimensionFiltered('lifecycle') }">
            <div class="chart-title">
              Lifecycle <span class="chart-count-badge" v-if="chartContextFiles">({{ chartContextFiles.length }})</span>
            </div>
            <div class="chart-body">
              <ECharts :option="lifecycleBarOption" height="220" @chart-click="onChartClick('lifecycle', $event)" />
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
          <div class="chart-box" :class="{ 'chart-highlight': isDimensionFiltered('module') }">
            <div class="chart-title">
              Top Modules <span class="chart-count-badge" v-if="chartContextFiles">({{ chartContextFiles.length }})</span>
            </div>
            <div class="chart-body">
              <ECharts :option="moduleBarOption" height="220" @chart-click="onChartClick('module', $event)" />
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
          <div class="chart-box" :class="{ 'chart-highlight': isDimensionFiltered('roles') }">
            <div class="chart-title">
              Roles <span class="chart-count-badge" v-if="chartContextFiles">({{ chartContextFiles.length }})</span>
            </div>
            <div class="chart-body">
              <ECharts :option="rolesBarOption" height="220" @chart-click="onChartClick('role', $event)" />
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
          <div class="chart-box" :class="{ 'chart-highlight': isDimensionFiltered('size') }">
            <div class="chart-title">
              File Size <span class="chart-count-badge" v-if="chartContextFiles">({{ chartContextFiles.length }})</span>
            </div>
            <div class="chart-body">
              <ECharts :option="sizeDistOption" height="220" @chart-click="onChartClick('size', $event)" />
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
          <div class="chart-box" :class="{ 'chart-highlight': isDimensionFiltered('age') }">
            <div class="chart-title">
              File Age <span class="chart-count-badge" v-if="chartContextFiles">({{ chartContextFiles.length }})</span>
            </div>
            <div class="chart-body">
              <ECharts :option="fileAgeOption" height="220" @chart-click="onChartClick('age', $event)" />
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
          <div class="chart-box" :class="{ 'chart-highlight': isDimensionFiltered('category') }">
            <div class="chart-title">
              Category <span class="chart-count-badge" v-if="chartContextFiles">({{ chartContextFiles.length }})</span>
            </div>
            <div class="chart-body">
              <ECharts :option="categoryBarOption" height="220" @chart-click="onChartClick('category', $event)" />
            </div>
          </div>
        </el-col>
        <el-col class="mb12" :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
          <div class="chart-box" :class="{ 'chart-highlight': isDimensionFiltered('tags') }">
            <div class="chart-title">
              Tags <span class="chart-count-badge" v-if="chartContextFiles">({{ chartContextFiles.length }})</span>
            </div>
            <div class="chart-body">
              <ECharts :option="tagsBarOption" height="220" @chart-click="onChartClick('tag', $event)" />
            </div>
          </div>
        </el-col>
      </el-row>
    ...
    <div class="card quality-box">
      ...
      <el-row :gutter="12">
        <el-col class="mb12" :xs="12" :sm="8" :md="4" :lg="4" :xl="4">
          <div class="quality-mini-card" :class="qualityCardClass(statusCompletenessPct)" @click="setQualityFilter('status')">
            ...
            <div class="qmc-bar">
              <div
                class="qmc-bar-fill"
                :style="{ width: statusCompletenessPct + '%', background: dataQualityColor(statusCompletenessPct) }"
              ></div>
            </div>
        ...
        <el-col class="mb12" :xs="12" :sm="8" :md="4" :lg="4" :xl="4">
          <div class="quality-mini-card" :class="qualityCardClass(typeCompletenessPct)" @click="setQualityFilter('type')">
            ...
            <div class="qmc-bar">
              <div
                class="qmc-bar-fill"
                :style="{ width: typeCompletenessPct + '%', background: dataQualityColor(typeCompletenessPct) }"
              ></div>
            </div>
        ...
        <el-col class="mb12" :xs="12" :sm="8" :md="4" :lg="4" :xl="4">
          <div
            ...
            :class="qualityCardClass(lifecycleCompletenessPct)"
            @click="setQualityFilter('lifecycle')"
          >
            <div class="qmc-pct" :style="{ color: dataQualityColor(lifecycleCompletenessPct) }">
              {{ lifecycleCompletenessPct }}%
            </div>
            <div class="qmc-bar">
              <div
                class="qmc-bar-fill"
                :style="{ width: lifecycleCompletenessPct + '%', background: dataQualityColor(lifecycleCompletenessPct) }"
              ></div>
            </div>
        ...
        <el-col class="mb12" :xs="12" :sm="8" :md="4" :lg="4" :xl="4">
          <div
            class="quality-mini-card"
            :class="qualityCardClass(reviewCycleCompletenessPct)"
            @click="setQualityFilter('review_cycle')"
          >
            <div class="qmc-pct" :style="{ color: dataQualityColor(reviewCycleCompletenessPct) }">
              {{ reviewCycleCompletenessPct }}%
            </div>
            <div class="qmc-bar">
              <div
                class="qmc-bar-fill"
                :style="{ width: reviewCycleCompletenessPct + '%', background: dataQualityColor(reviewCycleCompletenessPct) }"
              ></div>
            </div>
        ...
        <el-col class="mb12" :xs="12" :sm="8" :md="4" :lg="4" :xl="4">
          <div class="quality-mini-card" :class="qualityCardClass(rolesCompletenessPct)" @click="setQualityFilter('roles')">
            ...
            <div class="qmc-bar">
              <div
                class="qmc-bar-fill"
                :style="{ width: rolesCompletenessPct + '%', background: dataQualityColor(rolesCompletenessPct) }"
              ></div>
            </div>
        ...
        <el-col class="mb12" :xs="12" :sm="8" :md="4" :lg="4" :xl="4">
          <div class="quality-mini-card" :class="qualityCardClass(tagsCompletenessPct)" @click="setQualityFilter('tags')">
            ...
            <div class="qmc-bar">
              <div
                class="qmc-bar-fill"
                :style="{ width: tagsCompletenessPct + '%', background: dataQualityColor(tagsCompletenessPct) }"
              ></div>
            </div>
      ...
      <div class="quality-by-cat" v-if="worstCategories.length > 0">
        <div class="qbc-header">
          ...
          <span class="qbc-hint"
            >{{ worstCategories.length }} categor{{ worstCategories.length === 1 ? "y" : "ies" }} below 80% quality</span
          >
        </div>
        <div class="qbc-list">
          <div v-for="cat in worstCategories" :key="cat.name" class="qbc-item" @click="setFilter('category', cat.name)">
    ...
    <div class="card attention-box" v-if="needsAttentionFiles.length > 0">
      <div class="top-header">
        ...
        <div class="top-actions">
          ...
          <el-button size="small" type="warning" text @click="showAllAttentionFiles()"
            >View all {{ needsAttentionFiles.length }} files &rarr;</el-button
          >
        </div>
      </div>
      <template v-if="showAttentionDetail">
        ...
        <div class="attention-group" v-if="hasUnknownItems">
          ...
          <div class="attention-grid">
            <div
              class="attn-item attn-item-unknown"
              v-if="clientMissingStats.unknown_status > 0"
              @click="setFilter('status', 'unknown')"
            >
            ...
            <div
              class="attn-item attn-item-unknown"
              v-if="clientMissingStats.unknown_type > 0"
              @click="setFilter('type', 'unknown')"
            >
              <el-icon><QuestionFilled /></el-icon>
            ...
            <div
              class="attn-item attn-item-unknown"
              v-if="clientMissingStats.unknown_lifecycle > 0"
              @click="setFilter('lifecycle', 'unknown')"
            >
              <el-icon><QuestionFilled /></el-icon>
    ...
    <div class="card collapsible-panels">
      <div class="top-header">
        ...
        <div class="top-actions">
          ...
          <el-button
            text
            size="small"
            @click="showCategoryComparison = !showCategoryComparison"
            :type="showCategoryComparison ? 'primary' : ''"
          >
            Compare Categories
          </el-button>
          ...
          <el-button
            text
            size="small"
            @click="showReviewCompliance = !showReviewCompliance"
            :type="showReviewCompliance ? 'primary' : ''"
          >
            Review Compliance
          </el-button>
          <el-button
            ...
            :type="showKnowledgeGraph ? 'primary' : ''"
          >
            Knowledge Graph
          </el-button>
        </div>
      ...
      <StaleRiskTimeline
        ...
        @filter-files="
          (files: any) => {
            clearAllFilters();
            files.forEach((f: any) => setFilter('stale', 'true'));
          }
        "
      />
      ...
      <CoverageGaps
        ...
        @drill-gap="
          (cat: string, mod: string, field: string) => {
            setFilter('category', cat);
            setFilter('module', mod);
            setQualityFilter(field);
          }
        "
      />
        ...
        <div class="card drill-down-box" ref="drillDownRef" :class="{ 'drill-highlight-flash': drillHighlight }">
            ...
            <div class="panel-actions" v-if="!viewAttentionFiles">
              <div class="search-wrapper">
                ...
                <div
                  ...
                  v-if="showSearchSuggestions && searchSuggestions.length > 0 && searchMode === 'title'"
                >
          ...
          <div class="module-classification-view" v-if="viewMode === 'modules' && searchMode === 'title' && !searchText">
            <div class="mcv-header">
              <span class="mcv-title"
                >Module Classification ({{ totalModules }} modules, {{ knowledgeData?.total ?? 0 }} files)</span
              >
              <div class="mcv-header-actions">
                <el-input
                  v-model="moduleDrillSearch"
                  size="small"
            ...
            >
                  ...
                  <div class="mcv-expand-inner">
                    <div class="mcv-expand-summary">
                      <template v-if="getModuleClassSummary(m.files).roles.length">
                        ...
                        <span
                          v-for="r in getModuleClassSummary(m.files).roles"
                          :key="r.name"
                          class="mcv-chip role-badge"
                          @click="setFilter('role', r.name)"
                          >{{ r.name }} {{ r.count }}</span
                        >
                      </template>
                    </div>
                    <el-table :data="m.files.slice(0, m.filePage || 30)" size="small" class="mcv-files-table">
                      <el-table-column label="File" min-width="180" show-overflow-tooltip>
                        <template #default="{ row: f }">
                          <span class="mcv-file-link" @click="openFileInDialog(f as KnowledgeFileSummary)" :title="f.path">{{
                      ...
                      <el-table-column label="Sub" width="100" show-overflow-tooltip>
                        <template #default="{ row: f }">
                          <span
                            v-if="f.sub_module !== '__root__' && f.sub_module"
                            class="mcv-sub-link"
                            @click="drillFromModule(m.category, m.name, f.sub_module)"
                            >{{ f.sub_module }}</span
                          >
                      ...
                      <el-table-column label="Type" width="110">
                        <template #default="{ row: f }">
                          <span class="type-badge" :class="'type-' + (f.type || 'unknown')" @click="setFilter('type', f.type)">{{
                            f.type || "--"
                          }}</span>
                        </template>
                      </el-table-column>
                      <el-table-column label="Status" width="90">
                        <template #default="{ row: f }">
                          <span
                            v-if="f.status"
                            class="mcv-status-tag-dynamic"
                            :style="{ '--bg': statusColor(f.status) }"
                            @click="setFilter('status', f.status)"
                            >{{ f.status }}</span
                          >
                          <span v-else class="text-muted">--</span>
                        </template>
                      ...
                      <el-table-column label="Lifecycle" width="100">
                        <template #default="{ row: f }">
                          <span
                            v-if="f.lifecycle && f.lifecycle !== 'unknown'"
                            class="mcv-lifecycle-tag-dynamic"
                            :style="{ '--bg': lifecycleColor(f.lifecycle) }"
                            @click="setFilter('lifecycle', f.lifecycle)"
                            >{{ f.lifecycle }}</span
                          >
                          <span v-else class="text-muted">--</span>
                        </template>
                      ...
                      <el-table-column label="Review" width="100">
                        <template #default="{ row: f }">
                          <span
                            v-if="f.review_cycle"
                            class="mcv-review-link"
                            @click="setFilter('review_cycle', f.review_cycle)"
                            >{{ f.review_cycle }}</span
                          >
                          <span v-else class="text-muted">--</span>
                        </template>
                      ...
                      <el-table-column label="Roles" width="130">
                        <template #default="{ row: f }">
                          <span v-if="(f.roles || []).length" class="role-badges-row">
                            <span
                              v-for="r in (f.roles || []).slice(0, 3)"
                              :key="r"
                              class="role-badge"
                              @click="setFilter('role', r)"
                              >{{ r }}</span
                            >
                          </span>
                          <span v-else class="text-muted">--</span>
                      ...
                      <el-table-column label="Flags" width="50">
                        <template #default="{ row: f }">
                          ...
                          <span v-if="isStaleFile(f as KnowledgeFileSummary)" class="popover-stale mcv-flag-stale" title="stale"
                            >S</span
                          >
                        </template>
                      </el-table-column>
                      <el-table-column label="Actions" width="110" fixed="right">
                        <template #default="{ row: f }">
                          <el-button size="small" type="primary" text @click="openFileInDialog(f as KnowledgeFileSummary)"
                            >Preview</el-button
                          >
                          <el-button size="small" text type="danger" @click.stop="deleteFile(f)"
                    ...
                    <div
                      v-if="m.files.length > (m.filePage || 30)"
                      class="mcv-show-more"
                      @click="m.filePage = (m.filePage || 30) + 30"
                    >
              ...
              <el-table-column label="Top Status" min-width="170">
                <template #default="{ row }">
                  <span
                    v-for="s in (row.statuses || []).slice(0, 3)"
                    :key="s.name"
                    class="mcv-chip-dynamic"
                    :style="{ '--bg': statusColor(s.name) }"
                    @click.stop="setFilter('status', s.name)"
                    >{{ s.name }} {{ s.count }}</span
                  >
                </template>
              </el-table-column>
              <el-table-column label="Top Type" min-width="170">
                <template #default="{ row }">
                  <span
                    v-for="t in (row.types || []).slice(0, 3)"
                    :key="t.name"
                    class="mcv-chip type-badge"
                    :class="'type-' + (t.name || 'unknown')"
                    @click.stop="setFilter('type', t.name)"
                    >{{ t.name }} {{ t.count }}</span
                  >
                </template>
              </el-table-column>
                ...
                <template #default="{ row }">
                  <div class="health-row-stats">
                    <span
                      ...
                      :style="{ '--coverage-color': row.review_coverage_pct < 50 ? '#e6a23c' : '#67c23a' }"
                      >{{ row.review_coverage_pct }}%</span
                    >
          ...
          <div class="submodule-grid" v-if="showSubModuleGrid">
            <div
              ...
              :class="{ 'sm-root': sc.name === '__root__' }"
              @click="
              ...
              <div class="sm-stats">
                <div class="sm-stat-row">
                  ...
                  <span class="sm-stat-values">
                    <span
                      v-for="s in (sc.statuses || []).slice(0, 3)"
                      :key="s.name"
                      class="sm-stat-chip clickable"
                      :class="'chip-' + (s.name || 'unknown')"
                      @click.stop="crossFilterSubModule(sc.name, 'status', s.name)"
                      >{{ s.name }}</span
                    >
                ...
                <div class="sm-stat-row" v-if="(sc.types || []).length > 0">
                  ...
                  <span class="sm-stat-values">
                    <span
                      v-for="t in (sc.types || []).slice(0, 3)"
                      :key="t.name"
                      class="sm-stat-chip clickable"
                      :class="'chip-' + (t.name || 'unknown')"
                      @click.stop="crossFilterSubModule(sc.name, 'type', t.name)"
                      >{{ t.name }}</span
                    >
                ...
                <div class="sm-stat-row" v-if="(sc.lifecycles || []).length > 0">
                  ...
                  <span class="sm-stat-values">
                    <span
                      v-for="l in (sc.lifecycles || []).slice(0, 3)"
                      :key="l.name"
                      class="sm-stat-chip clickable"
                      :class="'chip-' + (l.name || 'unknown')"
                      @click.stop="crossFilterSubModule(sc.name, 'lifecycle', l.name)"
                      >{{ l.name }}</span
                    >
                ...
                <div class="sm-stat-row">
                  ...
                  <span class="sm-stat-value" :class="{ 'text-warn': sc.reviewCoveragePct < 50 }"
                    >{{ sc.reviewCoveragePct }}%</span
                  >
                </div>
          ...
          <div class="module-detail-card" v-if="moduleDetail">
            <div class="mdc-header">
              <div class="mdc-title-row">
                ...
                <span
                  class="mdc-category-tag mdc-category-tag-dynamic"
                  :style="{ '--cat-color': catColor(activeFilter.category || '') }"
                  >{{ activeFilter.category }}</span
                >
              </div>
              <div class="mdc-health-row">
                <div class="mdc-health-item" :class="{ 'mdc-warn': moduleDetail.review_coverage_pct < 50 }">
                  ...
                  <div class="mdc-health-bar">
                    <div
                      class="mdc-health-fill mdc-health-fill-dynamic"
                      :style="{
                        '--w': moduleDetail.review_coverage_pct + '%',
                        '--bar-bg': moduleDetail.review_coverage_pct < 50 ? '#e6a23c' : '#67c23a'
                      }"
                    ></div>
                  </div>
                </div>
            ...
            <div class="mdc-body">
              <div class="mdc-dist-row" v-if="(moduleDetail.statuses || []).length > 0">
                ...
                <span
                  v-for="s in (moduleDetail.statuses || []).slice(0, 5)"
                  :key="s.name"
                  class="sm-stat-chip clickable"
                  :class="'chip-' + (s.name || 'unknown')"
                  @click="setFilter('status', s.name)"
                  >{{ s.name }} {{ s.count }}</span
                >
              </div>
              <div class="mdc-dist-row" v-if="(moduleDetail.types || []).length > 0">
                ...
                <span
                  v-for="t in (moduleDetail.types || []).slice(0, 5)"
                  :key="t.name"
                  class="sm-stat-chip clickable"
                  :class="'chip-' + (t.name || 'unknown')"
                  @click="setFilter('type', t.name)"
                  >{{ t.name }} {{ t.count }}</span
                >
              </div>
              <div class="mdc-dist-row" v-if="(moduleDetail.lifecycles || []).length > 0">
                ...
                <span
                  v-for="l in (moduleDetail.lifecycles || []).slice(0, 4)"
                  :key="l.name"
                  class="sm-stat-chip clickable"
                  :class="'chip-' + (l.name || 'unknown')"
                  @click="setFilter('lifecycle', l.name)"
                  >{{ l.name }} {{ l.count }}</span
                >
              </div>
              <div class="mdc-dist-row" v-if="(moduleDetail.roles || []).length > 0">
                <span class="mdc-dist-label">Roles</span>
                <span v-for="r in (moduleDetail.roles || []).slice(0, 5)" :key="r.name" class="sm-role-chip"
                  >{{ r.name }} {{ r.count }}</span
                >
              </div>
            </div>
            <div class="mdc-sub-row" v-if="subdirectoryBreakdown.length > 1">
              ...
              <div class="mdc-sub-bars">
                <span
                  v-for="s in subdirectoryBreakdown"
                  :key="s.name"
                ...
                >
                  <span
                    class="mdc-sub-bar-fill mdc-sub-bar-fill-dynamic"
                    :style="{ '--bar-color': catColor(activeFilter.category || '') }"
                  ></span>
          ...
          <div class="top-files-row" v-if="topModuleFiles.length > 0">
            ...
            <div class="tf-scroll">
              <span v-for="tf in topModuleFiles" :key="tf.path" class="tf-chip" @click="openFileInDialog(tf)" :title="tf.path">
                <span class="tf-chip-name">{{ tf.title || tf.path.split("/").pop() }}</span>
                <span class="tf-chip-meta">
                  <span v-if="tf.type" class="type-badge tf-chip-type-sm" :class="'type-' + (tf.type || 'unknown')">{{
                    tf.type
                  }}</span>
                  <span
                    v-if="tf.status"
                    class="tv-file-status-dot tv-file-status-dot-dynamic"
                    :style="{ '--dot-color': statusColor(tf.status) }"
                  ></span>
          ...
          <div v-loading="contentSearchLoading" class="content-search-results" v-if="searchMode === 'content' && searchText">
            ...
            <div
              v-for="r in enrichedSearchResults"
              :key="r.path"
              class="csr-item"
              ...
              @mouseenter="
                (e: any) => {
                  ...
                  e.currentTarget.style.background = 'var(--el-color-primary-light-9)';
                }
              "
              @mouseleave="
                (e: any) => {
                  e.currentTarget.style.borderColor = 'var(--el-border-color-lighter)';
            ...
            >
              ...
              <div class="csr-class-row" v-if="r.category">
                ...
                <el-button size="small" text type="primary" @click.stop="openFileDialog(r.path)" title="Preview" class="csr-btn"
          ...
          <template v-if="viewMode === 'files' && !(searchMode === 'content' && searchText)">
            ...
            <div class="file-gallery" v-if="fileViewMode === 'gallery'">
              <div
                v-for="f in paginatedDrillFiles"
                :key="f.path"
                class="fg-card"
                @click="openFileInDialog(f as KnowledgeFileSummary)"
              >
                ...
                <div class="fg-card-meta">
                  <span v-if="f.type" class="type-badge type-badge-sm" :class="'type-' + (f.type || 'unknown')">{{
                    f.type
                  }}</span>
                  <el-tag v-if="f.status" :type="statusTagType(f.status)" size="small" class="fg-card-meta-tag">{{
                    f.status
                  }}</el-tag>
                  <el-tag
                    v-if="f.lifecycle && f.lifecycle !== 'unknown'"
                    :type="lifecycleTagType(f.lifecycle)"
                    size="small"
                    class="fg-card-meta-tag"
                    >{{ f.lifecycle }}</el-tag
                  >
                ...
                <div class="fg-card-footer">
                  ...
                  <el-button
                    ...
                    text
                    type="primary"
                    @click.stop="openFileInDialog(f as KnowledgeFileSummary)"
                    class="fg-footer-preview"
                    >Preview</el-button
                  >
                  <el-button size="small" text @click.stop="discussInAiChat(f as KnowledgeFileSummary)" class="fg-footer-chat"
                    >Chat</el-button
                  >
                  <el-button
                    size="small"
                    ...
                    title="Copy path"
                    @click.stop
                    class="fg-footer-copy"
                  />
                  <el-button size="small" text type="danger" @click.stop="deleteFile(f)" class="fg-footer-delete"
                    ><el-icon><Delete /></el-icon
                  ></el-button>
                </div>
              </div>
            ...
            <el-table
              v-else
              :data="paginatedDrillFiles"
              stripe
              size="small"
              highlight-current-row
              @row-click="openFileInDialog"
            ...
            >
                ...
                <template #default="{ row }">
                  <el-popover placement="right" :width="320" trigger="hover" :show-after="400" :hide-after="100">
                    <template #reference>
                      <div class="file-cell">
                        <span class="file-title">
                          <el-icon v-if="isStaleFile(row as KnowledgeFileSummary)" class="stale-row-icon" :size="12"
                            ><WarningFilled
                          /></el-icon>
                        ...
                        <span class="file-path">
                          <span v-for="(seg, i) in row.path.split('/')" :key="i">
                            ...
                            <span v-else-if="i === 1 && !seg.endsWith('.md')" class="path-seg">
                              <el-popover placement="top" :width="220" trigger="hover" :show-after="300" :hide-after="200">
                                ...
                                <div class="popover-content" v-if="getModuleStats(row.category, seg)">
                                  <div>
                                    <b>{{ seg }}</b> ({{ getModuleStats(row.category, seg)!.count }} files)
                                  </div>
                                  <div>
                                    Status:
                                    <span
                                      v-for="s in (getModuleStats(row.category, seg)!.statuses || []).slice(0, 3)"
                                      :key="s.name"
                                      class="popover-stat"
                                      >{{ s.name }}:{{ s.count }}</span
                                    >
                                  ...
                                  <div>
                                    Types:
                                    <span
                                      v-for="t in (getModuleStats(row.category, seg)!.types || []).slice(0, 3)"
                                      :key="t.name"
                                      class="popover-stat"
                                      >{{ t.name }}:{{ t.count }}</span
                                    >
                                  ...
                                  <div>
                                    Coverage: {{ getModuleStats(row.category, seg)!.review_coverage_pct }}% | Stale:
                                    {{ getModuleStats(row.category, seg)!.stale_count }} | Tacit:
                                    {{ getModuleStats(row.category, seg)!.tacit_count }}
                                  </div>
                                  <div v-if="(getModuleStats(row.category, seg)!.sub_modules || []).length > 1">
                                    Sub-modules:
                                    {{
                                      (getModuleStats(row.category, seg)!.sub_modules || [])
                                        .filter(s => s.name !== "__root__")
                                        .map(s => s.name)
                                        .join(", ")
                                    }}
                                  </div>
                            ...
                            <span
                              v-else-if="i === 2 && !seg.endsWith('.md')"
                              class="path-seg"
                              @click.stop="setFilter('sub_module', seg)"
                              >{{ seg }}</span
                            >
                    ...
                    <div class="popover-content">
                      ...
                      <div>
                        <b>Category:</b> {{ row.category }} &middot; <b>Module:</b>
                        {{ row.module === "__root__" ? "root" : row.module }} &middot; <b>Sub:</b>
                        {{ row.sub_module === "__root__" ? "root" : row.sub_module }}
                      </div>
                      <div>
                        <b>Status:</b> {{ row.status }} &middot; <b>Lifecycle:</b> {{ row.lifecycle }} &middot; <b>Type:</b>
                        {{ row.type }}
                      </div>
                      ...
                      <div v-if="isStaleFile(row as KnowledgeFileSummary)">
                        <b>Stale:</b> <span class="popover-stale">Yes</span>
                      </div>
                      <div v-if="row.benefit">
                        <b>Benefit:</b>
                        <span class="popover-benefit"
                          >{{ row.benefit.slice(0, 100) }}{{ row.benefit.length > 100 ? "..." : "" }}</span
                        >
                      </div>
                      <div v-if="row.related_count > 0">
                        <b>Related:</b> {{ row.related_count }} files
                        <div v-if="resolveRelatedNames(row as KnowledgeFileSummary).length > 0" class="popover-related-row">
                          <span
                            v-for="r in resolveRelatedNames(row as KnowledgeFileSummary)"
                            :key="r.path"
                            class="popover-related-link"
                            @click.stop="
                              openFilePreview(
                                knowledgeData?.files?.find(f => f.path === r.path) || ({ path: r.path, title: r.title } as any)
                              )
                            "
                            :title="r.path"
                            >{{ r.title }}</span
                      ...
                      <div>
                        <b>Size:</b> {{ formatFileSize(row.size) }} &middot; <b>Updated:</b>
                        {{ row.updated ? formatRelativeTime(row.updated) : "--" }}
                      </div>
                      <div class="popover-actions">
                        <el-button size="small" type="primary" plain @click.stop="openFileInDialog(row as KnowledgeFileSummary)"
                          >Preview</el-button
                        >
              ...
              <el-table-column prop="classification" label="Classification" width="190">
                <template #default="{ row }">
                  <div class="classification-breadcrumbs">
                    <span
                      class="cb-seg cb-seg-cat"
                      :style="{ '--cat-color': catColor(row.category) }"
                      @click.stop="setFilter('category', row.category)"
                      >{{ row.category }}</span
                    >
                    <span class="cb-sep">/</span>
                    <span
                      class="cb-seg"
                      @click.stop="row.module !== '__root__' ? navigateToModule(row.category, row.module) : undefined"
                      >{{ row.module === "__root__" ? "root" : row.module }}</span
                    >
              ...
              <el-table-column prop="category" label="Category" width="110" show-overflow-tooltip sortable="custom">
                <template #default="{ row }">
                  <span v-if="row.category" class="cat-tag cat-color-text" :style="{ '--cat-color': catColor(row.category) }">{{
                    row.category
                  }}</span>
                  <span v-else class="text-muted">--</span>
                </template>
              ...
              <el-table-column prop="type" label="Type" width="85" show-overflow-tooltip sortable="custom">
                <template #default="{ row }">
                  <span
                    class="type-badge"
                    :class="'type-' + (row.type || 'unknown')"
                    @click.stop="setFilter('type', row.type || 'unknown')"
                    >{{ row.type || "--" }}</span
                  >
                </template>
              </el-table-column>
              <el-table-column prop="module" label="Module" width="115" show-overflow-tooltip sortable="custom">
                <template #default="{ row }">
                  <span
                    v-if="row.module && row.module !== '__root__'"
                    class="module-chip"
                    @click.stop="setFilter('module', row.module)"
                    >{{ row.module }}</span
                  >
                  <span v-else class="text-muted">--</span>
                </template>
              ...
              <el-table-column prop="sub_module" label="Sub" width="90" show-overflow-tooltip sortable="custom">
                <template #default="{ row }">
                  <span
                    v-if="row.sub_module && row.sub_module !== '__root__'"
                    class="module-chip"
                    @click.stop="setFilter('sub_module', row.sub_module)"
                    >{{ row.sub_module }}</span
                  >
                  <span v-else class="text-muted">--</span>
                </template>
              ...
              <el-table-column prop="health" label="Health" width="100" align="center" sortable="custom">
                <template #default="{ row }">
                  <el-tooltip placement="top" :show-after="300">
                    ...
                    <span
                      v-if="fileHealthIssues(row as KnowledgeFileSummary).length > 0"
                      class="health-issues-badge"
                      :class="'health-issues-' + fileHealthLevel(row as KnowledgeFileSummary)"
                      >{{ fileHealthIssues(row as KnowledgeFileSummary).length }}</span
                    >
              ...
              <el-table-column prop="status" label="Status" width="100" sortable="custom">
                <template #default="{ row }">
                  <el-tag
                    v-if="isMissingField(row.status)"
                    type="danger"
                    size="small"
                    @click.stop="setQualityFilter('status')"
                    class="table-tag-clickable"
                    >Missing</el-tag
                  >
                  <el-tag
                    v-else
                    ...
                    size="small"
                    @click.stop="setFilter('status', row.status || 'unknown')"
                    class="table-tag-clickable"
                    >{{ row.status || "unknown" }}</el-tag
                  >
                </template>
              </el-table-column>
              <el-table-column prop="lifecycle" label="Lifecycle" width="100" sortable="custom">
                <template #default="{ row }">
                  <el-tag
                    v-if="isMissingField(row.lifecycle)"
                    type="danger"
                    size="small"
                    @click.stop="setQualityFilter('lifecycle')"
                    class="table-tag-clickable"
                    >Missing</el-tag
                  >
                  <el-tag
                    v-else-if="row.lifecycle && row.lifecycle !== 'unknown'"
                    :type="lifecycleTagType(row.lifecycle)"
                    size="small"
                    @click.stop="setFilter('lifecycle', row.lifecycle)"
                    class="table-tag-clickable"
                  >
                    {{ row.lifecycle }}
                  </el-tag>
                  <el-tag
                    v-else-if="row.lifecycle === 'unknown'"
                    type="info"
                    size="small"
                    @click.stop="setFilter('lifecycle', 'unknown')"
                    class="table-tag-clickable"
                    >unknown</el-tag
                  >
                  <span v-else class="text-muted">--</span>
              ...
              <el-table-column prop="review_cycle" label="Review" width="140" sortable="custom">
                <template #default="{ row }">
                  <el-tag
                    v-if="row.review_cycle"
                    :type="reviewCycleTagType(row.review_cycle)"
                    size="small"
                    @click.stop="setFilter('review_cycle', row.review_cycle)"
                    class="table-tag-clickable"
                  >
                    {{ row.review_cycle }}
                  </el-tag>
              ...
              >
                <template #default="{ row }">
                  <span v-if="row.benefit" class="benefit-col-text"
                    >{{ row.benefit.slice(0, 80) }}{{ row.benefit.length > 80 ? "..." : "" }}</span
                  >
                  <span v-else class="text-muted">--</span>
                </template>
              </el-table-column>
              <el-table-column label="Actions" width="90" align="center" fixed="right">
                <template #default="{ row }">
                  <el-button size="small" text type="danger" @click.stop="deleteFile(row)"
                    ><el-icon><Delete /></el-icon
                  ></el-button>
                </template>
              </el-table-column>
            ...
            <div class="table-footer" v-if="drillTableData.length > drillPageSize">
              <span class="table-footer-info"
                >Page {{ drillPage }} of {{ Math.ceil(drillTableData.length / drillPageSize) }} ({{
                  drillTableData.length
                }}
                files)</span
              >
              <el-pagination
                v-model:current-page="drillPage"
                :page-size="drillPageSize"
                :total="drillTableData.length"
          ...
          <div v-if="selectedFile" class="file-detail-panel" @keydown="onDetailKeydown" tabindex="0" ref="detailPanelRef">
            <div class="fd-header">
              <div class="fd-header-left">
                <el-button size="small" text :disabled="!prevFile" @click="navigateToFile(prevFile!)" title="Previous file"
                  ><el-icon><ArrowLeft /></el-icon
                ></el-button>
                <span class="fd-position" v-if="selectedFileIndex >= 0"
                  >{{ selectedFileIndex + 1 }}/{{ sortedDrillTableData.length }}</span
                >
                <span class="fd-position fd-kbd-hint" title="Use ← → arrow keys to navigate">←→</span>
                <el-button size="small" text :disabled="!nextFile" @click="navigateToFile(nextFile!)" title="Next file"
                  ><el-icon><ArrowRight /></el-icon
                ></el-button>
                <span class="fd-title">{{ selectedFile.title || selectedFile.path.split("/").pop() }}</span>
              </div>
              <div class="fd-header-right">
                <el-button size="small" text type="primary" @click="openFileDialog(selectedFile.path)" title="Full preview"
                  ><el-icon :size="14"><View /></el-icon
                ></el-button>
                <el-button size="small" text type="danger" @click="deleteFile(selectedFile)" title="Delete"
                  ><el-icon :size="14"><Delete /></el-icon
                ></el-button>
                <el-button size="small" text @click="selectedFile = null"
            ...
            <div class="fd-classification-path">
              <span
                class="fd-path-chip fd-path-chip-cat"
                :style="{ '--cat-color': catColor(selectedFile.category) }"
                @click="setFilter('category', selectedFile.category)"
                >{{ selectedFile.category }}</span
              >
              <span class="fd-path-sep">/</span>
              <span
                class="fd-path-chip"
                @click="selectedFile.module !== '__root__' ? setFilter('module', selectedFile.module) : undefined"
                >{{ selectedFile.module === "__root__" ? "root" : selectedFile.module }}</span
              >
              <template v-if="selectedFile.sub_module !== '__root__'">
                <span class="fd-path-sep">/</span>
                <span class="fd-path-chip" @click="setFilter('sub_module', selectedFile.sub_module)">{{
                  selectedFile.sub_module
                }}</span>
              </template>
              <span class="fd-path-sep">/</span>
            ...
            <div class="fd-body">
              <div class="fd-meta-grid">
                <div class="fd-meta-item">
                  ...
                  <el-tag v-else :type="statusTagType(selectedFile.status)" size="small">{{
                ...
                <div class="fd-meta-item">
                  ...
                  <el-tag v-else-if="selectedFile.lifecycle" :type="lifecycleTagType(selectedFile.lifecycle)" size="small">{{
                    selectedFile.lifecycle
                  }}</el-tag>
                  <span v-else class="text-muted">--</span>
                </div>
                <div class="fd-meta-item">
                  <span class="fd-meta-label">Type</span>
                  <span class="type-badge" :class="'type-' + (selectedFile.type || 'unknown')">{{
                    selectedFile.type || "--"
                  }}</span>
                </div>
                <div class="fd-meta-item">
                  <span class="fd-meta-label">Review</span>
                  <el-tag v-if="selectedFile.review_cycle" :type="reviewCycleTagType(selectedFile.review_cycle)" size="small">{{
                    selectedFile.review_cycle
                  }}</el-tag>
                  <span v-else class="text-muted">--</span>
                </div>
                <div class="fd-meta-item">
              ...
              <div class="fd-missing-strip" v-if="fileHealthIssues(selectedFile).length > 0">
                ...
                <span
                  v-for="issue in fileHealthIssues(selectedFile)"
                  :key="issue"
                    ...
                    issue === 'Stale'
                      ...
                      : issue === 'Missing status'
                        ...
                        : issue === 'Missing type'
                          ...
                          : issue === 'Missing lifecycle'
                            ? setQualityFilter('lifecycle')
                            : issue === 'Missing review cycle'
                              ? setQualityFilter('review_cycle')
                              : issue === 'Missing roles'
                                ? setQualityFilter('roles')
                                : issue === 'Missing tags'
                                  ? setQualityFilter('tags')
                                  : issue === 'Missing benefit'
                                    ? setQualityFilter('benefit')
                                    : issue === 'Status: unknown'
                                      ? setFilter('status', 'unknown')
                                      : issue === 'Type: unknown'
                                        ? setFilter('type', 'unknown')
                                        : setFilter('lifecycle', 'unknown')
                  "
                  >{{ issue }}</span
                >
              </div>
              <div class="fd-module-context" v-if="sameModuleCount > 0">
                <span class="fd-context-item">
                  Module:
                  <a class="fd-context-link" @click="navigateToModule(selectedFile!.category, selectedFile!.module)">{{
                    selectedFile!.module === "__root__" ? "root" : selectedFile!.module
                  }}</a>
                ...
                <span class="fd-context-item" v-if="sameSubModuleCount > 0 && selectedFile!.sub_module !== '__root__'">
                  Sub:
                  <a class="fd-context-link" @click="drillToSubdir(selectedFile!.sub_module)">{{ selectedFile!.sub_module }}</a>
              ...
              <div class="fd-content-preview" v-if="showFileContent || fileContentLoading">
                ...
                <div class="fd-content-body" v-show="showFileContent" v-loading="fileContentLoading">
                  ...
                  <div v-else-if="!fileContentLoading" class="text-muted fd-empty-content">
              ...
              <div class="fd-tags-row" v-if="resolvedRelatedFiles.length > 0">
                ...
                <span class="fd-tags">
                  <span
                    v-for="rf in resolvedRelatedFiles"
                    :key="rf.path"
                    class="related-link"
                    @click="openFilePreview(rf)"
                    :title="rf.path"
                  >
          ...
          <div
            class="empty-hint"
            v-if="
              (drillTableData.length === 0 && !contentSearchLoading) ||
              (searchMode === 'title' && searchText && searchSuggestions.length === 0 && drillTableData.length === 0)
            "
          >
          ...
          <div
            class="empty-hint"
            v-if="searchMode === 'content' && searchText && !contentSearchLoading && contentSearchResults.length === 0"
          >
            <el-icon><InfoFilled /></el-icon>
