...
// 供目标行提供「🔁 N 闭环」链接，跳转到 /executiver/process?goal=。
...
function goGoalLoops(goalId: string) {
  router.push(`/executiver/process?goal=${goalId}`);
}
...
.okr-role__loop-link { font-size: 12px; font-weight: 600; color: var(--el-color-primary); cursor: pointer; white-space: nowrap; transition: color .15s; &:hover { color: var(--el-color-primary-light-3); text-decoration: underline; } }
.okr-role__issue-link { font-size: 12px; font-weight: 600; color: var(--el-color-success); cursor: pointer; white-space: nowrap; transition: color .15s; &:hover { color: var(--el-color-success-light-3); text-decoration: underline; } }
.okr-role__loop-empty { font-size: 12px; color: var(--el-text-color-placeholder); }
