...
export const ROLE_COLORS: Record<string, string> = {
  executiver: "#ee6666", producter: "#fac858", leader: "#73c0de",
  engineer: "#5470c6", srer: "#ea7ccc", aier: "#91cc75", curator: "#3ba272"
};
export function roleColor(roleId: string): string {
  return ROLE_COLORS[roleId] || "#909399";
}
...
export const goalsData: Record<string, GoalItem[]> = {
  executiver: [
    { id: "exec-001", icon: "📊", title: "市场情报与竞争洞察", status: "active", description: "追踪 LLM/SaaS 竞品格局、市场趋势与第三方行业报告（Gartner/McKinsey/a16z/CAICT/IDC），让战略决策基于市场现实。", period: "2026 Q3", owner: "CEO", project: "YiAi", keyResults: [{ text: "竞品分析覆盖 LLM 供应商 / SaaS 头部 / 区域竞对", progress: 100, file: "executiver/okr/2026-Q3/exec-001-市场情报与竞争洞察/kr-exec-001-competitor-coverage.md" }, { text: "第三方行业报告摘要（Gartner/McKinsey/a16z/CAICT/IDC）落知识库", progress: 67, file: "executiver/okr/2026-Q3/exec-001-市场情报与竞争洞察/kr-exec-001-report-summaries.md" }, { text: "半年度市场趋势复盘 + 新兴赛道追踪", progress: 60, file: "executiver/okr/2026-Q3/exec-001-市场情报与竞争洞察/kr-exec-001-market-trends.md" }, { text: "竞品与行业信息可被 RAG 检索，过时条目标记 deprecated", progress: 70, file: "executiver/okr/2026-Q3/exec-001-市场情报与竞争洞察/kr-exec-001-rag-retrievability.md" }] },
    { id: "exec-002", icon: "🧭", title: "经营战略与组织路线", status: "active", description: "用战略框架（Porter/Blue Ocean/VRIO/SWOT/BMC/价值主张）定义竞争定位，产出年度战略规划、季度经营复盘、组织 OKR 与编制预算规划。", period: "2026 Q3", owner: "CEO", project: "YiAi", keyResults: [{ text: "战略框架与商业模型（BMC/价值主张/第二曲线）落地到产品战略实例", progress: 100, file: "executiver/okr/2026-Q3/exec-002-经营战略与组织路线/kr-exec-002-strategy-frameworks.md" }, { text: "年度战略规划 + 季度经营复盘（QBR）产出", progress: 60, file: "executiver/okr/2026-Q3/exec-002-经营战略与组织路线/kr-exec-002-annual-qbr.md" }, { text: "组织级 OKR 跟踪 + 编制/预算规划落地", progress: 75, file: "executiver/okr/2026-Q3/exec-002-经营战略与组织路线/kr-exec-002-okr-budget.md" }, { text: "合规与数据留存策略（regulatory change / retention review）有据可查", progress: 80, file: "executiver/okr/2026-Q3/exec-002-经营战略与组织路线/kr-exec-002-compliance.md" }] },
    { id: "exec-003", icon: "📚", title: "经营学习与阅读", status: "active", description: "维护月度精选阅读清单与读书笔记，沉淀可执行洞察（如 High Output Management），并蒸馏到对应语义知识叶。", period: "2026 Q3", owner: "CEO", project: "YiAi", keyResults: [{ text: "月度阅读清单滚动更新", progress: 70, file: "executiver/okr/2026-Q3/exec-003-经营学习与阅读/kr-exec-003-reading-list.md" }, { text: "读书笔记含可执行 takeaway（High Output Management）", progress: 100, file: "executiver/okr/2026-Q3/exec-003-经营学习与阅读/kr-exec-003-reading-notes.md" }, { text: "有价值观点蒸馏到方法论/技术语义叶", progress: 50, file: "executiver/okr/2026-Q3/exec-003-经营学习与阅读/kr-exec-003-knowledge-distillation.md" }] },
  ],
  producter: [
    { id: "prod-001", icon: "📋", title: "需求评审可闭环", status: "active", description: "作为需求评审拥有者，为每条闭环需求产出 PRD（背景/目标/范围/非目标/干系人）、可被测试门禁直接判定的验收标准与 WSJF 优先级（价值×紧迫÷难度），评审记录落知识库，需求→任务拆解模板可复用。", period: "2026 Q3", owner: "PM YiAi", project: "YiAi", keyResults: [{ text: "每条需求产出 PRD（背景/目标/范围/非目标/干系人）", progress: 100, file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/01-requirement-review.md" }, { text: "验收标准可被测试门禁直接判定", progress: 100, file: "producter/okr/2026-Q3/prod-001-requirement-review-loop/goal.md" }, { text: "WSJF 优先级（价值×紧迫÷难度）打分排序", progress: 100, file: "producter/okr/2026-Q3/prod-001-requirement-review-loop/goal.md" }, { text: "需求评审记录落知识库（01-requirement-review）", progress: 100, file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/01-requirement-review.md" }, { text: "需求→任务拆解模板可复用", progress: 100, file: "curator/okr/2026-Q3/loop/_templates/01-requirement-review.md" }] },
  ],
  leader: [
    { id: "lead-001", icon: "🧭", title: "技术评审可闭环", status: "active", description: "作为技术评审拥有者，为每条需求产出 ADR（Context/Decision/Consequences）、数据模型与风险对策，保证决策可回溯到需求，评审记录落知识库（02-technical-review），ADR 模板可复用。", period: "2026 Q3", owner: "Tech Lead", project: "YiAi", keyResults: [{ text: "每条需求产出 ADR（Context/Decision/Consequences）", progress: 100, file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/02-technical-review.md" }, { text: "数据模型与风险对策随技术评审记录产出", progress: 100, file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/02-technical-review.md" }, { text: "架构决策可回溯到需求", progress: 100, file: "leader/okr/2026-Q3/lead-001-technical-review-loop/goal.md" }, { text: "技术评审记录落知识库（02-technical-review）", progress: 100, file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/02-technical-review.md" }, { text: "ADR 模板可复用（Context/Decision/Consequences）", progress: 100, file: "curator/okr/2026-Q3/loop/_templates/02-technical-review.md" }] },
  ],
  engineer: [
    { id: "eng-001", icon: "⚡", title: "代码编写与调试自闭环", status: "active", description: "作为代码编写与调试拥有者，把需求实现为可构建代码（0 人工编码介入），改动文件 0 新增类型错误，调试过程（问题→修复→验证）留痕落知识库（04-build-debug），构建门禁通过。", period: "2026 Q3", owner: "Engineering Lead", project: "YiVad", keyResults: [{ text: "需求实现为可构建代码（0 人工编码介入）", progress: 100, file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/04-build-debug.md" }, { text: "改动文件 0 新增类型错误", progress: 100, file: "engineer/okr/2026-Q3/eng-001-build-debug-loop/goal.md" }, { text: "调试过程（问题→修复→验证）落知识库（04-build-debug）", progress: 100, file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/04-build-debug.md" }, { text: "构建门禁（vue-tsc + build）通过", progress: 100, file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/04-build-debug.md" }] },
    { id: "eng-005", icon: "🧹", title: "构建健康度清零", status: "active", description: "清零 23 个 vue-tsc 既有类型错误，让 YiVad 恢复可构建可部署。", period: "2026 Q3", owner: "Engineering Lead", project: "YiVad", keyResults: [{ text: "清零 23 个 vue-tsc 既有类型错误", progress: 100, file: "engineer/okr/2026-Q3/eng-005-build-health-zero/goal.md" }, { text: "knowledgeBase dashboard 17 个错误修复", progress: 100, file: "engineer/okr/2026-Q3/eng-005-build-health-zero/goal.md" }, { text: "rag history/retrieval 4 个错误修复", progress: 100, file: "engineer/okr/2026-Q3/eng-005-build-health-zero/goal.md" }, { text: "proTable + menuMange 2 个类型错误修复", progress: 100, file: "engineer/okr/2026-Q3/eng-005-build-health-zero/goal.md" }] },
  ],
  srer: [
    { id: "sre-001", icon: "🔧", title: "测试与上线自闭环", status: "active", description: "作为测试与上线拥有者，为每条需求产出测试报告（04-test-report）与上线记录（05-launch-record），typecheck/build 门禁通过才上线，上线可追溯可回滚。", period: "2026 Q3", owner: "SRE Lead", project: "YiAi", keyResults: [{ text: "每条需求产出测试报告（04-test-report）", progress: 100, file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/05-test-report.md" }, { text: "上线记录（artifact/version/env）落知识库（05-launch-record）", progress: 100, file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/07-launch-record.md" }, { text: "typecheck/build 门禁通过才上线", progress: 100, file: "srer/okr/2026-Q3/sre-001-test-launch-loop/goal.md" }, { text: "上线可回滚/可追溯", progress: 100, file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/07-launch-record.md" }] },
  ],
  aier: [
    { id: "aier-001", icon: "🧩", title: "编排三要素落地", status: "active", description: "作为编排拥有者，为每个推荐任务显式指派 skill/agent/mcp 三要素，确定性角色×清单映射覆盖 7 角色，AI 推荐可复现，编排结果落盘可读回。", period: "2026 Q3", owner: "AI Engineer", project: "YiAi", keyResults: [{ text: "每个推荐任务显式指派 skill/agent/mcp", progress: 100, file: "curator/okr/2026-Q3/loop/loop-002-template-orchestration/README.md" }, { text: "确定性角色×清单映射覆盖 7 角色", progress: 100, file: "aier/okr/2026-Q3/aier-001-orchestration/goal.md" }, { text: "AI 推荐按 WSJF 可复现", progress: 100, file: "aier/okr/2026-Q3/aier-001-orchestration/goal.md" }, { text: "编排结果落盘可读回", progress: 100, file: "curator/okr/2026-Q3/loop/loop-002-template-orchestration/README.md" }] },
  ...
  curator: [
    { id: "cur-001", icon: "📦", title: "流程记录知识化", status: "active", description: "作为流程记录知识化拥有者，维护 5 类流程记录模板与整合索引（loop/INDEX），记录 frontmatter 合规，循环记录可被 RAG 检索。", period: "2026 Q3", owner: "Curator", project: "YiAi", keyResults: [{ text: "五类记录模板 + 整合索引页（loop/INDEX）落地", progress: 100, file: "curator/okr/2026-Q3/loop/INDEX.md" }, { text: "记录 frontmatter 合规率 100%", progress: 100, file: "curator/okr/2026-Q3/loop/INDEX.md" }, { text: "循环记录可被 RAG 检索", progress: 100, file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/README.md" }, { text: "旧数据清零并留迁移记录", progress: 100, file: "engineer/okr/2026-Q3/eng-001-build-debug-loop/goal.md" }] },
  ]
};
...
export const roleWeeklyDataMap: Record<string, WeeklyRoleData> = {
  executiver: {
    status: "On Track", statusType: "success",
      ...
      { text: "更新 LLM 供应商竞品格局", file: "executiver/okr/2026-Q3/exec-001-市场情报与竞争洞察/kr-exec-001-competitor-coverage.md" },
      { text: "摘要 Gartner/McKinsey 行业报告", file: "executiver/okr/2026-Q3/exec-001-市场情报与竞争洞察/kr-exec-001-report-summaries.md" },
      { text: "落地 Business Model Canvas 战略实例", file: "executiver/okr/2026-Q3/exec-002-经营战略与组织路线/kr-exec-002-strategy-frameworks.md" }
    ],
    blockers: [],
    nextWeek: [
    ...
    decisions: [
      { text: "定位：Business Strategy 跨管线上下文", file: "executiver/okr/2026-Q3/exec-002-经营战略与组织路线/kr-exec-002-strategy-frameworks.md" },
      { text: "三芯片：market-intel / org-strategy / reading-list", file: "executiver/okr/2026-Q3/exec-001-市场情报与竞争洞察/kr-exec-001-competitor-coverage.md" },
      { text: "路线：战略框架 → 合成 → 规划 → 执行", file: "executiver/okr/2026-Q3/exec-002-经营战略与组织路线/kr-exec-002-okr-budget.md" }
    ]
  },
  producter: {
    status: "On Track", statusType: "success",
    done: [
      { text: "产出 loop-001 需求评审（PRD + 6 验收标准 + WSJF）", file: "producter/okr/2026-Q3/prod-001-requirement-review-loop/goal.md" },
      { text: "需求评审记录落知识库（01-requirement-review）", file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/01-requirement-review.md" },
      { text: "复盘 loop-001，产出 loop-002 PRD 与验收标准", file: "curator/okr/2026-Q3/loop/loop-002-template-orchestration/01-requirement-review.md" }
    ],
    blockers: [],
    nextWeek: [
      { text: "跑通 loop-002 需求评审全流程", file: "curator/okr/2026-Q3/loop/_templates/01-requirement-review.md" },
      { text: "沉淀 PRD / 验收标准 / WSJF 可复用模板", file: "curator/okr/2026-Q3/loop/_templates/01-requirement-review.md" }
    ],
    decisions: [
      { text: "需求评审 = 产出 PRD + 验收标准 + WSJF 优先级", file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/01-requirement-review.md" },
      { text: "每需求一条 01-requirement-review 记录", file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/01-requirement-review.md" },
  ...
  leader: {
    status: "On Track", statusType: "success",
      ...
      { text: "圈定记录载体（KB markdown + YiVad 新页）", file: "leader/okr/2026-Q3/lead-001-technical-review-loop/goal.md" },
      { text: "定 KB loop/ 目录规范", file: "curator/okr/2026-Q3/loop/INDEX.md" },
      { text: "盘点可复用的 OKR 机制", file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/02-technical-review.md" }
    ],
    blockers: [],
    nextWeek: [
      { text: "复盘 loop-001 技术评审，沉淀可复用 ADR", file: "curator/okr/2026-Q3/loop/_templates/02-technical-review.md" }
    ],
    decisions: [
      { text: "记录载体：KB markdown 为事实源 + YiVad 新页整合展示", file: "leader/okr/2026-Q3/lead-001-technical-review-loop/goal.md" },
      { text: "ADR 随 02-technical-review 落知识库", file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/02-technical-review.md" }
    ]
  },
  engineer: {
    status: "On Track", statusType: "success",
    done: [
      { text: "重写 okrData.ts 7 角色数据", file: "engineer/okr/2026-Q3/eng-001-build-debug-loop/goal.md" },
      { text: "基线盘点：23 个 vue-tsc 既有错误", file: "engineer/okr/2026-Q3/eng-005-build-health-zero/goal.md" },
      { text: "确认类型接口不变、只换数据", file: "engineer/okr/2026-Q3/eng-001-build-debug-loop/goal.md" }
    ],
    blockers: [],
    nextWeek: [
      { text: "复盘 loop-001 构建调试，维护 0 类型错误基线", file: "engineer/okr/2026-Q3/eng-001-build-debug-loop/goal.md" }
    ],
    decisions: [
      { text: "类型接口保持不变，只替换数据内容", file: "engineer/okr/2026-Q3/eng-001-build-debug-loop/goal.md" },
  ...
  srer: {
    ...
    blockers: [],
    nextWeek: [
      { text: "复盘 loop-001 门禁与上线，规划 loop-002 上线", file: "curator/okr/2026-Q3/loop/loop-002-template-orchestration/05-test-report.md" }
    ],
    decisions: [
      { text: "门禁：typecheck + build 通过才上线", file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/05-test-report.md" },
      { text: "上线记录含 artifact/version/env", file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/07-launch-record.md" }
    ]
  },
  aier: {
    status: "On Track", statusType: "success",
    done: [
      { text: "盘点 skill/agent/mcp 三要素映射", file: "aier/okr/2026-Q3/aier-001-orchestration/goal.md" },
      { text: "确认 WSJF 评分逻辑可复用", file: "curator/okr/2026-Q3/loop/loop-002-template-orchestration/README.md" },
      { text: "确认 Agent 确认门机制在位", file: "aier/methodology/agent-harness-plugin-architecture.md" }
    ],
    blockers: [],
    nextWeek: [
      { text: "复盘 loop-001 编排映射，沉淀三要素清单", file: "curator/okr/2026-Q3/loop/loop-002-template-orchestration/README.md" }
    ],
    decisions: [
      { text: "编排三要素：skill/agent/mcp 确定性映射 + AI 兜底", file: "aier/okr/2026-Q3/aier-001-orchestration/goal.md" },
      { text: "WSJF 评分复用既有实现", file: "curator/okr/2026-Q3/loop/loop-002-template-orchestration/README.md" }
    ]
  },
  curator: {
    status: "On Track", statusType: "success",
    done: [
      { text: "清空旧 OKR 数据（goals/metrics/2026-08）", file: "engineer/okr/2026-Q3/eng-001-build-debug-loop/goal.md" },
      { text: "定 loop/ 目录结构", file: "curator/okr/2026-Q3/loop/INDEX.md" },
      { text: "定 4 类记录模板 frontmatter", file: "curator/okr/2026-Q3/cur-001-process-record-kb/goal.md" }
    ],
    blockers: [],
    nextWeek: [
      { text: "复盘 loop-001 记录规范，规划 loop-002 模板复用", file: "curator/okr/2026-Q3/loop/loop-002-template-orchestration/README.md" }
    ],
    decisions: [
      { text: "loop/ 每闭环一个目录，含 01~05 记录", file: "curator/okr/2026-Q3/loop/INDEX.md" },
      { text: "记录 frontmatter 沿用 KB rulebook 规范", file: "curator/okr/2026-Q3/cur-001-process-record-kb/goal.md" }
    ]
  }
};
