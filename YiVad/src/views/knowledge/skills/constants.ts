...
export const categories: SkillCategory[] = [
  ...
  },
  {
    ...
    color: "#f59e0b",
    desc: "Skill creator, project init, document import, Mermaid diagrams — AI-native skills."
  },
  {
    id: "business",
    icon: "🏢",
...
export const skills: SkillDef[] = [
  ...
  },
  {
    ...
    title: "Node.js",
    icon: "💚",
    description: "Node.js best practices: error handling, security, performance, project structure, and production patterns.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    title: "Git Worktree",
    icon: "🌿",
    description: "Git worktrees for parallel development on the YrY monorepo — multiple branches simultaneously.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    title: "Mermaid",
    icon: "📊",
    description: "Mermaid diagram rendering: 15+ themes, flowchart, sequence, class, ER, Gantt, and more.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    icon: "🔍",
    description:
      "Investigate questions against high-trust primary sources and capture findings as cited markdown in YiKnowledge.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    title: "Code Review",
    icon: "✅",
    description: "Two-axis code review of pending changes: standards compliance and spec faithfulness.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    title: "Brainstorm",
    icon: "💡",
    description: "Structured interview to clarify intent, surface hidden assumptions, and produce a concrete spec before coding.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    icon: "🔬",
    description:
      "Systematic debugging with a disciplined 4-phase loop: reproduce → isolate → hypothesize → fix → regression-test.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    icon: "🧠",
    description:
      "Build and sharpen a project's shared language (domain model) to reduce agent verbosity and improve code consistency.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    title: "Execute Plan",
    icon: "🎯",
    description: "Execute an implementation plan task by task, verifying each step before moving to the next.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    title: "Handoff",
    icon: "🤝",
    description: "Compact the current conversation into a handoff document so another agent can continue without losing context.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    title: "Prototype",
    icon: "🖼️",
    description: "Build a throwaway prototype to answer a design question before committing to production code.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    title: "Subagent Dev",
    icon: "🤖",
    description: "Dispatch independent tasks to parallel subagents for faster execution across the monorepo.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    title: "TDD",
    icon: "🧪",
    description: "Test-driven development with a red-green-refactor loop. Language-specific testing guidance for the YrY stack.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    icon: "🧭",
    description:
      "Plan a large piece of work that's too big for a single agent session — create decision tickets and work through them.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    title: "Write Plan",
    icon: "📝",
    description: "Transform a spec or requirement into a concrete, step-by-step implementation plan with verifiable tasks.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  // ── Business & Strategy ─────────────────────────────
  {
    ...
    icon: "🔍",
    description:
      "Full research lifecycle: landscape surveys, single-project evaluation, head-to-head comparison, YiKnowledge output.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    icon: "✅",
    description:
      "Evaluate and select AI-powered code quality tools across 4 key paths: review, test generation, refactoring, style alignment.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
  ...
  },
  {
    ...
    icon: "📈",
    description:
      "Define organizational strategy: market intelligence, competitive analysis, OKRs, roadmaps, build-vs-buy decisions.",
    files: 1,
    lifecycle: "active",
    user_invocable: true,
    status: "stable",
