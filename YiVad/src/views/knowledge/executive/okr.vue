...
import { EXAMPLE_TASKS, type ExampleTask, type ExampleSubtask } from "@/views/knowledge/executive/okrFlowData";
import { rolesData, roleWeeklyDataMap, goalRoleMap } from "@/views/knowledge/executive/okrData";
...
function goRole(roleId?: string) {
  if (roleId) router.push(`/knowledge/${roleId}`);
}
