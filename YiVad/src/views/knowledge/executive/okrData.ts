  ...
  executiver: [
    {
      ...
      status: "active",
      description:
        "追踪 LLM/SaaS 竞品格局、市场趋势与第三方行业报告（Gartner/McKinsey/a16z/CAICT/IDC），让战略决策基于市场现实。",
      period: "2026 Q3",
      owner: "CEO",
      project: "YiAi",
      keyResults: [
    ...
    },
    {
      ...
      status: "active",
      description:
        "用战略框架（Porter/Blue Ocean/VRIO/SWOT/BMC/价值主张）定义竞争定位，产出年度战略规划、季度经营复盘、组织 OKR 与编制预算规划。",
      period: "2026 Q3",
      owner: "CEO",
      project: "YiAi",
      keyResults: [
    ...
    },
    {
      ...
      title: "经营学习与阅读",
      status: "active",
      description: "维护月度精选阅读清单与读书笔记，沉淀可执行洞察（如 High Output Management），并蒸馏到对应语义知识叶。",
      period: "2026 Q3",
      owner: "CEO",
      project: "YiAi",
      keyResults: [
  ...
  producter: [
    {
      ...
      keyResults: [
        {
          text: "每条需求产出 PRD（背景/目标/范围/非目标/干系人）",
          progress: 100,
        ...
        { text: "需求→任务拆解模板可复用", progress: 100, file: "curator/okr/2026-Q3/loop/_templates/01-requirement-review.md" }
      ]
    }
  ],
  leader: [
    {
      ...
      status: "active",
      description:
        "作为技术评审拥有者，为每条需求产出 ADR（Context/Decision/Consequences）、数据模型与风险对策，保证决策可回溯到需求，评审记录落知识库（02-technical-review），ADR 模板可复用。",
      period: "2026 Q3",
      owner: "Tech Lead",
      project: "YiAi",
      keyResults: [
        {
          text: "每条需求产出 ADR（Context/Decision/Consequences）",
          progress: 100,
          file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/02-technical-review.md"
        },
        {
          text: "数据模型与风险对策随技术评审记录产出",
          progress: 100,
          file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/02-technical-review.md"
        },
        { text: "架构决策可回溯到需求", progress: 100, file: "leader/okr/2026-Q3/lead-001-technical-review-loop/goal.md" },
        {
          text: "技术评审记录落知识库（02-technical-review）",
          progress: 100,
          file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/02-technical-review.md"
        },
        {
          text: "ADR 模板可复用（Context/Decision/Consequences）",
          progress: 100,
          file: "curator/okr/2026-Q3/loop/_templates/02-technical-review.md"
        }
      ]
    }
  ],
  engineer: [
    {
      ...
      status: "active",
      description:
        "作为代码编写与调试拥有者，把需求实现为可构建代码（0 人工编码介入），改动文件 0 新增类型错误，调试过程（问题→修复→验证）留痕落知识库（04-build-debug），构建门禁通过。",
      period: "2026 Q3",
      owner: "Engineering Lead",
      project: "YiVad",
      keyResults: [
        {
          text: "需求实现为可构建代码（0 人工编码介入）",
          progress: 100,
          file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/04-build-debug.md"
        },
        { text: "改动文件 0 新增类型错误", progress: 100, file: "engineer/okr/2026-Q3/eng-001-build-debug-loop/goal.md" },
        {
          text: "调试过程（问题→修复→验证）落知识库（04-build-debug）",
          progress: 100,
          file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/04-build-debug.md"
        },
        {
          text: "构建门禁（vue-tsc + build）通过",
          progress: 100,
          file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/04-build-debug.md"
        }
      ]
    },
    {
      ...
      title: "构建健康度清零",
      status: "active",
      description: "清零 23 个 vue-tsc 既有类型错误，让 YiVad 恢复可构建可部署。",
      period: "2026 Q3",
      owner: "Engineering Lead",
      project: "YiVad",
      keyResults: [
        {
          text: "清零 23 个 vue-tsc 既有类型错误",
          progress: 100,
          file: "engineer/okr/2026-Q3/eng-005-build-health-zero/goal.md"
        },
        {
          text: "knowledgeBase dashboard 17 个错误修复",
          progress: 100,
          file: "engineer/okr/2026-Q3/eng-005-build-health-zero/goal.md"
        },
        {
          text: "rag history/retrieval 4 个错误修复",
          progress: 100,
          file: "engineer/okr/2026-Q3/eng-005-build-health-zero/goal.md"
        },
        {
          text: "proTable + menuMange 2 个类型错误修复",
          progress: 100,
          file: "engineer/okr/2026-Q3/eng-005-build-health-zero/goal.md"
        }
      ]
  ...
  srer: [
    {
      ...
      keyResults: [
        {
          text: "每条需求产出测试报告（04-test-report）",
          progress: 100,
          file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/05-test-report.md"
        },
        {
          text: "上线记录（artifact/version/env）落知识库（05-launch-record）",
          progress: 100,
  ...
  aier: [
    {
      ...
      keyResults: [
        {
          text: "每个推荐任务显式指派 skill/agent/mcp",
          progress: 100,
          file: "curator/okr/2026-Q3/loop/loop-002-template-orchestration/README.md"
        },
        { text: "确定性角色×清单映射覆盖 7 角色", progress: 100, file: "aier/okr/2026-Q3/aier-001-orchestration/goal.md" },
        { text: "AI 推荐按 WSJF 可复现", progress: 100, file: "aier/okr/2026-Q3/aier-001-orchestration/goal.md" },
        { text: "编排结果落盘可读回", progress: 100, file: "curator/okr/2026-Q3/loop/loop-002-template-orchestration/README.md" }
      ]
    },
    {
      id: "aier-002",
      ...
      project: "YiAi",
      keyResults: [
        { text: "Agent 任务完成率 > 70%", progress: 100, file: "aier/methodology/agent-harness-plugin-architecture.md" },
        {
          text: "写操作确认门（approve/reject）把关",
          progress: 100,
          file: "aier/methodology/agent-harness-plugin-architecture.md"
        },
        { text: "模型升级（stall→stronger）生效", progress: 100, file: "aier/methodology/agent-harness-plugin-architecture.md" },
        { text: "80% 任务 ≤ 5 轮完成", progress: 100, file: "aier/methodology/agent-harness-plugin-architecture.md" }
      ]
    }
  ],
  curator: [
    {
      ...
      project: "YiAi",
      keyResults: [
        { text: "五类记录模板 + 整合索引页（loop/INDEX）落地", progress: 100, file: "curator/okr/2026-Q3/loop/INDEX.md" },
        { text: "记录 frontmatter 合规率 100%", progress: 100, file: "curator/okr/2026-Q3/loop/INDEX.md" },
        {
          text: "循环记录可被 RAG 检索",
          progress: 100,
          file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/README.md"
        },
        { text: "旧数据清零并留迁移记录", progress: 100, file: "engineer/okr/2026-Q3/eng-001-build-debug-loop/goal.md" }
      ]
    }
  ]
};
  ...
  executiver: [
    {
      ...
      category: "市场情报",
      framework: "OKR",
      description: "已分析的竞品分类数（LLM 供应商 / SaaS 头部 / 区域竞对）。",
      current: 3,
      target: 3,
      baseline: 0,
      unit: " 类",
    ...
    },
    {
      ...
      category: "市场情报",
      framework: "OKR",
      description: "已摘要的第三方行业报告数（Gartner/McKinsey/a16z/CAICT/IDC）。",
      current: 4,
      target: 6,
      baseline: 0,
      unit: " 篇",
    ...
    },
    {
      ...
      category: "经营战略",
      framework: "OKR",
      description: "落地到产品战略实例的战略框架/工具数（Porter/Blue Ocean/BMC/价值主张）。",
      current: 4,
      target: 4,
      baseline: 0,
      unit: " 个",
    ...
    },
    {
      ...
      category: "组织路线",
      framework: "OKR",
      description: "年度规划 / QBR / OKR 跟踪 / 预算规划的文档完备度。",
      current: 3,
      target: 4,
      baseline: 0,
      unit: " 类",
  ...
  producter: [
    {
      ...
      category: "需求评审",
      framework: "OKR",
      description: "有 PRD + 验收标准 + WSJF 优先级的需求占比。",
      current: 100,
      target: 100,
      baseline: 0,
      unit: "%",
    ...
    },
    {
      ...
      category: "验收标准",
      framework: "OKR",
      description: "验收标准可被测试门禁直接判定的需求占比。",
      current: 100,
      target: 100,
      baseline: 0,
      unit: "%",
  ...
  leader: [
    {
      ...
      category: "技术评审",
      framework: "OKR",
      description: "产出 ADR（Context/Decision/Consequences）的需求占比。",
      current: 100,
      target: 100,
      baseline: 0,
      unit: "%",
  ...
  engineer: [
    {
      ...
      category: "构建",
      framework: "OKR",
      description: "改动文件在 vue-tsc --noEmit 下 0 新增错误。",
      current: 0,
      target: 0,
      baseline: 0,
      unit: " 个",
    ...
    },
    {
      ...
      category: "构建",
      framework: "OKR",
      description: "pnpm build 成功产出可部署 artifact。",
      current: 100,
      target: 100,
      baseline: 0,
      unit: "%",
    ...
    },
    {
      ...
      category: "构建",
      framework: "OKR",
      description: "vue-tsc 既有类型错误总数，目标从 23 清零。",
      current: 0,
      target: 0,
      baseline: 23,
      unit: " 个",
  ...
  srer: [
    {
      ...
      category: "测试",
      framework: "OKR",
      description: "有测试报告（typecheck/build + 手动验证）的需求占比。",
      current: 100,
      target: 100,
      baseline: 0,
      unit: "%",
    ...
    },
    {
      ...
      category: "上线",
      framework: "OKR",
      description: "上线记录含 artifact/version/env 且可追溯的需求占比。",
      current: 100,
      target: 100,
      baseline: 0,
      unit: "%",
  ...
  aier: [
    {
      ...
      category: "编排",
      framework: "OKR",
      description: "显式指派 skill/agent/mcp 三要素的推荐任务占比。",
      current: 100,
      target: 100,
      baseline: 0,
      unit: "%",
    ...
    },
    {
      ...
      category: "Agent",
      framework: "OKR",
      description: "Agent 任务成功完成的比例，目标 > 70%。",
      current: 0,
      target: 70,
      baseline: 0,
      unit: "%",
    ...
    },
    {
      ...
      category: "Agent",
      framework: "OKR",
      description: "写操作经 approve/reject 确认门把关的比例。",
      current: 100,
      target: 100,
      baseline: 0,
      unit: "%",
  ...
  curator: [
    {
      ...
      category: "记录",
      framework: "OKR",
      description: "流程记录模板数量（需求评审/技术评审/构建调试/测试报告/上线 5 类）。",
      current: 5,
      target: 5,
      baseline: 0,
      unit: " 个",
    ...
    },
    {
      ...
      category: "记录",
      framework: "OKR",
      description: "记录 frontmatter 满足 KB rulebook 必填字段的比例。",
      current: 100,
      target: 100,
      baseline: 0,
      unit: "%",
...
export const roleDailyDataMap: Record<string, DailyRoleData> = {
  ...
  producter: {
    ...
    today: [
      "写 loop-002 验收标准（可被测试门禁直接判定）",
      "把复盘结论落 01-requirement-review",
      "需求→任务拆解模板复用到 loop-002"
    ],
    blocker: "",
    mood: "Productive",
    moodType: "success"
...
export const roleWeeklyDataMap: Record<string, WeeklyRoleData> = {
  ...
  producter: {
    ...
    statusType: "success",
      ...
      {
        text: "复盘 loop-001，产出 loop-002 PRD 与验收标准",
        file: "curator/okr/2026-Q3/loop/loop-002-template-orchestration/01-requirement-review.md"
      }
    ],
    blockers: [],
    nextWeek: [
    ...
    decisions: [
      {
        text: "需求评审 = 产出 PRD + 验收标准 + WSJF 优先级",
        file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/01-requirement-review.md"
      },
      {
  ...
  leader: {
    ...
    decisions: [
      {
        text: "记录载体：KB markdown 为事实源 + YiVad 新页整合展示",
        file: "leader/okr/2026-Q3/lead-001-technical-review-loop/goal.md"
      },
      {
        text: "ADR 随 02-technical-review 落知识库",
        file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/02-technical-review.md"
      }
    ]
  },
  ...
  srer: {
    ...
    nextWeek: [
      {
        text: "复盘 loop-001 门禁与上线，规划 loop-002 上线",
        file: "curator/okr/2026-Q3/loop/loop-002-template-orchestration/05-test-report.md"
      }
    ],
    decisions: [
      {
        text: "门禁：typecheck + build 通过才上线",
        file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/05-test-report.md"
      },
      {
        text: "上线记录含 artifact/version/env",
        file: "curator/okr/2026-Q3/loop/loop-001-okr-self-closed-loop/07-launch-record.md"
      }
    ]
  },
  ...
  curator: {
    ...
    nextWeek: [
      {
        text: "复盘 loop-001 记录规范，规划 loop-002 模板复用",
        file: "curator/okr/2026-Q3/loop/loop-002-template-orchestration/README.md"
      }
    ],
    decisions: [
