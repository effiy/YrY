...
.reading-list__sticky-icon {
  flex-shrink: 0;
  margin-top: 2px;
  font-size: 28px;
}
.reading-list__sticky-info {
  display: flex;
  flex-direction: column;
  gap: 3px;
  min-width: 0;
}
.reading-list__sticky-name {
  margin: 0;
  font-size: 18px;
  font-weight: 700;
  line-height: 1.2;
...
.reading-list__stat-pill--accent {
  background: var(--el-color-primary-light-9);
}
.reading-list__stat-pill-value {
  font-size: 18px;
  font-weight: 700;
  line-height: 1.1;
  color: var(--el-text-color-primary);
}
.reading-list__stat-pill--accent .reading-list__stat-pill-value {
  color: var(--el-color-primary);
}
.reading-list__stat-pill-label {
  font-size: 10px;
  font-weight: 600;
  color: var(--el-text-color-secondary);
...
.reading-list__sidebar-icon {
  flex-shrink: 0;
  font-size: 18px;
}
.reading-list__sidebar-label {
  flex: 1;
  min-width: 0;
  overflow: hidden;
}
