...
.okr-role__sticky-left {
  display: flex;
  flex-shrink: 0;
  gap: 8px;
  align-items: center;
}
.okr-role__sticky-icon {
  font-size: 24px;
}
.okr-role__sticky-info {
  display: flex;
  flex-direction: column;
  gap: 0;
}
.okr-role__sticky-name {
  margin: 0;
  font-size: 16px;
  font-weight: 700;
  line-height: 1.2;
}
.okr-role__sticky-center {
  display: flex;
  flex-shrink: 0;
  gap: 8px;
  align-items: center;
}
.okr-role__year-select {
  width: 96px;
}
.okr-role__sticky-right {
  display: flex;
  flex-shrink: 0;
  gap: 6px;
}
...
.okr-role__stat-pill--accent {
  background: var(--el-color-primary-light-9);
}
.okr-role__stat-pill-value {
  font-size: 18px;
  font-weight: 700;
  line-height: 1.1;
  color: var(--el-text-color-primary);
}
.okr-role__stat-pill--accent .okr-role__stat-pill-value {
  color: var(--el-color-primary);
}
.okr-role__stat-pill-label {
  font-size: 10px;
  font-weight: 600;
...
.okr-role__section-count {
  font-size: 12px;
  font-weight: 600;
  color: var(--el-text-color-secondary);
}
.okr-role__section-desc {
  max-width: 800px;
  margin: 0 0 14px;
  font-size: 12px;
  line-height: 1.5;
...
.okr-role__week-input {
  width: 150px;
}
.okr-role__section-action {
  margin-left: auto;
}
.okr-role__copy-btn {
  flex-shrink: 0;
...
.okr-role__empty-icon {
  font-size: 40px;
  opacity: 0.6;
}
.okr-role__empty-title {
  margin: 0;
  font-size: 16px;
  font-weight: 700;
  color: var(--el-text-color-secondary);
}
.okr-role__empty-desc {
  max-width: 400px;
  margin: 0;
  font-size: 13px;
  line-height: 1.5;
...
// ── Table ──────────────────────────────────────
.okr-role__table-item {
  display: flex;
  gap: 8px;
  align-items: flex-start;
}
.okr-role__table-icon {
  flex-shrink: 0;
  margin-top: 1px;
  font-size: 18px;
}
.okr-role__table-title {
  display: block;
  font-size: 13px;
  font-weight: 600;
}
.okr-role__table-title--link {
  color: var(--el-color-primary);
  cursor: pointer;
...
.okr-role__loop-empty {
  font-size: 12px;
  color: var(--el-text-color-placeholder);
}
.okr-role__table-value {
  font-size: 14px;
  font-weight: 700;
  color: var(--el-color-primary);
}
.okr-role__table-target {
  font-size: 13px;
  font-weight: 600;
  color: var(--el-color-success);
}
.okr-role__table-progress {
  display: flex;
  gap: 8px;
  align-items: center;
}
...
.okr-role__expand {
  ...
  animation: okr-expand-in 0.2s ease;
}

@keyframes okr-expand-in {
  from {
    opacity: 0;
...
.okr-role__expand-title {
  margin: 0 0 8px;
  font-size: 13px;
  color: var(--el-text-color-secondary);
}
.okr-role__expand-empty {
  padding: 8px 0;
  font-size: 13px;
  font-style: italic;
  color: var(--el-text-color-placeholder);
...
.okr-role__weekly-card--done .okr-role__weekly-card-head {
  color: var(--el-color-success);
  background: var(--el-color-success-light-9);
}
.okr-role__weekly-card--blockers .okr-role__weekly-card-head {
  color: var(--el-color-danger);
  background: var(--el-color-danger-light-9);
}
.okr-role__weekly-card--next .okr-role__weekly-card-head {
  color: var(--el-color-primary);
  background: var(--el-color-primary-light-9);
}
.okr-role__weekly-card--decisions .okr-role__weekly-card-head {
  color: #7c3aed;
  background: #f3e8ff;
}
.okr-role__weekly-card-icon {
  font-size: 15px;
}
.okr-role__weekly-card-count {
  padding: 0 6px;
  margin-left: auto;
  font-size: 11px;
  line-height: 1.6;
...
.okr-role__weekly-card-toggle {
  margin-left: 2px;
  font-size: 12px;
  opacity: 0.7;
}
.okr-role__weekly-card-list {
  display: flex;
  flex-direction: column;
  gap: 5px;
...
.okr-role__weekly-card-body--collapsed {
  max-height: 0;
  padding: 0;
}
...
.okr-role__weekly-card-text {
  flex: 1;
  min-width: 0;
}
.okr-role__weekly-card-text--link {
  cursor: pointer;
  transition: color 0.15s;
  &:hover {
    color: var(--el-color-primary);
...
.okr-role__weekly-card--collapsed .okr-role__weekly-card-head {
  opacity: 0.7;
}

// ── Divider ────────────────────────────────────
.okr-role__section + .el-divider {
  width: auto;
  margin: 0 24px;
}
</style>
