<template>
  <div class="role-page">
    <header class="role-page__header">
      <h1>AI Engineer</h1>
      <p>
        {{ totalFiles }} files across {{ subdirs.length }} knowledge areas — AI foundations, methodology,
        platform, data, and ML ops for building effective AI systems.
      </p>
    </header>
...
function filePathHint(file: KnowledgeFileEntry): string {
  return file.path.replace(/^aier\//, '');
}

const STRUCTURAL_TAGS = new Set([
  'leaf', 'index', 'moc', 'summary', 'template',
  'foundations', 'methodology', 'platform', 'data', 'ml', 'aier',
  'prompts',
]);
