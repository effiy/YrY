...
export const stages: Stage[] = [
  {
    ...
    outputItems: [
      { id: "prds", label: "PRDs", keywords: ["prd", "product-requirement"], description: "Product Requirement Documents — what to build, for whom, and how to measure success" },
  ...
  },
  {
    ...
    category: "leader",
    inputItems: [
      { id: "prds", label: "PRDs", keywords: ["prd", "product-requirement"], description: "Product Requirement Documents from producter/ — the feature definitions to make decisions about" },
  ...
  },
  {
    ...
    inputItems: [
      ...
      { id: "prds", label: "PRDs", keywords: ["prd", "product-requirement"], description: "Product Requirement Documents from producter/ — the feature specifications to build" }
    ],
    outputItems: [
