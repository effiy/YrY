<script setup lang="ts" name="brdProductManagerList">
import { ref } from "vue";
...
const schema = brdMetaSchemas["brd-product-manager"];
...
<template>
  ...
  >
    <RelatedByProjectPanel
      ...
      current-tree="brd"
      current-topic="brd-product-manager"
