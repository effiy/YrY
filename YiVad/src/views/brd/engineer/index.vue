<script setup lang="ts" name="brdEngineerList">
import { ref } from "vue";
...
const schema = brdMetaSchemas["brd-engineer"];

// Cross-role drawer state — opens when user clicks the project cell on a row
...
<template>
  <TopicListPage
    ...
    :template-content="schema.templateContent"
    @meta-click="onMetaClick"
  />
  <el-drawer
    v-model="drawerOpen"
