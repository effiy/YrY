<script setup lang="ts" name="brdKnowledgeCuratorList">
import { ref } from "vue";
...
const schema = brdMetaSchemas["brd-knowledge-curator"];
...
<template>
  ...
  >
    <RelatedByProjectPanel
      ...
      current-tree="brd"
      current-topic="brd-knowledge-curator"
