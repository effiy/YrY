...
import {
  ...
  Search, Connection, Setting, MagicStick
...
const features = [
  { icon: ChatDotRound, title: "AI Chat", description: "SSE streaming with multi-model support, agent mode, and tool calling" },
  ...
  { icon: Setting, title: "Agent Engine", description: "Multi-turn agent loop with tool confirmation, steering, and model escalation" },
