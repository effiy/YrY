...
import {
  ArrowDown, TopRight,
  Position, MapLocation, Setting, Folder, Aim, Connection,
  Warning, Grid, Search, Service, Collection,
...
const quickNavGroups = computed(() => [
  {
    ...
    items: [
      ...
      { key: "skills", label: t("home.quickNavItems.skills.label"), path: "/skills" },
    ]
  },
  {
    key: "build",
    ...
    items: [
      ...
      { key: "rss", label: t("home.quickNavItems.rss.label"), path: "/dashboard/rssContent" },
    ]
  },
  {
    key: "quality",
  ...
  },
  {
    ...
    items: [
      { key: "aiChat", label: t("home.quickNavItems.aiChat.label"), path: "/aiChat", count: props.counts.chatSessionCount },
      { key: "knowledge", label: t("home.quickNavItems.knowledge.label"), path: "/knowledge", count: props.counts.knowledgeFileCount },
    ]
  },
]);
</script>
