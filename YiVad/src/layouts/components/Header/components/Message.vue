          ...
          <div class="message-list">
            <div class="message-item">
              ...
              <div class="message-content">
                <span class="message-title">系统通知：欢迎使用 YiVad</span>
            ...
            <div class="message-item">
              ...
              <div class="message-content">
                <span class="message-title">系统更新：v1.0.0 版本已发布</span>
            ...
            <div class="message-item">
              ...
              <div class="message-content">
                <span class="message-title">提醒：请定期备份数据</span>
            ...
            <div class="message-item">
              ...
              <div class="message-content">
                <span class="message-title">安全提示：请修改默认密码</span>
            ...
            <div class="message-item">
              ...
              <div class="message-content">
                <span class="message-title">提示：新功能即将上线</span>
