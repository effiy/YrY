/**
 * TypeScript interfaces for the YiAi backend API.
...
export interface KnowledgeFileEntry {
  ...
  name: string;
  /** Top-level YiKnowledge category: one of the 7 role directories (producter / leader / engineer / srer / executiver / aier / curator) or `static` / `__root__`. */
  category: string;
  meta: KnowledgeMeta;
  size: number;
