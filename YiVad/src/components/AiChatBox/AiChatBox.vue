...
import LlamaIndexPanel from "@/views/aiChat/components/LlamaIndexPanel/index.vue";
import KnowledgeDropZone from "./KnowledgeDropZone.vue";
...
async function onKnowledgeFileDrop(files: Array<{ path: string; content: string; title: string; tags: string[] }>) {
    ...
    <template v-if="showPanel">
      ...
      <template v-if="isFill">
        <div class="ai-chat-box__body">
          ...
          <KnowledgeDropZone @file-drop="onKnowledgeFileDrop">
