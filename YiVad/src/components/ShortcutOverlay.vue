      ...
      <div v-if="visible" class="shortcut-overlay" @click.self="close">
        <div class="shortcut-overlay__panel">
          <div class="shortcut-overlay__header">
            <h2>快捷键</h2>
            <el-input v-model="search" placeholder="搜索快捷键..." size="small" clearable class="shortcut-overlay__search" />
          ...
          <div class="shortcut-overlay__body">
            <div v-for="group in filteredGroups" :key="group.category" class="shortcut-overlay__group">
              ...
              <div v-for="shortcut in group.shortcuts" :key="shortcut.id" class="shortcut-overlay__item">
            ...
            <div v-if="filteredGroups.length === 0" class="shortcut-overlay__empty">无匹配的快捷键</div>
          </div>
        </div>
      </div>
    </Transition>
