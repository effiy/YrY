...
const INFRA_DIRS = ['agents', 'rules', '.history'];

// formulas.md is created by `rui init` from the plugin source. fix.js does NOT
// generate it (it's not infra — it's content). If missing, run `rui init` instead.
