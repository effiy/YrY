...
**场景 3 详情** (本组件文档所在地):
- 📄 [场景-3-组件库与JS工具API/index.md](../故事任务面板/scenes/场景-3-组件库与JS工具API/index.md) — 场景正文 (技术评审 / 测试设计 / 实施 / 报告 / 自改进)
- 🎯 [场景-3-组件库与JS工具API/演示.html](../故事任务面板/scenes/场景-3-组件库与JS工具API/演示.html) — 21 个 CSS 组件 + 9 个 JS API 的可交互演示
- 🏗 [场景-3-组件库与JS工具API/架构图.html](../故事任务面板/scenes/场景-3-组件库与JS工具API/架构图.html) — 组件分类 + 数据流图
- 📋 [场景-3-组件库与JS工具API/计划清单.html](../故事任务面板/scenes/场景-3-组件库与JS工具API/计划清单.html) — 任务分解 + 交付清单
...
| [架构](../yry-arch/scenes/故事任务.md) | 8 | 新人上手 / 模块定位 / 数据流 / 依赖变更 / 信任边界 / 断言脚本化 / 漂移监测 / 健康仪表板 | 间接 — 场景 1 (新人上手) 的页面会用到本组件 |
| [自改进](../yry-selfimprove-panel/scenes/故事任务.md) | 5 | 数据采集 / 诊断引擎 / 提案生成 / 效果评估 / 经验技能化 | 间接 — 提案可能涉及本组件的优化 |
| [自测](../yry-test/scenes/故事任务.md) | 6 | init 自检 / commit 自检 / 文档一致性 / 安全回归 / 集成回归 / 第三方 | 间接 — TC 套件需覆盖本组件 |
| [计划清单](../yry-checklist/scenes/故事任务.md) | 4 | 模板架构 · 交互组件 · 验证报告 · 批量生成 | 间接 — 模板场景 (场景 1) 已用本组件重构面包屑 |
| [首页](../yry-home/scenes/故事任务.md) | 4 | 数据采集 / 实时面板 / 交叉导航 / 自动化生成 | 间接 — 首页面包屑也用本组件 |
...
- 本组件仓库: [`cdn/yry-breadcrumb/`](./) · [README](./%E4%BB%BB%E5%8A%A1%E6%95%85%E4%BA%8B/README.md) · [Demo](./index.html)
- 所属场景: [场景-3-组件库与JS工具API](../故事任务面板/scenes/场景-3-组件库与JS工具API/index.md)
- 已使用本组件的页面: [计划清单 · 场景 1](../yry-checklist/scenes/场景-1-模板架构与CSS设计系统/计划清单.html) · 未来可接入: 架构/自测/自改进/首页等 28+ 场景页
