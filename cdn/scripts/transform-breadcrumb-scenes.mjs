 ...
 *
 * Usage:
 *   node cdn/scripts/transform-breadcrumb-scenes.mjs --dry-run
 *   node cdn/scripts/transform-breadcrumb-scenes.mjs --file <path>
 *   node cdn/scripts/transform-breadcrumb-scenes.mjs
 */
...
const SCENE_BASE = resolve(ROOT, 'cdn/故事任务面板/yry-breadcrumb');
