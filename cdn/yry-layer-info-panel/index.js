  ...
  function buildComponent(templateHTML) {
    return {
      ...
      methods: {
        ...
        isOpen: function () { return this.openState; },
        registerAPI: function () {
          var self = this;
          window.layerInfo = {
            show: function (name) { return self.show(name); },
      ...
      mounted: function () {
        ...
        document.dispatchEvent(new CustomEvent(READY_EVENT, { detail: { component: 'YryLayerInfoPanel' } }));
      }
    };
  }
  ...
  fetch(templateUrl, { credentials: 'same-origin' })
    ...
    .then(function (htmlText) {
      ...
      if (typeof window.Vue.defineCustomElement !== 'function') {
        console.error('[YryLayerInfoPanel] Vue.defineCustomElement 不可用,跳过注册');
        return;
      }
