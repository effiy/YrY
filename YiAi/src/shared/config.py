...
class Settings(BaseSettings):
    ...
    openai_default_model: str = Field("gpt-4o", validation_alias="openai_default_model")
    openai_chat_timeout: int = Field(300, validation_alias="openai_chat_timeout")

    # Anthropic
    anthropic_api_key: str = Field("", validation_alias="anthropic_api_key")
    anthropic_base_url: str = Field("https://api.anthropic.com", validation_alias="anthropic_base_url")
    anthropic_default_model: str = Field("claude-sonnet-4-6", validation_alias="anthropic_default_model")
    anthropic_chat_timeout: int = Field(300, validation_alias="anthropic_chat_timeout")
