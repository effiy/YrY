    ...
    return `
      <div class="mermaid-error">
        <div class="mermaid-error-header">
          ...
          <strong class="mermaid-error-title">Diagram render failed</strong>
        </div>
        <p class="mermaid-error-message">${escapedError}</p>
        <details class="mermaid-error-details">
          <summary class="mermaid-error-summary">View raw code</summary>
          <pre class="mermaid-error-code"><code>${escapedCode}</code></pre>
        </details>
      </div>
    `;
  }
  ...
  adjustMermaidSize(mermaidDiv) {
    ...
    try {
      ...
      if (svgWidth > 0 && svgHeight > 0) {
        ...
        mermaidDiv.classList.add('mermaid-diagram-auto');
      }
    } catch (e) {
      console.warn('[MermaidRenderer] Size adjustment failed', e);
      mermaidDiv.classList.add('mermaid-diagram-fallback');
    }
  }
