;(function () {
  ...
  const SESSION_TAG_MANAGER_TEMPLATES_RESOURCE_PATH = 'cdn/components/pet/manager/SessionTagManager/index.html'
  ...
  window.PetManager.Components.SessionTagPanel = {
    loadTemplate,
    createComponent,
  }
})()
