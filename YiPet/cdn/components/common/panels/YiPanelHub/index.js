...
const PanelHubRegistry = {
    ...
    panelLink(name, label) {
        ...
        return (
            '<a href="#" class="yry-panel-hub-link" onclick="event.preventDefault();event.stopPropagation();PanelHub.open(\'' +
            escapedName +
            '\')">' +
            this.escHtml(label) +
            '</a>'
...
const compDef = {
    name: 'ruiPanelHub',
    html: '/cdn/components/common/panels/YiPanelHub/template.html',
    css: '/cdn/components/common/panels/YiPanelHub/index.css',
    props: {
