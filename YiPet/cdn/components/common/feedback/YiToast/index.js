...
/* ═══════════════════════════════════════════════════════════════════════════
   ruiToast · Vue 3 Toast notification component (ES module entry)

   This file:
     1) Uses registerGlobalComponent to load CSS and register the component
     2) Immediately exposes window.ruiToast (early calls are queued)
...
const compDef = {
    name: 'ruiToast',
    html: '/cdn/components/common/feedback/YiToast/template.html',
    css: '/cdn/components/common/feedback/YiToast/index.css'
};
