          ...
          try {
            ...
            for (const { diagramId, diagramCode } of mermaidDiagrams) {
              ...
              try {
                ...
                el.innerHTML = `<pre class="md-code"><code class="language-mermaid">${escapeHtml(diagramCode)}</code></pre><div class="md-error-msg">渲染失败: ${escapeHtml(String(renderError.message || renderError))}</div>`;
              }
            }
          } catch (error) {
