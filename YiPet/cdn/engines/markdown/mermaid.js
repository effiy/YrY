 ...
 *       Page scripts: cdn/engines/markdown/mermaid-page-load.js
 *                     cdn/engines/markdown/mermaid-page-render.js
 */
(function () {
  'use strict'
  ...
  function loadMermaid() {
    ...
    return new Promise(function (resolve, reject) {
      ...
      var loadScriptUrl = chrome.runtime.getURL('cdn/engines/markdown/mermaid-page-load.js')
  ...
  function renderSingleBlock(mermaidId, mermaidDiv, mermaidContent) {
    DomHelper.runPageScriptWithData({
      scriptSrc: chrome.runtime.getURL('cdn/engines/markdown/mermaid-page-render.js'),
