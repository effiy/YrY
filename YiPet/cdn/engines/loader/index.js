/* ═══════════════════════════════════════════════════════════════════════════
   YrY Loader · bootstrap framework loader (thin bridge)
   ...
   yryBootstrapComponent, yryComponentHelpers, and all other loader APIs
...
(function () {
  ...
  if (window.yryBootstrapComponent && window.yryComponentHelpers) return;

  var SELF_SRC = (document.currentScript && document.currentScript.src) || '';
  // From cdn/components/core/YrYLoader/index.js → cdn/loader.js
  var LOADER_PATH = SELF_SRC.replace(/\/components\/core\/YrYLoader\/index\.js(\?.*)?$/, '/loader.js');
