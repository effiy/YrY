...
<template>
  <dialog v-if="s.tagManagerVisible" class="modal-overlay" open @click.self="s.tagManagerVisible = false">
    <div class="modal-content"><div class="modal-header"><span>Tag Manager</span><button @click="s.tagManagerVisible = false">✕</button></div><div class="modal-body"><p>Tag management — port in progress</p></div></div>
  </dialog>
</template>
