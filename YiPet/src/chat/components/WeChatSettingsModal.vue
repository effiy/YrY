...
<template>
  <dialog v-if="s.weChatSettingsVisible" class="modal-overlay" open @click.self="s.weChatSettingsVisible = false">
    <div class="modal-content"><div class="modal-header"><span>Bot Settings</span><button @click="s.weChatSettingsVisible = false">✕</button></div><div class="modal-body"><p>WeChat bot settings — port in progress</p></div></div>
  </dialog>
</template>
