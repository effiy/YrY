...
<template>
  <dialog v-if="s.sessionEditVisible" class="modal-overlay" open @click.self="s.sessionEditVisible = false">
    <div class="modal-content"><div class="modal-header"><span>Edit Session</span><button @click="s.sessionEditVisible = false">✕</button></div><div class="modal-body"><p>Session edit — port in progress</p></div></div>
  </dialog>
</template>
