/**
 * YiPet Popup — Root Container Component + Mount
 *
 * Defines the Popup container component (state-owner, action orchestrator)
 * and mounts it into the DOM. All UI logic lives in components/ui/*.js
 * (presentational).
 *
 ...
 *   ./services/notify                        → window.YiPetPopup.services.notification
 *   ./services/chrome                        → window.YiPetPopup.services.chromeService
 *   ./services/connect                       → window.YiPetPopup.services.connectionManager
 *   ./components/AppHeader                → window.YiPetPopup.components.AppHeader
 *   ./components/SettingsCard             → window.YiPetPopup.components.SettingsCard
 *   ./components/SwitchRow                → window.YiPetPopup.components.SwitchRow
 *   ./components/SliderRow                → window.YiPetPopup.components.SliderRow
 *   ./components/SelectRow                → window.YiPetPopup.components.SelectRow
 *   ./components/Notification             → window.YiPetPopup.components.Notification
 *   ./components/AppFooter                → window.YiPetPopup.components.AppFooter
 *
 * @module popup/index
 */
;(function (root) {
