/**
 * YiPet Configuration — Defaults & Endpoints
 *
 * Pure data: default values and REST endpoint path templates.
 * No logic, no env detection — just declarative configuration.
 *
 * Exports: window.PET_DEFAULTS, window.PET_ENDPOINTS
 *
 * @module config/pet.defaults
 */
...
;(function (root) {
    ...
    constants: {
      ...
      ANIMATION: {
        ...
        THINKING_BUBBLE_TEXTS: [
          '🤔 Let me think...', '💭 Thinking...', '✨ Inspiration strikes...', '🌟 Organizing thoughts...',
          '🎯 Deep analysis...', '🔍 Searching for answers...', '💡 Idea incoming...', '🌊 Brainstorming...',
          '📝 Choosing words...', '🎨 Crafting reply...', '⚡ Almost there...', '🌈 Nearly ready...', '🚀 Coming right up...'
        ]
      },
  ...
  root.PET_DEFAULTS  = DEFAULTS
  root.PET_ENDPOINTS = ENDPOINTS
