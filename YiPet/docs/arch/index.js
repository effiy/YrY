...
(function () {
  ...
  function useExport(containerRef) {
    ...
    function downloadPNG() {
      ...
      snapshot().then(function (canvas) {
        ...
        link.click();
        if (window.ruiToast) window.ruiToast.success('PNG downloaded', 'architecture-diagram.png');
      }).catch(function (err) {
    ...
    function downloadPDF() {
      ...
      snapshot().then(function (canvas) {
        ...
        if (window.ruiToast) window.ruiToast.success('PDF downloaded', 'architecture-diagram.pdf');
      }).catch(function (err) {
  ...
  var TEMPLATE = String.raw`
    ...
    <!-- Shared rui-back-top scroll-to-top button -->
  ...
  whenVueReady().then(function () {
    ...
    var app = Vue.createApp({
      ...
      mounted: function () {
        ...
        // nodes (the main <div class="container"> plus <rui-back-top>), so
